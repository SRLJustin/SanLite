...
public final class Tiles {
	...
	static {
		...
		Tiles_minPlane = 99;
		field1001 = new int[]{1, 2, 4, 8};
		field1002 = new int[]{16, 32, 64, 128};
		field1008 = new int[]{1, 0, -1, 0};
		field1009 = new int[]{0, -1, 0, 1};
			...
			while (true) {
				...
				if (var17 == var4 && var16 >= var5 && var16 < var5 + 8 && var15 >= var6 && var15 < var6 + 8) {
					...
					if (var22 > 0 && var23 > 0 && var22 < 103 && var23 < 103) {
						...
						class309.method5778(var1, var22, var23, var11, var20 + var7 & 3, var19, var8, var25);
					}
				}
			}
		}
