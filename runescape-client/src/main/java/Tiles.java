...
public final class Tiles {
	...
	static {
		...
		Tiles_minPlane = 99;
		field1032 = new int[]{1, 2, 4, 8};
		field1036 = new int[]{16, 32, 64, 128};
		field1035 = new int[]{1, 0, -1, 0};
		field1029 = new int[]{0, -1, 0, 1};
			...
			while (true) {
				...
				if (var17 == var4 && var16 >= var5 && var16 < var5 + 8 && var15 >= var6 && var15 < var6 + 8) {
					...
					if (var22 > 0 && var30 > 0 && var22 < 103 && var30 < 103) {
						...
						UrlRequester.method2772(var1, var22, var30, var11, var20 + var7 & 3, var19, var8, var32);
					}
				}
			}
		}
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			HealthBar.archive6 = MusicPatchNode.method5790(0, false, true, true, false);
			class9.archive7 = MusicPatchNode.method5790(1, false, true, true, false);
			HitSplatDefinition.archive2 = MusicPatchNode.method5790(2, true, false, true, false);
			FloorUnderlayDefinition.archive3 = MusicPatchNode.method5790(3, false, true, true, false);
			WorldMapSection0.archive9 = MusicPatchNode.method5790(4, false, true, true, false);
			class4.archive10 = MusicPatchNode.method5790(5, true, true, true, false);
			class162.archive11 = MusicPatchNode.method5790(6, true, true, true, false);
			class301.field3470 = MusicPatchNode.method5790(7, false, true, true, false);
			ClientPreferences.archive8 = MusicPatchNode.method5790(8, false, true, true, false);
			Frames.field2615 = MusicPatchNode.method5790(9, false, true, true, false);
			ClanChannelMember.field1666 = MusicPatchNode.method5790(10, false, true, true, false);
			class21.field123 = MusicPatchNode.method5790(11, false, true, true, false);
			class71.archive12 = MusicPatchNode.method5790(12, false, true, true, false);
			class358.archive13 = MusicPatchNode.method5790(13, true, false, true, false);
			VarpDefinition.archive14 = MusicPatchNode.method5790(14, false, true, true, false);
			class89.archive15 = MusicPatchNode.method5790(15, false, true, true, false);
			VerticalAlignment.field2076 = MusicPatchNode.method5790(17, true, true, true, false);
			class170.archive18 = MusicPatchNode.method5790(18, false, true, true, false);
			FontName.archive19 = MusicPatchNode.method5790(19, false, true, true, false);
			WorldMapArea.archive20 = MusicPatchNode.method5790(20, false, true, true, false);
			Ignored.field4539 = MusicPatchNode.method5790(21, false, true, true, true);
			Login.Login_loadingText = "Connecting to update server";
			Login.Login_loadingPercent = 20;
			Client.titleLoadingStage = 40;
		} else if (Client.titleLoadingStage == 40) {
			byte var24 = 0;
			var13 = var24 + HealthBar.archive6.percentage() * 4 / 100;
			var13 += class9.archive7.percentage() * 4 / 100;
			var13 += HitSplatDefinition.archive2.percentage() * 2 / 100;
			var13 += FloorUnderlayDefinition.archive3.percentage() * 2 / 100;
			var13 += WorldMapSection0.archive9.percentage() * 6 / 100;
			var13 += class4.archive10.percentage() * 4 / 100;
			var13 += class162.archive11.percentage() * 2 / 100;
			var13 += class301.field3470.percentage() * 55 / 100;
			var13 += ClientPreferences.archive8.percentage() * 2 / 100;
			var13 += Frames.field2615.percentage() * 2 / 100;
			var13 += ClanChannelMember.field1666.percentage() * 2 / 100;
			...
			var13 += VerticalAlignment.field2076.method6415() && VerticalAlignment.field2076.isFullyLoaded() ? 1 : 0;
			if (var13 != 100) {
				if (var13 != 0) {
				...
				class18.method263(HealthBar.archive6, "Animations");
				class18.method263(class9.archive7, "Skeletons");
				class18.method263(WorldMapSection0.archive9, "Sound FX");
				class18.method263(class4.archive10, "Maps");
				class18.method263(class162.archive11, "Music Tracks");
				class18.method263(class301.field3470, "Models");
				...
				UserComparator5.field1470 = new GraphicsDefaults();
				UserComparator5.field1470.decode(VerticalAlignment.field2076);
			...
			WorldMapDecoration.method5269(class89.archive15, VarpDefinition.archive14, WorldMapSection0.archive9, var21);
			...
			if (Client.titleLoadingStage == 60) {
				var13 = class134.method3051(ClanChannelMember.field1666, ClientPreferences.archive8);
				...
				if (!HitSplatDefinition.archive2.isFullyLoaded()) {
					...
					UrlRequester.method2770(HitSplatDefinition.archive2, class301.field3470, Client.isLowDetail);
					PacketWriter.method2741(HitSplatDefinition.archive2, class301.field3470, Client.field515 <= 209, UserComparator5.field1470.field4585);
					Archive var16 = HitSplatDefinition.archive2;
					StructComposition.StructDefinition_archive = var16;
					class346.method6684(HitSplatDefinition.archive2, class301.field3470, Client.isMembersWorld, class151.fontPlain11);
					WorldMapIcon_1.method4881(HitSplatDefinition.archive2, HealthBar.archive6, class9.archive7);
					WorldMapSectionType.method5233(HitSplatDefinition.archive2, class301.field3470);
					...
					SequenceDefinition.method4063(FloorUnderlayDefinition.archive3, class301.field3470, ClientPreferences.archive8, class358.archive13);
					...
					class34.Ignored_cached = new class451(LoginPacket.field3302, 47, class173.clientLanguage, HitSplatDefinition.archive2);
				...
				if (class201.compass == null) {
					class201.compass = class125.SpriteBuffer_getSprite(ClientPreferences.archive8, UserComparator5.field1470.compass, 0);
				} else {
					++var13;
				}

				if (class139.redHintArrowSprite == null) {
					class139.redHintArrowSprite = class125.SpriteBuffer_getSprite(ClientPreferences.archive8, UserComparator5.field1470.field4588, 0);
				} else {
					++var13;
				}

				if (class32.mapSceneSprites == null) {
					class32.mapSceneSprites = AbstractWorldMapData.method5238(ClientPreferences.archive8, UserComparator5.field1470.mapScenes, 0);
				} else {
					++var13;
				}

				if (World.headIconPkSprites == null) {
					World.headIconPkSprites = SequenceDefinition.method4064(ClientPreferences.archive8, UserComparator5.field1470.headIconsPk, 0);
				} else {
					++var13;
				}

				if (class410.headIconPrayerSprites == null) {
					class410.headIconPrayerSprites = SequenceDefinition.method4064(ClientPreferences.archive8, UserComparator5.field1470.field4585, 0);
				} else {
					++var13;
				}

				if (class358.headIconHintSprites == null) {
					class358.headIconHintSprites = SequenceDefinition.method4064(ClientPreferences.archive8, UserComparator5.field1470.field4587, 0);
				} else {
					++var13;
				}

				if (class144.mapMarkerSprites == null) {
					class144.mapMarkerSprites = SequenceDefinition.method4064(ClientPreferences.archive8, UserComparator5.field1470.field4591, 0);
				} else {
					++var13;
				}

				if (MouseHandler.crossSprites == null) {
					MouseHandler.crossSprites = SequenceDefinition.method4064(ClientPreferences.archive8, UserComparator5.field1470.field4589, 0);
				} else {
					++var13;
				}

				if (class281.mapDotSprites == null) {
					class281.mapDotSprites = SequenceDefinition.method4064(ClientPreferences.archive8, UserComparator5.field1470.field4590, 0);
				} else {
					++var13;
				}

				if (class89.scrollBarSprites == null) {
					class89.scrollBarSprites = AbstractWorldMapData.method5238(ClientPreferences.archive8, UserComparator5.field1470.field4586, 0);
				} else {
					++var13;
				}

				if (Coord.modIconSprites == null) {
					Coord.modIconSprites = AbstractWorldMapData.method5238(ClientPreferences.archive8, UserComparator5.field1470.field4592, 0);
				} else {
					++var13;
				}
				...
				if (!Frames.field2615.isFullyLoaded()) {
					...
					Rasterizer3D.method4317(Skeleton.textureProvider);
					Rasterizer3D.method4312(StructComposition.clientPreferences.method2422());
				...
				if (!ClanChannelMember.field1666.tryLoadFileByNames("huffman", "")) {
					Login.Login_loadingText = "Loading wordpack - " + 0 + "%";
					Login.Login_loadingPercent = 94;
				} else {
					Huffman var0 = new Huffman(ClanChannelMember.field1666.takeFileByNames("huffman", ""));
				...
				if (!FloorUnderlayDefinition.archive3.isFullyLoaded()) {
					Login.Login_loadingText = "Loading interfaces - " + FloorUnderlayDefinition.archive3.loadPercent() * 4 / 5 + "%";
