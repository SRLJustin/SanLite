...
public class class9 implements MouseWheel {
	...
	static {
		...
		field41 = new class9(1, "GET", true, false);
	...
	static final void method80() {
		...
		class6.Ignored_cached.method7552();
	...
	static final void method78(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		if (var2 == 1) {
			...
			var9.packetBuffer.writeIntME(GraphicsObject.selectedItemWidget);
			...
			var9.packetBuffer.writeShort(Client.field746);
			var9.packetBuffer.writeIntME(class113.selectedSpellWidget);
			...
			if (var2 == 7) {
				...
				if (var14 != null) {
					...
					var10.packetBuffer.method7773(Client.field746);
				...
				if (var2 == 14) {
					...
					if (var16 != null) {
						...
						var10.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
						var10.packetBuffer.method7773(var3);
						var10.packetBuffer.writeIntME(GraphicsObject.selectedItemWidget);
						Client.packetWriter.addNode(var10);
					}
				} else if (var2 == 15) {
					var16 = Client.players[var3];
					if (var16 != null) {
						...
						var10.packetBuffer.method7773(var3);
						var10.packetBuffer.method7969(Client.field746);
					...
					if (var2 == 24) {
						...
						if (var2 == 25) {
							...
							if (var17 != null) {
								...
								class21.selectSpell(var1, var0, WallObject.Widget_unpackTargetMask(class67.getWidgetFlags(var17)), var4);
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								if (Client.meslayerContinueWidget == null) {
									...
									class220.method4529(Client.meslayerContinueWidget);
								}
							} else if (var2 == 31) {
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var17 != null) {
													...
													var10.packetBuffer.method7771(Client.field746);
													var10.packetBuffer.method7785(class113.selectedSpellWidget);
		...
		if (Client.isItemSelected != 0) {
			Client.isItemSelected = 0;
			class220.method4529(FloorUnderlayDefinition.getWidget(GraphicsObject.selectedItemWidget));
		}
