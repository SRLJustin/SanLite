			...
			for (var3 = 0; var3 < 104; ++var3) {
				for (var4 = 0; var4 < 104; ++var4) {
					if ((Tiles.Tiles_renderFlags[var2][var3][var4] & 1) == 1) {
						...
						if (var5 >= 0) {
							var1[var5].method3850(var3, var4);
						}
					}
				}
			}
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var20 > 0 || var21 > 0) {
								...
								if (var20 > 0) {
									...
									var30 = class162.method3310(var32, var33, var34);
									...
									var31 = class162.method3310(var32, var33, var34);
								}
								...
								if (var21 == 0) {
									...
									if (var36 >= 0) {
										...
										var37 = class162.method3310(var35.hue, var35.saturation, var35.lightness);
										...
										var38 = class162.method3310(var39, var35.saturation, var40);
									}
									...
									if (var35.secondaryRgb != -1) {
										...
										var38 = class162.method3310(var40, var35.secondarySaturation, var41);
										var39 = Rasterizer3D.Rasterizer3D_colorPalette[ClanSettings.method3028(var38, 96)];
									}
