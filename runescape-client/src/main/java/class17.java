...
class class17 implements SSLSession {
	...
	static final void method273(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		if (var2 == 1) {
			...
			var9.packetBuffer.method8075(WorldMapData_1.baseY * 8 + var1);
			...
			var9.packetBuffer.method8075(Client.field649);
			var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var9.packetBuffer.method8075(WorldMapData_1.baseY * 8 + var1);
			...
			var9.packetBuffer.method7961(WorldMapData_1.baseY * 8 + var1);
			...
			var9.packetBuffer.writeShort(WorldMapData_1.baseY * 8 + var1);
			...
			var9.packetBuffer.method7962(WorldMapData_1.baseY * 8 + var1);
			var9.packetBuffer.writeShort(var3);
			Client.packetWriter.addNode(var9);
		} else if (var2 == 6) {
			Client.mouseCrossX = var7;
			...
			if (var2 == 7) {
				...
				if (var14 != null) {
					...
					var10.packetBuffer.method7962(Client.field649);
					Client.packetWriter.addNode(var10);
				}
			} else if (var2 == 9) {
				var14 = Client.npcs[var3];
				...
				if (var2 == 14) {
					...
					if (var16 != null) {
						...
						var10.packetBuffer.writeShort(ApproximateRouteStrategy.selectedItemSlot);
						var10.packetBuffer.method7962(var3);
						var10.packetBuffer.writeIntME(GameObject.selectedItemWidget);
					...
					if (var16 != null) {
						...
						var10.packetBuffer.method8075(Client.field649);
						Client.packetWriter.addNode(var10);
					}
				} else if (var2 == 16) {
					Client.mouseCrossX = var7;
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								if (Client.meslayerContinueWidget == null) {
									...
									class403.method7332(Client.meslayerContinueWidget);
								}
							} else if (var2 == 31) {
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var17 != null) {
													...
													var10.packetBuffer.writeIntME(ClanSettings.selectedSpellWidget);
													var10.packetBuffer.method7961(Client.selectedSpellChildIndex);
													var10.packetBuffer.method7971(var1);
													var10.packetBuffer.writeShort(Client.field649);
		...
		if (Client.isItemSelected != 0) {
			Client.isItemSelected = 0;
			class403.method7332(SpotAnimationDefinition.getWidget(GameObject.selectedItemWidget));
		}
				...
				if (var34 || !var9.isIf3 || var12 < var14 && var13 < var15) {
					if (var9.isIf3) {
						...
						if (var9.noClickThrough) {
							...
							for (var27 = (ScriptEvent)Client.scriptEvents.last(); var27 != null; var27 = (ScriptEvent)Client.scriptEvents.previous()) {
								if (var27.field1042 && var27.widget.onScroll == var27.args) {
									var27.remove();
								}
							}
						}
					...
					if (var9.contentType == 1337) {
						...
						if (var9.isIf3) {
									...
									case 1:
										if (ItemComposition.method3909(class97.getWidgetFlags(var9))) {
											...
											if (var22 != null) {
												...
												var23.packetBuffer.writeIntME(var22[2]);
												var23.packetBuffer.writeIntME(var9.method5839());
							...
							if (var9.hasListener) {
								...
								if (Client.clickedWidget != null || Nameable.dragInventoryWidget != null || Client.isMenuOpen) {
									var21 = false;
									var36 = false;
									var35 = false;
								}

								if (!var9.field3537 && var21) {
									var9.field3537 = true;
								...
								if (var9.field3537 && var36 && var9.onClickRepeat != null) {
									var37 = new ScriptEvent();
									var37.field1042 = true;
									var37.widget = var9;
								...
								if (var9.field3536 && var35 && var9.onMouseRepeat != null) {
									var37 = new ScriptEvent();
									var37.field1042 = true;
									var37.widget = var9;
									var37.mouseX = MouseHandler.MouseHandler_x - var26;
								...
								int var39;
								int var40;
								if (var9.onVarTransmit != null && Client.field557 > var9.field3539) {
									if (var9.varTransmitTriggers != null && Client.field557 - var9.field3539 <= 32) {
										label834:
										for (var40 = var9.field3539; var40 < Client.field557; ++var40) {
											var29 = Client.field691[var40 & 31];
									...
									var9.field3539 = Client.field557;
								}
								...
								if (var9.onInvTransmit != null && Client.field694 > var9.field3540) {
									if (var9.invTransmitTriggers != null && Client.field694 - var9.field3540 <= 32) {
										...
										for (var40 = var9.field3540; var40 < Client.field694; ++var40) {
											var29 = Client.field693[var40 & 31];
								...
								if (var9.onStatTransmit != null && Client.field696 > var9.field3541) {
									if (var9.statTransmitTriggers != null && Client.field696 - var9.field3541 <= 32) {
										label786:
										for (var40 = var9.field3541; var40 < Client.field696; ++var40) {
											var29 = Client.field695[var40 & 31];
									...
									var9.field3541 = Client.field696;
								}
