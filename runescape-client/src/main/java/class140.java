		...
		if (var0 != Client.gameState) {
			...
			if (var0 != 5 && var0 != 10) {
				if (var0 == 20) {
					...
					UserComparator5.method2830(ClanChannelMember.field1666, ClientPreferences.archive8, false, var3);
				} else if (var0 == 11) {
					UserComparator5.method2830(ClanChannelMember.field1666, ClientPreferences.archive8, false, 4);
				} else if (var0 == 50) {
					TaskHandler.setLoginResponseString("", "Updating date of birth...", "");
					UserComparator5.method2830(ClanChannelMember.field1666, ClientPreferences.archive8, false, 7);
				} else {
					FontName.method8199();
				}
			} else {
				...
				int var2 = var1 ? 0 : 12;
				UserComparator5.method2830(ClanChannelMember.field1666, ClientPreferences.archive8, true, var2);
			}
