		...
		if (var2 == 1) {
			...
			if (var2 == 7) {
				...
				if (var2 == 17) {
					...
					this.horizontalAlignment = (HorizontalAlignment)DecorativeObject.findEnumerated(class101.method2565(), var1.readUnsignedByte());
				} else if (var2 == 30) {
					this.verticalAlignment = (VerticalAlignment)DecorativeObject.findEnumerated(class120.method2813(), var1.readUnsignedByte());
				}
			}
		}
