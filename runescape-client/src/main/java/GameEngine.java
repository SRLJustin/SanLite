	...
	static final void method667() {
		...
		for (var1 = 0; var1 < class133.regionLandArchives.length; ++var1) {
			if (Client.regionMapArchiveIds[var1] != -1 && class133.regionLandArchives[var1] == null) {
				class133.regionLandArchives[var1] = class4.archive10.takeFile(Client.regionMapArchiveIds[var1], 0);
			...
			if (class379.regionLandArchiveIds[var1] != -1 && class241.regionMapArchives[var1] == null) {
				class241.regionMapArchives[var1] = class4.archive10.takeFileEncrypted(class379.regionLandArchiveIds[var1], 0, class104.xteaKeys[var1]);
			...
			if (!var0) {
				...
				if (Client.isInInstance) {
					...
					for (var2 = 0; var2 < 4; ++var2) {
						...
						for (var3 = 0; var3 < 13; ++var3) {
							for (var4 = 0; var4 < 13; ++var4) {
								boolean var18 = false;
								var6 = Client.field578[var2][var3][var4];
								if (var6 != -1) {
									var7 = var6 >> 24 & 3;
									var8 = var6 >> 1 & 3;
									var9 = var6 >> 14 & 1023;
									...
									for (int var12 = 0; var12 < class205.regions.length; ++var12) {
										if (class205.regions[var12] == var11 && class133.regionLandArchives[var12] != null) {
											...
											class26.method364(class133.regionLandArchives[var12], var2, var3 * 8, var4 * 8, var7, (var9 & 7) * 8, (var10 & 7) * 8, var8, var13, var14, Client.collisionMaps);
											var18 = true;
											break;
										}
									}
					...
					for (var2 = 0; var2 < 13; ++var2) {
						for (var3 = 0; var3 < 13; ++var3) {
							var4 = Client.field578[0][var2][var3];
							if (var4 == -1) {
					...
					for (var2 = 0; var2 < 4; ++var2) {
						...
						for (var3 = 0; var3 < 13; ++var3) {
							for (var4 = 0; var4 < 13; ++var4) {
								var5 = Client.field578[var2][var3][var4];
								if (var5 != -1) {
									var6 = var5 >> 24 & 3;
									var7 = var5 >> 1 & 3;
									var8 = var5 >> 14 & 1023;
				...
				if (BuddyRankComparator.client.hasFrame()) {
					...
					var19.packetBuffer.method8536(1057001181);
					...
					for (var7 = var3 - 1; var7 <= var4 + 1; ++var7) {
						for (var8 = var5 - 1; var8 <= var6 + 1; ++var8) {
							if (var7 < var3 || var7 > var4 || var8 < var5 || var8 > var6) {
								class4.archive10.loadRegionFromName("m" + var7 + "_" + var8);
								class4.archive10.loadRegionFromName("l" + var7 + "_" + var8);
							}
						}
					}
				}
