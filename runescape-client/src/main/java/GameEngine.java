...
public abstract class GameEngine extends Applet implements Runnable, FocusListener, WindowListener {
	...
	final void resizeCanvas() {
		...
		if (var1 != null) {
			...
			DecorativeObject.canvasHeight = Math.min(this.contentHeight, this.maxCanvasHeight);
			this.canvasX = (this.contentWidth - class7.canvasWidth) / 2;
			this.canvasY = 0;
			this.canvas.setSize(class7.canvasWidth, DecorativeObject.canvasHeight);
			class119.rasterProvider = new RasterProvider(class7.canvasWidth, DecorativeObject.canvasHeight, this.canvas);
			if (var1 == this.frame) {
	...
	void clearBackground() {
		...
		int var4 = this.contentHeight - DecorativeObject.canvasHeight - var2;
	...
	protected final void method507(int var1, int var2, int var3, int var4) {
		try {
			if (gameEngine != null) {
			...
			DecorativeObject.canvasHeight = var2;
			RunException.field4844 = var3;
	...
	final synchronized void addCanvas() {
		...
		DecorativeObject.canvasHeight = Math.max(var1.getHeight(), this.field195);
		Insets var2;
		if (this.frame != null) {
			var2 = this.frame.getInsets();
			class7.canvasWidth -= var2.right + var2.left;
			DecorativeObject.canvasHeight -= var2.top + var2.bottom;
		}
		...
		this.fullRedraw = true;
		if (class119.rasterProvider != null && class7.canvasWidth == class119.rasterProvider.width && DecorativeObject.canvasHeight == class119.rasterProvider.height) {
	...
	protected final void drawInitial(int var1, String var2, boolean var3) {
		try {
			...
			if (var3) {
				...
				var4.fillRect(0, 0, class7.canvasWidth, DecorativeObject.canvasHeight);
			}
			...
			try {
				...
				var4.drawImage(UserComparator9.field1387, class7.canvasWidth / 2 - 152, DecorativeObject.canvasHeight / 2 - 18, (ImageObserver)null);
			} catch (Exception var9) {
				int var7 = class7.canvasWidth / 2 - 152;
				int var8 = DecorativeObject.canvasHeight / 2 - 18;
				var4.setColor(var5);
