		...
		if (var0 == ScriptOpcodes.CLIENTCLOCK) {
			...
			if (var0 == ScriptOpcodes.INV_GETOBJ) {
				...
				if (var0 == ScriptOpcodes.COORD) {
					...
					TaskHandler.Interpreter_intStackSize -= 2;
					var3 = Interpreter.Interpreter_intStack[TaskHandler.Interpreter_intStackSize] + 32768;
					var4 = Interpreter.Interpreter_intStack[TaskHandler.Interpreter_intStackSize + 1];
					Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = class119.method2817(var3, var4);
					return 1;
				...
				if (!var10.isIf3 || !ModeWhere.isComponentHidden(var10)) {
					...
					if (var10 == Client.clickedWidget) {
						...
						if (Client.isDraggingWidget && Client.field675) {
							...
							if (var15 + var10.width > Client.field676 + Client.field671.width) {
								var15 = Client.field676 + Client.field671.width - var10.width;
							}
							...
							if (var16 + var10.height > Client.field751 + Client.field671.height) {
								var16 = Client.field751 + Client.field671.height - var10.height;
							}
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
									...
									if (var10.type == 4) {
										...
										SpritePixels var40;
										if (!var10.isIf3) {
											var40 = var10.method5624(FriendSystem.runCs1(var10), class152.urlRequester);
											if (var40 != null) {
											...
											if (var10.itemId != -1) {
												...
												var40 = var10.method5624(false, class152.urlRequester);
											}
