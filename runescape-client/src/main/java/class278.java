				...
				if (!var10.isIf3 || !class6.isComponentHidden(var10)) {
					...
					if (var10 == Client.clickedWidget) {
						...
						if (Client.isDraggingWidget && Client.field684) {
							...
							if (var15 + var10.width > Client.field603 + Client.field680.width) {
								var15 = Client.field603 + Client.field680.width - var10.width;
							}
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
									...
									if (var10.type == 4) {
										...
										SpritePixels var42;
										if (!var10.isIf3) {
											var42 = var10.method6051(MouseHandler.runCs1(var10), PcmPlayer.urlRequester);
											if (var42 != null) {
											...
											if (var10.itemId != -1) {
												...
												var42 = var10.method6051(false, PcmPlayer.urlRequester);
											}
