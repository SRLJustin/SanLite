...
public class IterableNodeDeque implements Iterable, Collection {
	...
	@Export("last")
	public Node last() {
		return this.method5989((Node)null);
	}
	...
	Node[] method5997() {
		Node[] var1 = new Node[this.method5967()];
		int var2 = 0;
	...
	public Object[] toArray() {
		return this.method5997();
	}

	public boolean add(Object var1) {
		return this.method5973((Node)var1);
	}
