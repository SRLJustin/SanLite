...
public class ArchiveLoader {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) {
			AbstractWorldMapIcon.worldToScreen((Client.field500 - SecureRandomCallable.baseX * 64 << 7) + Client.field503 * 4096, (Client.field501 - GrandExchangeOfferOwnWorldComparator.baseY * 64 << 7) + Client.field554 * 4096, Client.field563 * 4);
