...
public class InvDefinition extends DualNode {
	...
	static int method3277(int var0, Script var1, boolean var2) {
		...
		if (var0 != ScriptOpcodes.CC_CALLONRESIZE && var0 != ScriptOpcodes.IF_CALLONRESIZE) {
			...
			if (var0 == ScriptOpcodes.CC_TRIGGEROP) {
				...
				int var3 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize];
				var4 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1];
				int var5 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 2];
				if (var5 >= 1 && var5 <= 10) {
			...
			if (var0 >= 2000) {
				var7 = HitSplatDefinition.getWidget(Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]);
			} else {
				var7 = var2 ? SoundSystem.scriptDotWidget : Ignored.scriptActiveWidget;
			}
	...
	static void playSong(int var0) {
		if (var0 == -1 && !Client.field729) {
			VarcInt.method3328();
		} else if (var0 != -1 && var0 != Client.currentTrackGroupId && FriendsChatMember.clientPreferences.method2222() != 0 && !Client.field729) {
			Archive var1 = PacketBuffer.field4700;
			int var2 = FriendsChatMember.clientPreferences.method2222();
