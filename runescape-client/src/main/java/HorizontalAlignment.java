...
public enum HorizontalAlignment implements class349 {
	...
	static void method3715() {
		...
		Tiles.field1010 = new short[4][104][104];
		class172.field1865 = new short[4][104][104];
		Tiles.field1011 = new byte[4][104][104];
		Tiles.field1012 = new byte[4][104][104];
		class312.field3717 = new int[4][105][105];
		Tiles.field1013 = new byte[4][105][105];
		class323.field3794 = new int[105][105];
		class100.field1332 = new int[104];
		class161.field1805 = new int[104];
		Tiles.field1024 = new int[104];
		class463.field4906 = new int[104];
