...
public class WorldMapSection2 implements WorldMapSection {
		...
		if (var0.field1182 >= Client.cycle) {
			...
			if (var0.field1183 >= Client.cycle) {
				...
				if (!var11) {
					...
					if (var12 != null && !var12.method3725()) {
	...
	static final void method4493(Actor var0) {
		...
		if (var0.movementSequence != -1) {
			...
			if (var1 != null) {
				if (!var1.method3725() && var1.frameIds != null) {
		...
		if (var0.spotAnimation != -1 && Client.cycle >= var0.field1176) {
			...
			if (var4 != -1) {
				...
				if (var5 != null && var5.frameIds != null && !var5.method3725()) {
	...
	static final int method4502() {
		float var0 = 200.0F * ((float)FriendsChatMember.clientPreferences.method2220() - 0.5F);
