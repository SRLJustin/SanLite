				...
				if (!var10.isIf3 || !FriendSystem.isComponentHidden(var10)) {
					...
					if (var10 == Client.clickedWidget) {
						...
						if (Client.isDraggingWidget && Client.field745) {
							...
							if (var15 + var10.width > Client.field699 + Client.field694.width) {
								var15 = Client.field699 + Client.field694.width - var10.width;
							}
							...
							if (var16 + var10.height > Client.field613 + Client.field694.height) {
								var16 = Client.field613 + Client.field694.height - var10.height;
							}
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
									...
									if (var10.type == 4) {
										...
										SpritePixels var44;
										if (!var10.isIf3) {
											var44 = var10.method6157(class26.runCs1(var10), TaskHandler.urlRequester);
											if (var44 != null) {
											...
											if (var10.itemId != -1) {
												...
												var44 = var10.method6157(false, TaskHandler.urlRequester);
											}
										...
										if (var10.type == 6) {
											boolean var39 = class26.runCs1(var10);
											if (var39) {
