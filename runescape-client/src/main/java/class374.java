	...
	static final void drawActor2d(Actor var0, int var1, int var2, int var3, int var4, int var5) {
		if (var0 != null && var0.isVisible()) {
			...
			if (var0.overheadText != null && (!var8 || !var0.field1166 && (Client.publicChatMode == 4 || !var0.field1181 && (Client.publicChatMode == 0 || Client.publicChatMode == 3 || Client.publicChatMode == 1 && ((Player)var0).isFriend())))) {
				...
				if (Client.viewportTempX > -1 && Client.field599 < Client.field571) {
					Client.field577[Client.field599] = class19.fontBold12.stringWidth(var0.overheadText) / 2;
					Client.field781[Client.field599] = class19.fontBold12.ascent;
					Client.field601[Client.field599] = Client.viewportTempX;
					Client.field602[Client.field599] = Client.viewportTempY - var9;
					Client.field605[Client.field599] = var0.field1161;
					Client.field617[Client.field599] = var0.field1185;
					Client.field726[Client.field599] = var0.overheadTextCyclesRemaining;
					Client.field729[Client.field599] = var0.overheadText;
					++Client.field599;
					var9 += 12;
				}
			}
			...
			if (!var0.healthBars.method6900()) {
				...
				for (HealthBar var10 = (HealthBar)var0.healthBars.last(); var10 != null; var10 = (HealthBar)var0.healthBars.previous()) {
					...
					if (var11 == null) {
						...
						SpritePixels var78 = var77.method3666();
						SpritePixels var84 = var77.method3675();
						int var85 = 0;
				...
				if (var101 != null && var93 != null) {
					for (int var95 = 0; var95 < var101.length; ++var95) {
						if (var101[var95] >= 0 && var93[var95] >= 0) {
							...
							if (var16 == null) {
								SpritePixels[] var17 = class220.method4629(WorldMapEvent.archive8, var93[var95], 0);
