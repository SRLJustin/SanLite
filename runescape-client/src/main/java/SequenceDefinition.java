...
public class SequenceDefinition extends DualNode {
	...
	public Model transformActorModel(Model var1, int var2) {
		...
		if (!this.method3799()) {
			...
			class122 var3 = class117.method2724(this.field2154);
			if (var3 == null) {
				return var1.toSharedSequenceModel(true);
			} else {
	...
	Model transformObjectModel(Model var1, int var2, int var3) {
		...
		if (!this.method3799()) {
			...
			class122 var4 = class117.method2724(this.field2154);
			if (var4 == null) {
				return var1.toSharedSequenceModel(true);
			} else {
	...
	public Model applyTransformations(Model var1, int var2, SequenceDefinition var3, int var4) {
		if (field2150 && !this.method3799() && !var3.method3799()) {
			...
			if (this.method3799()) {
				...
				if (var3.method3799() && this.field2164 == null) {
				...
				if (!var3.method3799() && (this.field2156 == null || var4 == -1)) {
	...
	public class122 method3801() {
		return this.method3799() ? class117.method2724(this.field2154) : null;
	}
}
