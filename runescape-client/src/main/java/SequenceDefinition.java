...
public class SequenceDefinition extends DualNode {
	...
	public Model transformActorModel(Model var1, int var2) {
		...
		if (!this.method3725()) {
			...
			class122 var3 = StructComposition.method3543(this.field2176);
			if (var3 == null) {
				return var1.toSharedSequenceModel(true);
			} else {
	...
	Model transformObjectModel(Model var1, int var2, int var3) {
		...
		if (!this.method3725()) {
			...
			class122 var4 = StructComposition.method3543(this.field2176);
			if (var4 == null) {
				return var1.toSharedSequenceModel(true);
			} else {
	...
	public Model applyTransformations(Model var1, int var2, SequenceDefinition var3, int var4) {
		if (field2169 && !this.method3725() && !var3.method3725()) {
			...
			if (this.method3725()) {
				...
				if (var3.method3725() && this.field2172 == null) {
					var5.method4305(var9, var2);
					return var5;
				}

				var8 = var9.field1498;
				var5.method4285(var8, var9, var2, this.field2172, false, !var3.method3725());
			} else {
				var2 = this.frameIds[var2];
				...
				if (!var3.method3725() && (this.field2171 == null || var4 == -1)) {
	...
	public boolean method3725() {
		return this.field2176 >= 0;
	}
	...
	class122 method3726() {
		return this.method3725() ? StructComposition.method3543(this.field2176) : null;
	}
