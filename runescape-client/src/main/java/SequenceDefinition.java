...
public class SequenceDefinition extends DualNode {
	...
	public Model applyTransformations(Model var1, int var2, SequenceDefinition var3, int var4) {
		if (field2166 && !this.method3834() && !var3.method3834()) {
			...
			if (this.method3834()) {
				...
				if (var3.method3834() && this.field2181 == null) {
				...
				if (!var3.method3834() && (this.field2180 == null || var4 == -1)) {
	...
	public boolean method3834() {
		return this.field2189 >= 0;
	}
