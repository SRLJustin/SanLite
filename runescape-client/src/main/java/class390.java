			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					if (class463.friendsChatManager != null) {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = class463.friendsChatManager.name;
					} else {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (class463.friendsChatManager != null) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class463.friendsChatManager.getSize();
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					if (class463.friendsChatManager != null && var3 < class463.friendsChatManager.getSize()) {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = class463.friendsChatManager.get(var3).getUsername().getName();
					} else {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					if (class463.friendsChatManager != null && var3 < class463.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = ((Buddy)class463.friendsChatManager.get(var3)).getWorld();
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					if (class463.friendsChatManager != null && var3 < class463.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = ((Buddy)class463.friendsChatManager.get(var3)).rank;
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class463.friendsChatManager != null ? class463.friendsChatManager.minKick : 0;
					return 1;
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class463.friendsChatManager != null ? class463.friendsChatManager.rank : 0;
					return 1;
					...
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					if (class463.friendsChatManager != null && var3 < class463.friendsChatManager.getSize() && class463.friendsChatManager.get(var3).getUsername().equals(class387.localPlayer.username)) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (class463.friendsChatManager != null && class463.friendsChatManager.owner != null) {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = class463.friendsChatManager.owner;
					} else {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					if (class463.friendsChatManager != null && var3 < class463.friendsChatManager.getSize() && ((FriendsChatMember)class463.friendsChatManager.get(var3)).isFriend()) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (var0 == 3628) {
						...
						if (var0 == 3629) {
							...
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.removeComparator();
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new UserComparator1(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new UserComparator2(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new UserComparator3(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new UserComparator4(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new UserComparator5(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new UserComparator6(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new UserComparator7(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new UserComparator8(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new UserComparator9(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new UserComparator10(var7));
							}

							return 1;
						} else if (var0 == 3655) {
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.sort();
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
							if (class463.friendsChatManager != null) {
								class463.friendsChatManager.addComparator(new BuddyRankComparator(var7));
							}
					...
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					if (class463.friendsChatManager != null && var3 < class463.friendsChatManager.getSize() && ((FriendsChatMember)class463.friendsChatManager.get(var3)).isIgnored()) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
	...
	static final void drawModelComponents(Widget[] var0, int var1) {
		for (int var2 = 0; var2 < var0.length; ++var2) {
			...
			if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !class160.isComponentHidden(var3))) {
				int var5;
				if (var3.type == 0) {
					if (!var3.isIf3 && class160.isComponentHidden(var3) && var3 != class25.mousedOverWidgetIf1) {
						continue;
					}
				...
				if (var3.type == 6) {
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
						...
						if (var5 != -1) {
							...
							if (!var6.method4070()) {
								for (var3.modelFrameCycle += Client.field574; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; LoginScreenAnimation.method2477(var3)) {
								...
								var3.modelFrame += Client.field574;
								...
								LoginScreenAnimation.method2477(var3);
							}
						}
					}
					...
					if (var3.field3585 != 0 && !var3.isIf3) {
						...
						var9 *= Client.field574;
						var5 *= Client.field574;
