...
public class class390 {
	...
	public static IndexedSprite[] method7253(AbstractArchive var0, int var1, int var2) {
		return !Occluder.SpriteBuffer_loadSpritesFromArchive(var0, var1, var2) ? null : GraphicsObject.method2018();
	}
		...
		for (int var0 = 0; var0 < Client.soundEffectCount; ++var0) {
			...
			if (Client.queuedSoundEffectDelays[var0] >= -10) {
				...
				if (Client.queuedSoundEffectDelays[var0] < 0) {
					...
					if (var2 > 0) {
						RawSound var9 = var1.toRawSound().resample(class327.field4119);
		...
		if (Client.field651) {
			...
			if (!var12) {
				if (Player.clientPreferences.method2402() != 0 && Client.currentTrackGroupId != -1) {
					Message.method1164(class14.field76, Client.currentTrackGroupId, 0, Player.clientPreferences.method2402(), false);
				}
