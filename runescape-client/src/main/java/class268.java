	...
	static final void method5364(int var0) {
		...
		for (var5 = 0; var5 < 104; ++var5) {
			for (var6 = 0; var6 < 104; ++var6) {
				long var7 = class139.scene.getGroundObjectTag(ApproximateRouteStrategy.Client_plane, var5, var6);
				if (0L != var7) {
					...
					if (var10 >= 0 && Actor.WorldMapElement_get(var10).field1871) {
						...
						Client.field691[Client.mapIconCount] = var5;
						Client.field744[Client.mapIconCount] = var6;
						++Client.mapIconCount;
					}
				}
			}
