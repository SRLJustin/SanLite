...
public final class class268 {
	...
	static final void method5214(int var0, int var1, int var2, int var3, int var4, int var5, Scene var6, CollisionMap var7) {
			...
			if (var5 == 22) {
				...
				if (var5 != 10 && var5 != 11) {
					...
					if (var5 >= 12) {
						...
						var6.newWallObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, Tiles.field1007[var4], 0, var19, var21);
						if (var4 == 0) {
							if (var8.clipped) {
						...
						var6.newWallObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, Tiles.field1011[var4], 0, var19, var21);
						if (var8.clipped) {
							if (var4 == 0) {
								UserComparator6.field1415[var0][var1][var2 + 1] = 50;
							} else if (var4 == 1) {
						...
						if (var5 == 2) {
							...
							var6.newWallObject(var0, var1, var2, var16, (Renderable)var30, (Renderable)var24, Tiles.field1007[var4], Tiles.field1007[var22], var19, var21);
							if (var8.modelClipped) {
								if (var4 == 0) {
									var10000 = class1.field2[var0][var1];
									var10000[var2] |= 585;
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, Tiles.field1007[var4], 0, 0, 0, var19, var21);
						} else {
							long var23;
							Object var25;
							if (var5 == 5) {
								...
								var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, Tiles.field1007[var4], 0, var22 * Tiles.field1003[var4], var22 * Tiles.field1005[var4], var19, var21);
							} else if (var5 == 6) {
								var22 = 8;
								var23 = var6.getWallObjectTag(var0, var1, var2);
								if (0L != var23) {
								...
								var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, 256, var4, var22 * Tiles.field1006[var4], var22 * Tiles.field1002[var4], var19, var21);
							} else if (var5 == 7) {
								var28 = var4 + 2 & 3;
								if (var8.animationId == -1 && var8.transforms == null) {
								...
								var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)var26, 256, var4, var22 * Tiles.field1006[var4], var22 * Tiles.field1002[var4], var19, var21);
							}
						}
					}
				} else {
