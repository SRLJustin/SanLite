...
public class UserComparator8 extends AbstractUserComparator {
	...
	static int method2553(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.IF_GETINVOBJECT) {
			...
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var3.itemId;
			return 1;
			...
			int var5 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
			...
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.rootInterface;
			return 1;
		} else if (var0 == 2707) {
			var3 = HitSplatDefinition.getWidget(Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]);
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var3.method5562() ? 1 : 0;
			return 1;
		} else if (var0 == 2708) {
			var3 = HitSplatDefinition.getWidget(Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]);
