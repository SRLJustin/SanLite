			...
			for (var3 = 0; var3 < 104; ++var3) {
				for (var4 = 0; var4 < 104; ++var4) {
					if ((Tiles.Tiles_renderFlags[var2][var3][var4] & 1) == 1) {
						...
						if (var5 >= 0) {
							var1[var5].method3880(var3, var4);
						}
					}
				}
			}
					...
					if (var13 >= 0 && var13 < 104) {
						...
						if (var14 > 0) {
							...
							if (var43 != null) {
								...
								byte[] var44 = FloorUnderlayDefinition.field1990.takeFile(1, var16);
					...
					if (var14 >= 0 && var14 < 104) {
						...
						if (var15 > 0) {
							...
							if (var56 != null) {
								...
								byte[] var46 = FloorUnderlayDefinition.field1990.takeFile(1, var17);
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var20 > 0 || var21 > 0) {
								...
								if (var20 > 0) {
									...
									var30 = class21.method265(var32, var33, var34);
									...
									var31 = class21.method265(var32, var33, var34);
								}
								...
								if (var21 == 0) {
									...
									if (var36 >= 0) {
										...
										var37 = class21.method265(var35.hue, var35.saturation, var35.lightness);
										...
										var38 = class21.method265(var39, var35.saturation, var40);
									}
									...
									if (var35.secondaryRgb != -1) {
										...
										var38 = class21.method265(var40, var35.secondarySaturation, var41);
										var39 = Rasterizer3D.Rasterizer3D_colorPalette[ModeWhere.method6079(var38, 96)];
									}
