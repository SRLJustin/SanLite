...
public class VorbisFloor {
	...
	static {
		field271 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			if (field276 == null || field276.length < var5) {
				field276 = new int[var5];
				field269 = new int[var5];
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field276[var1];
			int var5 = field269[var1];
			boolean var6 = field278[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field276[var7];
				if (var8 < var4) {
					field276[var3] = var8;
					field269[var3] = field269[var7];
					field278[var3] = field278[var7];
					++var3;
					field276[var7] = field276[var3];
					field269[var7] = field269[var3];
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			var3 = field271[this.multiplier - 1];
			int var4 = class143.iLog(var3 - 1);
			field269[0] = VorbisSample.readBits(var4);
			field269[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				for (int var12 = 0; var12 < var8; ++var12) {
					...
					var11 >>>= var9;
					field269[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method981() : 0;
				}
			}
	...
	void method668(float[] var1, int var2) {
		...
		int var4 = field271[this.multiplier - 1];
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method689(field276, var6);
			var8 = method662(field276, var6);
			var9 = this.method664(field276[var7], field269[var7], field276[var8], field269[var8], field276[var6]);
			var10 = field269[var6];
			int var11 = var4 - var9;
			...
			if (var10 != 0) {
				...
				field278[var6] = true;
				if (var10 >= var13) {
					field269[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field269[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field278[var6] = false;
				field269[var6] = var9;
		...
		var6 = 0;
		var7 = field269[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field278[var8]) {
				var9 = field276[var8];
				var10 = field269[var8] * this.multiplier;
				this.method665(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
