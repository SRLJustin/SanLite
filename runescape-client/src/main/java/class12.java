...
class class12 extends SSLSocket {
	...
	static final void method158(int var0, int var1) {
		if (Client.hintArrowType == 2) {
			VarbitComposition.worldToScreen(Client.field519 * 64 + (Client.hintArrowX - GrandExchangeOfferOwnWorldComparator.baseX * 64 << 7), Client.field520 * 64 + (Client.hintArrowY - VarcInt.baseY * 64 << 7), Client.field518 * 4);
