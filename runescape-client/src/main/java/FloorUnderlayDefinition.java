...
public class FloorUnderlayDefinition extends DualNode {
	...
	public static AbstractArchive field1990;
	@ObfuscatedName("v")
	@ObfuscatedSignature(
		descriptor = "Lii;"
	)
