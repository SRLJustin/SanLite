	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
			...
			if (0L != var7) {
				...
				if (var1 == 0) {
					ReflectionCheck.scene.removeWallObject(var0, var2, var3);
				...
				if (var1 == 3) {
					ReflectionCheck.scene.removeGroundObject(var0, var2, var3);
					var13 = VarpDefinition.getObjectDefinition(var38);
			...
			if (var4 >= 0) {
				...
				if (var6 == 22) {
					...
					if (var6 >= 12) {
						...
						var41.newWallObject(var0, var2, var3, var23, (Renderable)var36, (Renderable)null, Tiles.field1032[var5], 0, var26, var28);
						if (var15.interactType != 0) {
						...
						var41.newWallObject(var0, var2, var3, var23, (Renderable)var36, (Renderable)null, Tiles.field1036[var5], 0, var26, var28);
						if (var15.interactType != 0) {
							var14.method4142(var2, var3, var6, var5, var15.boolean1);
						}
					} else {
						...
						if (var6 == 2) {
							...
							var41.newWallObject(var0, var2, var3, var23, (Renderable)var37, (Renderable)var31, Tiles.field1032[var5], Tiles.field1032[var29], var26, var28);
							if (var15.interactType != 0) {
								var14.method4142(var2, var3, var6, var5, var15.boolean1);
							}
						} else if (var6 == 3) {
							...
							var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var36, (Renderable)null, Tiles.field1032[var5], 0, 0, 0, var26, var28);
						} else {
							long var30;
							Object var32;
							if (var6 == 5) {
								...
								var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var32, (Renderable)null, Tiles.field1032[var5], 0, var29 * Tiles.field1035[var5], var29 * Tiles.field1029[var5], var26, var28);
							} else if (var6 == 6) {
								var29 = 8;
								var30 = var41.getWallObjectTag(var0, var2, var3);
								if (var30 != 0L) {
								...
								var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var32, (Renderable)null, 256, var5, var29 * Tiles.field1037[var5], var29 * Tiles.field1025[var5], var26, var28);
							} else if (var6 == 7) {
								int var35 = var5 + 2 & 3;
								if (var15.animationId == -1 && var15.transforms == null) {
								...
								var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var32, (Renderable)var33, 256, var5, var29 * Tiles.field1037[var5], var29 * Tiles.field1025[var5], var26, var28);
							}
						}
					}
				} else {
