...
public class class144 extends class152 {
	...
	static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null && var9.parentId == var1 && (var9.method6298() || Clock.getWidgetFlags(var9) != 0 || var9 == Client.field694)) {
				if (var9.isIf3) {
				...
				if (var34 || !var9.isIf3 || var12 < var14 && var13 < var15) {
						...
						if (var9.noClickThrough) {
							if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15) {
								for (var27 = (ScriptEvent)Client.scriptEvents.last(); var27 != null; var27 = (ScriptEvent)Client.scriptEvents.previous()) {
									if (var27.field1075) {
										var27.remove();
										var27.widget.field3684 = false;
									}
								}

								ClientPacket.method5481();
								if (class87.field1109 == 0) {
									Client.clickedWidget = null;
									Client.field694 = null;
								}
					...
					if (var9.contentType == 1337) {
						if (!Client.field517 && !Client.isMenuOpen && var35) {
						...
						if (var9.isIf3) {
							...
							if (Client.clickedWidget != null && var9 != Client.clickedWidget && var35 && class136.method3075(Clock.getWidgetFlags(var9))) {
								Client.field697 = var9;
							}

							if (var9 == Client.field694) {
							...
							if (var9.hasListener) {
								...
								if (var9.field3684 && var35 && var9.onMouseRepeat != null) {
									var22 = new ScriptEvent();
									var22.field1075 = true;
									var22.widget = var9;
									var22.mouseX = MouseHandler.MouseHandler_x - var26;
