			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					if (Huffman.friendsChatManager != null) {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = Huffman.friendsChatManager.name;
					} else {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (Huffman.friendsChatManager != null) {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = Huffman.friendsChatManager.getSize();
					} else {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize];
					if (Huffman.friendsChatManager != null && var3 < Huffman.friendsChatManager.getSize()) {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = Huffman.friendsChatManager.get(var3).getUsername().getName();
					} else {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize];
					if (Huffman.friendsChatManager != null && var3 < Huffman.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = ((Buddy)Huffman.friendsChatManager.get(var3)).getWorld();
					} else {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize];
					if (Huffman.friendsChatManager != null && var3 < Huffman.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = ((Buddy)Huffman.friendsChatManager.get(var3)).rank;
					} else {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = 0;
					}
					...
					Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = Huffman.friendsChatManager != null ? Huffman.friendsChatManager.minKick : 0;
					return 1;
					...
					Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = Huffman.friendsChatManager != null ? Huffman.friendsChatManager.rank : 0;
					return 1;
					...
					var3 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize];
					if (Huffman.friendsChatManager != null && var3 < Huffman.friendsChatManager.getSize() && Huffman.friendsChatManager.get(var3).getUsername().equals(class101.localPlayer.username)) {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (Huffman.friendsChatManager != null && Huffman.friendsChatManager.owner != null) {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = Huffman.friendsChatManager.owner;
					} else {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize];
					if (Huffman.friendsChatManager != null && var3 < Huffman.friendsChatManager.getSize() && ((FriendsChatMember)Huffman.friendsChatManager.get(var3)).isFriend()) {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (var0 == 3628) {
						...
						if (var0 == 3629) {
							...
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.removeComparator();
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new UserComparator1(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new UserComparator2(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new UserComparator3(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new UserComparator4(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new UserComparator5(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new UserComparator6(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new UserComparator7(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new UserComparator8(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new UserComparator9(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new UserComparator10(var7));
							}

							return 1;
						} else if (var0 == 3655) {
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.sort();
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1;
							if (Huffman.friendsChatManager != null) {
								Huffman.friendsChatManager.addComparator(new BuddyRankComparator(var7));
							}
					...
					var3 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize];
					if (Huffman.friendsChatManager != null && var3 < Huffman.friendsChatManager.getSize() && ((FriendsChatMember)Huffman.friendsChatManager.get(var3)).isIgnored()) {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = 0;
					}
