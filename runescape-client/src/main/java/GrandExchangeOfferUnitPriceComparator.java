		...
		if (var0 == ScriptOpcodes.CLIENTCLOCK) {
			...
			if (var0 == ScriptOpcodes.INV_GETOBJ) {
				...
				if (var0 == ScriptOpcodes.COORD) {
					...
					class87.Interpreter_intStackSize -= 2;
					var3 = Interpreter.Interpreter_intStack[class87.Interpreter_intStackSize] + 32768;
					var4 = Interpreter.Interpreter_intStack[class87.Interpreter_intStackSize + 1];
					Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = class18.method267(var3, var4);
					return 1;
					...
					Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = Client.field629 / 100;
					return 1;
					...
					Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = Client.field629;
					return 1;
				} else {
					return 2;
				}
