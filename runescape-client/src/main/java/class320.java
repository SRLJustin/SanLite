	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
			...
			if (0L != var7) {
				...
				if (var1 == 0) {
					class139.scene.removeWallObject(var0, var2, var3);
				...
				if (var1 == 3) {
					class139.scene.removeGroundObject(var0, var2, var3);
					var13 = InterfaceParent.getObjectDefinition(var38);
					...
					if (var6 >= 12) {
						...
						if (var6 == 2) {
							...
							if (var6 == 5) {
								...
								var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var32, (Renderable)null, Tiles.field999[var5], 0, var29 * Tiles.field991[var5], var29 * Tiles.field1003[var5], var26, var28);
							} else if (var6 == 6) {
								var29 = 8;
								var30 = var41.getWallObjectTag(var0, var2, var3);
								if (0L != var30) {
								...
								var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var32, (Renderable)null, 256, var5, var29 * Tiles.field993[var5], var29 * Tiles.field1004[var5], var26, var28);
							} else if (var6 == 7) {
								int var35 = var5 + 2 & 3;
								if (var15.animationId == -1 && var15.transforms == null) {
								...
								var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var32, (Renderable)var33, 256, var5, var29 * Tiles.field993[var5], var29 * Tiles.field1004[var5], var26, var28);
							}
						}
					}
				} else {
