...
public class class305 {
	...
	static final void method6206(Scene var0, CollisionMap[] var1) {
			...
			for (var3 = 0; var3 < 104; ++var3) {
				for (var4 = 0; var4 < 104; ++var4) {
					if ((Tiles.Tiles_renderFlags[var2][var3][var4] & 1) == 1) {
						...
						if (var5 >= 0) {
							var1[var5].method4004(var3, var4);
						}
					}
				}
			}
		...
		for (var2 = 0; var2 < 4; ++var2) {
			...
			for (var11 = 0; var11 < 104; ++var11) {
				class32.field181[var11] = 0;
				FriendSystem.field818[var11] = 0;
				DefaultsGroup.field4531[var11] = 0;
				ClanChannelMember.field1591[var11] = 0;
					...
					if (var13 >= 0 && var13 < 104) {
						...
						if (var15 > 0) {
							...
							if (var50 != null) {
								...
								byte[] var51 = FloorUnderlayDefinition.field2024.takeFile(1, var17);
							...
							var10000 = class32.field181;
							var10000[var12] += var52.hue;
							var10000 = FriendSystem.field818;
							var10000[var12] += var52.saturation;
							var10000 = DefaultsGroup.field4531;
							var10000[var12] += var52.lightness;
							var10000 = ClanChannelMember.field1591;
					...
					if (var14 >= 0 && var14 < 104) {
						...
						if (var16 > 0) {
							...
							if (var63 != null) {
								...
								byte[] var53 = FloorUnderlayDefinition.field2024.takeFile(1, var18);
				...
				if (var11 >= 1 && var11 < 103) {
					...
					for (var17 = -5; var17 < 109; ++var17) {
						...
						if (var18 >= 0 && var18 < 104) {
							var12 += class32.field181[var18];
							var13 += FriendSystem.field818[var18];
							var14 += DefaultsGroup.field4531[var18];
							var15 += ClanChannelMember.field1591[var18];
							var16 += class410.field4590[var18];
						}

						var19 = var17 - 5;
						if (var19 >= 0 && var19 < 104) {
							var12 -= class32.field181[var19];
							var13 -= FriendSystem.field818[var19];
							var14 -= DefaultsGroup.field4531[var19];
							var15 -= ClanChannelMember.field1591[var19];
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var21 > 0 || var22 > 0) {
								...
								if (var21 > 0) {
									...
									var34 = var13 / var16;
									var35 = var14 / var16;
									var31 = UserComparator10.method2789(var33, var34, var35);
									...
									var32 = UserComparator10.method2789(var33, var34, var35);
								}
								...
								if (var22 == 0) {
									...
									if (var49 >= 0) {
										...
										var40 = UserComparator10.method2789(var36.hue, var36.saturation, var36.lightness);
										...
										var41 = UserComparator10.method2789(var42, var36.saturation, var43);
									}
									...
									if (var36.secondaryRgb != -1) {
										...
										var41 = UserComparator10.method2789(var43, var36.secondarySaturation, var44);
										var42 = Rasterizer3D.Rasterizer3D_colorPalette[HealthBarDefinition.method3516(var41, 96)];
									}
	...
	static int method6209(int var0, Script var1, boolean var2) {
		...
		if (var0 >= 2000) {
			...
			var3 = var2 ? class140.scriptDotWidget : class136.field1589;
		}
