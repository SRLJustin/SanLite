...
public class LoginType {
	...
	static {
		...
		field4612 = new LoginType(1, 1, "", "");
		field4610 = new LoginType(2, 2, "", "");
		field4615 = new LoginType(4, 3, "", "");
		field4611 = new LoginType(6, 4, "", "");
		field4613 = new LoginType(0, 5, "", "");
		field4614 = new LoginType(8, 6, "", "");
		field4609 = new LoginType(7, 7, "", "");
		field4616 = new LoginType(5, -1, "", "", true, new LoginType[]{oldscape, field4612, field4610, field4611, field4615});
	}
