...
public class MenuAction {
	...
	public static void method2021() {
		if (MouseHandler.KeyHandler_instance != null) {
			synchronized(MouseHandler.KeyHandler_instance) {
				MouseHandler.KeyHandler_instance = null;
			}
		}
				...
				if (var3.type == 6) {
					...
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
						...
						if (var5 != -1) {
							...
							if (!var6.method3886()) {
								for (var3.modelFrameCycle += Client.field558; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; class143.method3053(var3)) {
		...
		if (var4 != null) {
			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				for (var8 = 0; var8 < Client.mapIconCount; ++var8) {
					var16 = Client.field691[var8] * 4 + 2 - class296.localPlayer.x / 32;
					var10 = Client.field744[var8] * 4 + 2 - class296.localPlayer.y / 32;
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					...
					if (Client.hintArrowType == 2) {
						var10 = Client.field512 * 4 - class26.baseX * 256 + 2 - class296.localPlayer.x / 32;
						var11 = Client.field513 * 4 - class158.baseY * 256 + 2 - class296.localPlayer.y / 32;
