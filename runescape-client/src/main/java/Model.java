...
public class Model extends Renderable {
	...
	static {
		...
		field2504 = new class388();
		field2571 = new class388();
		field2576 = new class388();
		field2540 = new boolean[6500];
		...
		field2579 = new int[6500];
		field2551 = new int[6500];
		field2539 = new char[6000];
		field2554 = new char[6000][512];
		field2555 = new int[12];
		field2556 = new int[12][2000];
		field2557 = new int[2000];
		field2565 = new int[2000];
		field2559 = new int[12];
		field2560 = new int[10];
		field2561 = new int[10];
		field2562 = new int[10];
		field2566 = true;
		...
		if (this.diameter < 6000) {
				...
				if (this.faceColors3[var7] != -2) {
					...
					if (!var1 || var11 != -5000 && var12 != -5000 && var28 != -5000) {
						...
						if ((var11 - var12) * (modelViewportYs[var10] - modelViewportYs[var9]) - (var28 - var12) * (modelViewportYs[var8] - modelViewportYs[var9]) > 0) {
							...
							field2554[var29][field2539[var29]++] = var7;
						}
					} else {
						...
						if (var15 * var23 + var18 * var24 + var21 * var25 > 0) {
							...
							field2554[var26][field2539[var26]++] = var7;
						}
					}
				}
			}
			...
			if (this.faceRenderPriorities == null) {
				for (var33 = this.diameter - 1; var33 >= 0; --var33) {
					var34 = field2539[var33];
					if (var34 > 0) {
						var27 = field2554[var33];
				...
				for (var33 = this.diameter - 1; var33 >= 0; --var33) {
					...
					if (var34 > 0) {
						...
						for (var10 = 0; var10 < var34; ++var10) {
							...
							var28 = field2555[var36]++;
							field2556[var36][var28] = var35;
							if (var36 < 10) {
								int[] var38 = field2559;
								var38[var36] += var33;
							} else if (var36 == 10) {
					...
					if (var21 / var14 > Rasterizer3D.Rasterizer3D_clipNegativeMidY) {
						...
						if (var23 / var14 < Rasterizer3D.Rasterizer3D_clipMidY2) {
								...
								if (field2566) {
									...
									if (!class143.method3076()) {
										...
										if (!ViewportMouse.ViewportMouse_false0) {
											...
											var56 = Rasterizer3D.method4025(var45, var42, var39, var38);
											var45 = var48;
											var48 = Rasterizer3D.method4024(var47, var43, var39, var38);
											var57 = Rasterizer3D.method4025(var47, var43, var39, var38);
											var47 = var48;
											var48 = Rasterizer3D.method4022(var44, var56, var41, var40);
											var56 = Rasterizer3D.method4078(var44, var56, var41, var40);
											var44 = var48;
											var48 = Rasterizer3D.method4022(var46, var57, var41, var40);
											var57 = Rasterizer3D.method4078(var46, var57, var41, var40);
											ViewportMouse.field2587 = (var48 + var44) / 2;
											GrandExchangeOfferOwnWorldComparator.field480 = (var45 + var47) / 2;
											ViewportMouse.field2580 = (var57 + var56) / 2;
											ViewportMouse.field2586 = (var48 - var44) / 2;
											class124.field1522 = (var47 - var45) / 2;
											ViewportMouse.field2583 = (var57 - var56) / 2;
										...
										if (Math.abs(var44) > var41 + class20.field115) {
											var36 = false;
										} else if (Math.abs(var45) > var56 + class181.field1987) {
											var36 = false;
										} else if (Math.abs(var46) > var57 + class128.field1543) {
											var36 = false;
										} else if (Math.abs(var46 * class124.field1522 - var45 * ViewportMouse.field2583) > var57 * class181.field1987 + var56 * class128.field1543) {
											var36 = false;
										} else if (Math.abs(var44 * ViewportMouse.field2583 - var46 * ViewportMouse.field2586) > var41 * class128.field1543 + var57 * class20.field115) {
											var36 = false;
										} else if (Math.abs(var45 * ViewportMouse.field2586 - var44 * class124.field1522) > var41 * class181.field1987 + var56 * class20.field115) {
											var36 = false;
										} else {
											var36 = true;
										}
							...
							for (var39 = 0; var39 < this.verticesCount; ++var39) {
								...
								var56 = this.verticesZ[var39];
								if (var1 != 0) {
									var57 = var56 * var49 + var40 * var38 >> 16;
									var56 = var56 * var38 - var40 * var49 >> 16;
									var40 = var57;
								}
								...
								var41 += var7;
								var56 += var8;
								var57 = var56 * var4 + var5 * var40 >> 16;
								var56 = var5 * var56 - var40 * var4 >> 16;
								var40 = var57;
								var57 = var3 * var41 - var56 * var2 >> 16;
								var56 = var41 * var2 + var3 * var56 >> 16;
								field2553[var39] = var56 - var12;
								if (var56 >= 50) {
									modelViewportXs[var39] = var40 * Rasterizer3D.Rasterizer3D_zoom / var56 + var54;
									modelViewportYs[var39] = var57 * Rasterizer3D.Rasterizer3D_zoom / var56 + var55;
								} else {
								...
								if (var27) {
									...
									field2579[var39] = var57;
									field2551[var39] = var56;
								}
							}
