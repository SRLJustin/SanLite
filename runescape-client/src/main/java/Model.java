								...
								if (field2524) {
									...
									if (!class174.method3458()) {
										...
										if (Math.abs(var43) > var40 + class421.field4607) {
											...
											var35 = false;
										} else if (Math.abs(var45 * ItemComposition.field2148 - var44 * Nameable.field4308) > var53 * class136.field1612 + var54 * ViewportMouse.field2590) {
											var35 = false;
										} else if (Math.abs(var43 * Nameable.field4308 - var45 * ViewportMouse.field2589) > var54 * class421.field4607 + var40 * class136.field1612) {
											var35 = false;
