...
public class Model extends Renderable {
	...
	static {
		...
		field2671 = new class410();
		field2672 = new class410();
		field2673 = new class410();
		field2706 = new boolean[6500];
		field2707 = new boolean[6500];
		modelViewportXs = new int[6500];
		modelViewportYs = new int[6500];
		field2675 = new int[6500];
		field2711 = new int[6500];
		field2712 = new int[6500];
		field2676 = new int[6500];
		field2721 = new char[6000];
		field2685 = new char[6000][512];
		field2677 = new int[12];
		field2740 = new int[12][2000];
		field2719 = new int[2000];
		field2720 = new int[2000];
		field2690 = new int[12];
		field2722 = new int[10];
		field2667 = new int[10];
		field2713 = new int[10];
		field2728 = true;
