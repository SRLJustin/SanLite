		...
		if (Client.minimapState == 0 || Client.minimapState == 3) {
			if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !SceneTilePaint.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) {
				...
				if (var3.contains(var4, var5)) {
					...
					var13.packetBuffer.method8588(class365.baseY * 64 + var12);
					...
					if (class276.field3158 == var0) {
						...
						if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
							...
							if (class155.localPlayer.pathX[0] >= var5 - var10 && class155.localPlayer.pathX[0] <= var5 + var10 && class155.localPlayer.pathY[0] >= var6 - var10 && class155.localPlayer.pathY[0] <= var10 + var6 && StructComposition.clientPreferences.method2506() != 0 && var9 > 0 && Client.soundEffectCount < 50) {
								Client.field766[Client.soundEffectCount] = var3;
								Client.field767[Client.soundEffectCount] = var9;
								Client.field795[Client.soundEffectCount] = var2;
								Client.field575[Client.soundEffectCount] = null;
								Client.field621[Client.soundEffectCount] = var8 + (var6 << 8) + (var5 << 16);
					...
					if (class276.field3164 == var0) {
						...
						if (class276.field3170 == var0) {
							...
							if (var3 >= 0 && var4 >= 0 && var3 < 103 && var4 < 103) {
								if (var9 == 0) {
									WallObject var34 = ReflectionCheck.scene.method4452(class383.Client_plane, var3, var4);
									if (var34 != null) {
								...
								if (var9 == 1) {
									DecorativeObject var44 = ReflectionCheck.scene.method4604(class383.Client_plane, var3, var4);
									if (var44 != null) {
								...
								if (var9 == 3) {
									GroundObject var46 = ReflectionCheck.scene.getGroundObject(class383.Client_plane, var3, var4);
									if (var46 != null) {
