...
public class MouseRecorder implements Runnable {
	...
	static int method2072(int var0, Script var1, boolean var2) {
		...
		if (var4.length() > 0 && var4.charAt(var4.length() - 1) == 'Y') {
			...
			if (var6 > 0) {
				for (var5 = new int[var6]; var6-- > 0; var5[var6] = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]) {
				}
			}
		...
		for (var7 = var8.length - 1; var7 >= 1; --var7) {
			if (var4.charAt(var7 - 1) == 's') {
				...
				var8[var7] = new Integer(Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]);
			}
		}
