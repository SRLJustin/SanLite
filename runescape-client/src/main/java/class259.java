	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) {
			if (var2) {
				...
				Players.Players_regions[var1] = (var4.plane << 28) + (class128.baseX * 64 + var4.pathX[0] >> 13 << 14) + (WorldMapData_1.baseY * 8 + var4.pathY[0] >> 13);
				if (var4.field1163 != -1) {
			...
			if (var3 == 1) {
				...
				if (var5 == 0) {
					...
					var11 = (WorldMapData_1.baseY * 8 + var9 + var4.pathY[0] & 16383) - WorldMapData_1.baseY * 8;
					if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) {
						var4.resetPath(var10, var11);
						var4.field1103 = false;
					} else if (var2) {
	...
	static final void method5338(int var0, int var1, int var2, int var3, int var4, int var5, int var6, Scene var7, CollisionMap var8) {
		...
		if (var6 == 22) {
			...
			if (var6 >= 12) {
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1013[var5], 0, var20, var22);
				if (var9.interactType != 0) {
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1005[var5], 0, var20, var22);
				if (var9.interactType != 0) {
					var8.method3988(var2, var3, var6, var5, var9.boolean1);
				}
				...
				if (var6 == 2) {
					...
					var7.newWallObject(var0, var2, var3, var17, (Renderable)var31, (Renderable)var25, Tiles.field1013[var5], Tiles.field1013[var23], var20, var22);
					if (var9.interactType != 0) {
						var8.method3988(var2, var3, var6, var5, var9.boolean1);
					}
					...
					var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1013[var5], 0, 0, 0, var20, var22);
				} else {
					long var24;
					Object var26;
					if (var6 == 5) {
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, Tiles.field1013[var5], 0, var23 * Tiles.field1006[var5], var23 * Tiles.field1000[var5], var20, var22);
					} else if (var6 == 6) {
						var23 = 8;
						var24 = var7.getWallObjectTag(var0, var2, var3);
						if (0L != var24) {
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, 256, var5, var23 * Tiles.field1003[var5], var23 * Tiles.field1009[var5], var20, var22);
					} else if (var6 == 7) {
						int var29 = var5 + 2 & 3;
						if (var9.animationId == -1 && var9.transforms == null) {
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)var27, 256, var5, var23 * Tiles.field1003[var5], var23 * Tiles.field1009[var5], var20, var22);
					}
				}
			}
		} else {
