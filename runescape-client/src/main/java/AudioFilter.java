...
public class AudioFilter {
	...
	int compute(int var1, float var2) {
		...
		if (this.pairs[var1] == 0) {
			...
			var3 = this.method1042(var1, 0, var2);
			field410[var1][0] = -2.0F * var3 * (float)Math.cos((double)this.method1040(var1, 0, var2));
			field410[var1][1] = var3 * var3;

			float[] var10000;
			int var4;
			for (var4 = 1; var4 < this.pairs[var1]; ++var4) {
				var3 = this.method1042(var1, var4, var2);
				float var5 = -2.0F * var3 * (float)Math.cos((double)this.method1040(var1, var4, var2));
