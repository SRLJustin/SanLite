...
public class class160 {
		...
		if (var0 == ScriptOpcodes.APPEND_NUM) {
			...
			if (var0 == ScriptOpcodes.APPEND) {
				...
				if (var0 == ScriptOpcodes.FROMDATE) {
					...
					var3 = Interpreter.Interpreter_stringStack[class20.Interpreter_stringStackSize];
					var4 = Interpreter.Interpreter_stringStack[class20.Interpreter_stringStackSize + 1];
					if (class387.localPlayer.appearance != null && class387.localPlayer.appearance.field3491 != 0) {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = var4;
					} else {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = var3;
					}
	...
	static void setWindowedMode(int var0) {
		...
		if (Client.gameState >= 25) {
			PacketBufferNode var1 = Renderable.getPacketBufferNode(ClientPacket.field3126, Client.packetWriter.isaacCipher);
	...
	static final void clanKickUser(String var0) {
		if (class463.friendsChatManager != null) {
			PacketBufferNode var1 = Renderable.getPacketBufferNode(ClientPacket.field3066, Client.packetWriter.isaacCipher);
