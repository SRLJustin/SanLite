...
public class HealthBarDefinition extends DualNode {
	...
	public SpritePixels method3360() {
		if (this.backSpriteID < 0) {
			...
			if (var1 != null) {
				...
				var1 = StructComposition.SpriteBuffer_getSprite(field1911, this.backSpriteID, 0);
				if (var1 != null) {
	...
	public static int compareStrings(CharSequence var0, CharSequence var1, Language var2) {
		...
		while (var5 - var7 < var3 || var6 - var8 < var4) {
			...
			var7 = RouteStrategy.method3795(var9);
			var8 = RouteStrategy.method3795(var10);
			var9 = class343.standardizeChar(var9, var2);
			var10 = class343.standardizeChar(var10, var2);
		...
		for (var17 = 0; var17 < var16; ++var17) {
			...
			if (var11 != var12 && Character.toUpperCase(var11) != Character.toUpperCase(var12)) {
				...
				if (var11 != var12) {
					return class282.lowercaseChar(var11, var2) - class282.lowercaseChar(var12, var2);
				}
			}
		}
