...
public class class389 {
	...
	public static IndexedSprite[] method7083() {
		...
		for (int var1 = 0; var1 < class457.SpriteBuffer_spriteCount; ++var1) {
			...
			var2.pixels = class436.SpriteBuffer_pixels[var1];
		}
	...
	static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null && var9.parentId == var1 && (var9.method5634() || class67.getWidgetFlags(var9) != 0 || var9 == Client.field671)) {
				if (var9.isIf3) {
						...
						if (var9.noClickThrough) {
							if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15) {
								for (var27 = (ScriptEvent)Client.scriptEvents.last(); var27 != null; var27 = (ScriptEvent)Client.scriptEvents.previous()) {
									if (var27.field1040) {
										var27.remove();
										var27.widget.field3506 = false;
									}
								}

								if (LoginScreenAnimation.field1234 == 0) {
					...
					if (var9.contentType == 1337) {
							...
							for (int var20 = 0; var20 < var9.field3445.length; ++var20) {
								...
								if (var28) {
									if (var20 < 10) {
										...
										class21.selectSpell(var9.id, var9.childIndex, WallObject.Widget_unpackTargetMask(class67.getWidgetFlags(var9)), var9.itemId);
						...
						if (var9.isIf3) {
							...
							if (var9.hasListener) {
								...
								if (var9.field3437 && var36 && var9.onClickRepeat != null) {
									var37 = new ScriptEvent();
									var37.field1040 = true;
									var37.widget = var9;
								...
								if (var9.field3437 && !var36) {
									var9.field3437 = false;
								...
								if (var9.field3506 && var35 && var9.onMouseRepeat != null) {
									var37 = new ScriptEvent();
									var37.field1040 = true;
									var37.widget = var9;
									var37.mouseX = MouseHandler.MouseHandler_x - var26;
								...
								int var39;
								int var40;
								if (var9.onVarTransmit != null && Client.field684 > var9.field3369) {
									if (var9.varTransmitTriggers != null && Client.field684 - var9.field3369 <= 32) {
										label839:
										for (var40 = var9.field3369; var40 < Client.field684; ++var40) {
											var29 = Client.field648[var40 & 31];
									...
									var9.field3369 = Client.field684;
								}
								...
								if (var9.onInvTransmit != null && Client.field686 > var9.field3510) {
									if (var9.invTransmitTriggers != null && Client.field686 - var9.field3510 <= 32) {
										...
										for (var40 = var9.field3510; var40 < Client.field686; ++var40) {
											var29 = Client.field685[var40 & 31];
								...
								if (var9.onStatTransmit != null && Client.field688 > var9.field3486) {
									if (var9.statTransmitTriggers != null && Client.field688 - var9.field3486 <= 32) {
										label791:
										for (var40 = var9.field3486; var40 < Client.field688; ++var40) {
											var29 = Client.field496[var40 & 31];
									...
									var9.field3486 = Client.field688;
								}
