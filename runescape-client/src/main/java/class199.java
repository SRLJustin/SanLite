	...
	public static synchronized void ByteArrayPool_release(byte[] var0) {
		if (var0.length == 100 && ByteArrayPool.ByteArrayPool_smallCount < ByteArrayPool.field4385) {
			...
			if (class357.ByteArrayPool_arrays != null) {
				for (int var1 = 0; var1 < WallObject.ByteArrayPool_alternativeSizes.length; ++var1) {
					if (var0.length == WallObject.ByteArrayPool_alternativeSizes[var1] && class239.ByteArrayPool_altSizeArrayCounts[var1] < class357.ByteArrayPool_arrays[var1].length) {
