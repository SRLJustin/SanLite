...
public class class199 implements class30 {
				...
				if (var2.method401(var1)) {
					...
					default:
						if (this.method4073(var1)) {
							class69.method2030(this.field2305);
						}
					}
				}
	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		...
		if (Login.worldSelectOpen) {
			...
			if (GroundObject.worldSelectArrows == null) {
				var39 = ClientPreferences.archive8;
				var38 = var39.getGroupId("sl_arrows");
				var42 = var39.getFileId(var38, "");
				var44 = AbstractWorldMapData.method5238(var39, var38, var42);
				GroundObject.worldSelectArrows = var44;
			}
			...
			if (GroundObject.worldSelectArrows != null) {
				...
				if (World.World_sortOption1[0] == 0 && World.World_sortOption2[0] == 0) {
					...
					GroundObject.worldSelectArrows[0].drawAt(var31, 4);
				}

				if (World.World_sortOption1[0] == 0 && World.World_sortOption2[0] == 1) {
					GroundObject.worldSelectArrows[3].drawAt(var31 + 15, 4);
				} else {
					GroundObject.worldSelectArrows[1].drawAt(var31 + 15, 4);
				}
				...
				if (World.World_sortOption1[0] == 1 && World.World_sortOption2[0] == 0) {
					...
					GroundObject.worldSelectArrows[0].drawAt(var4, 4);
				}

				if (World.World_sortOption1[0] == 1 && World.World_sortOption2[0] == 1) {
					GroundObject.worldSelectArrows[3].drawAt(var4 + 15, 4);
				} else {
					GroundObject.worldSelectArrows[1].drawAt(var4 + 15, 4);
				}
				...
				if (World.World_sortOption1[0] == 2 && World.World_sortOption2[0] == 0) {
					...
					GroundObject.worldSelectArrows[0].drawAt(var38, 4);
				}

				if (World.World_sortOption1[0] == 2 && World.World_sortOption2[0] == 1) {
					GroundObject.worldSelectArrows[3].drawAt(var38 + 15, 4);
				} else {
					GroundObject.worldSelectArrows[1].drawAt(var38 + 15, 4);
				}
				...
				if (World.World_sortOption1[0] == 3 && World.World_sortOption2[0] == 0) {
					...
					GroundObject.worldSelectArrows[0].drawAt(var42, 4);
				}

				if (World.World_sortOption1[0] == 3 && World.World_sortOption2[0] == 1) {
					GroundObject.worldSelectArrows[3].drawAt(var42 + 15, 4);
				} else {
					GroundObject.worldSelectArrows[1].drawAt(var42 + 15, 4);
				}
