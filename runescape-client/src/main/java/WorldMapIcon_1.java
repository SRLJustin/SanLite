	...
	static final void method4878(Scene var0, CollisionMap[] var1) {
			...
			for (var3 = 0; var3 < 104; ++var3) {
				for (var4 = 0; var4 < 104; ++var4) {
					if ((Tiles.Tiles_renderFlags[var2][var3][var4] & 1) == 1) {
						...
						if (var5 >= 0) {
							var1[var5].method4144(var3, var4);
						}
					}
				}
			}
		...
		for (var2 = 0; var2 < 4; ++var2) {
			...
			for (var11 = 0; var11 < 104; ++var11) {
				Tiles.field1031[var11] = 0;
				PcmPlayer.field326[var11] = 0;
				Tiles.field1038[var11] = 0;
				NPC.field1319[var11] = 0;
				...
				for (var12 = 0; var12 < 104; ++var12) {
					...
					if (var13 >= 0 && var13 < 104) {
						...
						if (var15 > 0) {
							...
							var10000 = Tiles.field1031;
							var10000[var12] += var49.hue;
							var10000 = PcmPlayer.field326;
							var10000[var12] += var49.saturation;
							var10000 = Tiles.field1038;
							var10000[var12] += var49.lightness;
							var10000 = NPC.field1319;
				...
				if (var11 >= 1 && var11 < 103) {
					...
					for (var17 = -5; var17 < 109; ++var17) {
						...
						if (var18 >= 0 && var18 < 104) {
							var12 += Tiles.field1031[var18];
							var13 += PcmPlayer.field326[var18];
							var14 += Tiles.field1038[var18];
							var15 += NPC.field1319[var18];
							var16 += MenuAction.field905[var18];
						}

						var19 = var17 - 5;
						if (var19 >= 0 && var19 < 104) {
							var12 -= Tiles.field1031[var19];
							var13 -= PcmPlayer.field326[var19];
							var14 -= Tiles.field1038[var19];
							var15 -= NPC.field1319[var19];
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var21 > 0 || var22 > 0) {
								...
								if (var21 > 0) {
									...
									var34 = var13 / var16;
									var35 = var14 / var16;
									var31 = class374.method7317(var33, var34, var35);
									...
									var32 = class374.method7317(var33, var34, var35);
								}
								...
								if (var22 == 0) {
									...
									if (var48 >= 0) {
										...
										var40 = class374.method7317(var36.hue, var36.saturation, var36.lightness);
										...
										var41 = class374.method7317(var42, var36.saturation, var43);
									}
									...
									if (var36.secondaryRgb != -1) {
										...
										var41 = class374.method7317(var43, var36.secondarySaturation, var44);
										var42 = Rasterizer3D.Rasterizer3D_colorPalette[WorldMapSectionType.method5234(var41, 96)];
									}
