	...
	static final void method3050(int var0, int var1, int var2, int var3, int var4, int var5, int var6, Scene var7, CollisionMap var8) {
		...
		if (var6 == 22) {
			...
			if (var6 >= 12) {
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1007[var5], 0, var20, var22);
				if (var9.interactType != 0) {
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1011[var5], 0, var20, var22);
				if (var9.interactType != 0) {
					var8.method3878(var2, var3, var6, var5, var9.boolean1);
				}
				...
				if (var6 == 2) {
					...
					var7.newWallObject(var0, var2, var3, var17, (Renderable)var31, (Renderable)var25, Tiles.field1007[var5], Tiles.field1007[var23], var20, var22);
					if (var9.interactType != 0) {
						var8.method3878(var2, var3, var6, var5, var9.boolean1);
					}
					...
					var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1007[var5], 0, 0, 0, var20, var22);
				} else {
					long var24;
					Object var26;
					if (var6 == 5) {
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, Tiles.field1007[var5], 0, var23 * Tiles.field1003[var5], var23 * Tiles.field1005[var5], var20, var22);
					} else if (var6 == 6) {
						var23 = 8;
						var24 = var7.getWallObjectTag(var0, var2, var3);
						if (var24 != 0L) {
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, 256, var5, var23 * Tiles.field1006[var5], var23 * Tiles.field1002[var5], var20, var22);
					} else if (var6 == 7) {
						int var29 = var5 + 2 & 3;
						if (var9.animationId == -1 && var9.transforms == null) {
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)var27, 256, var5, var23 * Tiles.field1006[var5], var23 * Tiles.field1002[var5], var20, var22);
					}
				}
			}
		} else {
