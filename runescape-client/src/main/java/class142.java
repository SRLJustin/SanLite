...
public class class142 extends class128 {
	...
	static int method2982(int var0, Script var1, boolean var2) {
		...
		if (var0 >= 2000) {
			var0 -= 1000;
			var4 = HitSplatDefinition.getWidget(Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]);
			var3 = false;
		} else {
		...
		if (var0 == ScriptOpcodes.CC_SETOP) {
			var11 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] - 1;
			if (var11 >= 0 && var11 <= 9) {
			...
			if (var0 == ScriptOpcodes.CC_SETDRAGGABLE) {
				...
				var11 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize];
				...
				var4.isScrollBar = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
				return 1;
			} else if (var0 == ScriptOpcodes.CC_SETDRAGDEADZONE) {
				var4.dragZoneSize = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
				return 1;
			} else if (var0 == ScriptOpcodes.CC_SETDRAGDEADTIME) {
				var4.dragThreshold = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
				return 1;
				...
				var4.prioritizeMenuEntry = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
				return 1;
			} else if (var0 == 1309) {
				...
				if (var0 != ScriptOpcodes.CC_SETOPKEY) {
					...
					if (var0 == ScriptOpcodes.CC_SETOPTKEY) {
						Nameable.Interpreter_intStackSize -= 2;
						var5 = 10;
						var8 = new byte[]{(byte)Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize]};
						byte[] var9 = new byte[]{(byte)Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1]};
						...
						var11 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize] - 1;
						var6 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1];
						var7 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 2];
						if (var11 >= 0 && var11 <= 9) {
						...
						var7 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
					...
					var8 = null;
					if (var3) {
						Nameable.Interpreter_intStackSize -= 10;

						for (var7 = 0; var7 < 10 && Interpreter.Interpreter_intStack[var7 + Nameable.Interpreter_intStackSize] >= 0; var7 += 2) {
						}
						...
						if (var7 > 0) {
							...
							for (var7 -= 2; var7 >= 0; var7 -= 2) {
								var10[var7 / 2] = (byte)Interpreter.Interpreter_intStack[var7 + Nameable.Interpreter_intStackSize];
								var8[var7 / 2] = (byte)Interpreter.Interpreter_intStack[var7 + Nameable.Interpreter_intStackSize + 1];
							}
						}
					} else {
						Nameable.Interpreter_intStackSize -= 2;
						var10 = new byte[]{(byte)Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize]};
						var8 = new byte[]{(byte)Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1]};
					}

					var7 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] - 1;
					if (var7 >= 0 && var7 <= 9) {
	...
	static int method2989(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			Nameable.Interpreter_intStackSize -= 2;
			Strings.performPlayerAnimation(ScriptFrame.localPlayer, Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize], Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1]);
			return 1;
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						Nameable.Interpreter_intStackSize -= 3;
						var3 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize];
						var16 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1];
						int var9 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 2];
						...
						Bounds.mouseCam = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
						return 1;
					} else if (var0 == ScriptOpcodes.GETREMOVEROOFS) {
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = FriendsChatMember.clientPreferences.method2209() ? 1 : 0;
						return 1;
					} else if (var0 == ScriptOpcodes.SETREMOVEROOFS) {
						FriendsChatMember.clientPreferences.method2241(Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1);
						return 1;
					} else if (var0 == ScriptOpcodes.OPENURL) {
						var7 = Interpreter.Interpreter_stringStack[--UserComparator8.Interpreter_stringStackSize];
						boolean var8 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
						...
						Client.shiftClickDrop = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
						return 1;
					} else if (var0 == ScriptOpcodes.SETSHOWMOUSEOVERTEXT) {
						Client.showMouseOverText = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
						return 1;
					} else if (var0 == ScriptOpcodes.RENDERSELF) {
						Client.renderSelf = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
						return 1;
					} else if (var0 == 3120) {
						if (Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1) {
						...
						Client.showMouseCross = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
						return 1;
					} else if (var0 == ScriptOpcodes.SETSHOWLOADINGMESSAGES) {
						Client.showLoadingMessages = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
						return 1;
					} else if (var0 == ScriptOpcodes.SETTAPTODROP) {
						KeyHandler.setTapToDrop(Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1);
						return 1;
					} else if (var0 == ScriptOpcodes.GETTAPTODROP) {
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = UserComparator8.getTapToDrop() ? 1 : 0;
						return 1;
					} else if (var0 == 3129) {
						Nameable.Interpreter_intStackSize -= 2;
						Client.oculusOrbNormalSpeed = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize];
						Client.oculusOrbSlowedSpeed = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1];
						return 1;
					} else if (var0 == 3130) {
						Nameable.Interpreter_intStackSize -= 2;
						return 1;
						...
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = class7.canvasWidth;
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = DecorativeObject.canvasHeight;
						return 1;
						...
						Client.field741 = 3;
						Client.field652 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
						return 1;
					} else if (var0 == 3137) {
						Client.field741 = 2;
						Client.field652 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
						...
						if (var0 == ScriptOpcodes.SETHIDEUSERNAME) {
							var10 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
							FriendsChatMember.clientPreferences.method2210(var10);
							return 1;
						} else if (var0 == ScriptOpcodes.GETHIDEUSERNAME) {
							Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = FriendsChatMember.clientPreferences.method2211() ? 1 : 0;
							return 1;
						} else if (var0 == ScriptOpcodes.SETREMEMBERUSERNAME) {
							var10 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
							Client.Login_isUsernameRemembered = var10;
							if (!var10) {
								FriendsChatMember.clientPreferences.method2268("");
							}

							return 1;
						} else if (var0 == ScriptOpcodes.GETREMEMBERUSERNAME) {
							Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.Login_isUsernameRemembered ? 1 : 0;
							return 1;
						} else if (var0 == ScriptOpcodes.SHOW_IOS_REVIEW) {
							return 1;
						} else if (var0 == 3146) {
							var10 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
							FriendsChatMember.clientPreferences.method2212(!var10);
							return 1;
						} else if (var0 == 3147) {
							Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = FriendsChatMember.clientPreferences.method2213() ? 0 : 1;
							return 1;
						} else if (var0 == 3148) {
							return 1;
						} else if (var0 == 3149) {
							...
							Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Login.Login_loadingPercent;
							return 1;
						} else if (var0 == 3154) {
							Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = method2991();
							return 1;
						} else if (var0 == 3155) {
							--UserComparator8.Interpreter_stringStackSize;
							return 1;
							...
							WorldMapLabel.method4918(Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]);
							return 1;
						} else if (var0 == 3182) {
							Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = WorldMapSection2.method4502();
							return 1;
							...
							if (var0 == 3187) {
								...
								if (var4.method3725()) {
									StructComposition.method3543(var4.field2176);
								}
