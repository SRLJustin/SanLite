...
public class Coord {
	...
	static int method5485(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CC_SETPOSITION) {
			...
			var4.rawX = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize];
			var4.rawY = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1];
			var4.xAlignment = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 2];
			var4.yAlignment = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 3];
			...
			Nameable.Interpreter_intStackSize -= 4;
			var4.rawWidth = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize];
			var4.rawHeight = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1];
			var4.widthAlignment = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 2];
			var4.heightAlignment = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 3];
			class125.method2770(var4);
			AbstractByteArrayCopier.client.alignWidget(var4);
			if (var3 != -1 && var4.type == 0) {
				class181.revalidateWidgetScroll(class358.Widget_interfaceComponents[var3 >> 16], var4, false);
			...
			boolean var5 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
			...
			var4.noClickThrough = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
			return 1;
		} else if (var0 == ScriptOpcodes.CC_SETNOSCROLLTHROUGH) {
			var4.noScrollThrough = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
			return 1;
		} else {
			return 2;
		}
					...
					if (var9.contentType == 1337) {
						...
						if (var9.isIf3) {
									...
									case 1:
										if (class439.method7568(class193.getWidgetFlags(var9))) {
											...
											if (var22 != null) {
												...
												var23.packetBuffer.writeIntME(var9.id);
							...
							if (var9.hasListener) {
								...
								int var39;
								int var40;
								if (var9.onVarTransmit != null && Client.field648 > var9.field3501) {
									if (var9.varTransmitTriggers != null && Client.field648 - var9.field3501 <= 32) {
										label842:
										for (var40 = var9.field3501; var40 < Client.field648; ++var40) {
									...
									var9.field3501 = Client.field648;
								}
								...
								if (var9.onStatTransmit != null && Client.field680 > var9.field3503) {
									if (var9.statTransmitTriggers != null && Client.field680 - var9.field3503 <= 32) {
										label794:
										for (var40 = var9.field3503; var40 < Client.field680; ++var40) {
									...
									var9.field3503 = Client.field680;
								}
