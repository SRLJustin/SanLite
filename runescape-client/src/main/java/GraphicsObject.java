...
public class GraphicsObject extends Renderable {
	...
	final void advance(int var1) {
		if (!this.isFinished) {
			...
			if (!this.sequenceDefinition.method3725()) {
	...
	static void runScript(ScriptEvent var0, int var1, int var2) {
		...
		if (var4 != null) {
			Nameable.Interpreter_intStackSize = 0;
						...
						try {
							...
							while (true) {
								...
								if (var33 >= 100) {
									...
									Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var7[var20];
								} else if (var33 == ScriptOpcodes.GET_VARP) {
									var13 = var7[var20];
									Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Varps.Varps_main[var13];
								} else if (var33 == ScriptOpcodes.SET_VARP) {
									var13 = var7[var20];
									Varps.Varps_main[var13] = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
									...
									if (Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize] != Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1]) {
										var20 += var7[var20];
									}
									...
									var13 = var7[var20];
									Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = class133.getVarbit(var13);
									...
									Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Interpreter.Interpreter_intLocals[var7[var20]];
								} else if (var33 == ScriptOpcodes.ISTORE) {
									Interpreter.Interpreter_intLocals[var7[var20]] = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
									...
									if (var33 != ScriptOpcodes.INVOKE) {
										if (var33 == ScriptOpcodes.GET_VARC_INT) {
											Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = class341.varcs.getInt(var7[var20]);
										} else if (var33 == ScriptOpcodes.SET_VARC_INT) {
											class341.varcs.setInt(var7[var20], Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]);
										} else if (var33 == ScriptOpcodes.DEFINE_ARRAY) {
											var13 = var7[var20] >> 16;
											var14 = var7[var20] & 65535;
											int var24 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
											...
											var13 = var7[var20];
											var14 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
											if (var14 < 0 || var14 >= Interpreter.Interpreter_arrayLengths[var13]) {
												throw new RuntimeException();
											}

											Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Interpreter.Interpreter_arrays[var13][var14];
											...
											Interpreter.Interpreter_arrays[var13][var14] = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1];
										} else {
											String var22;
											if (var33 == ScriptOpcodes.GET_VARC_STRING_OLD) {
												...
												IntegerNode var37 = (IntegerNode)var38.get((long)Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]);
												if (var37 != null) {
													var20 += var37.integer;
												}
											} else {
												...
												if (var33 == ScriptOpcodes.GET_VARCLANSETTING) {
													...
													if (var39 == null) {
														...
														Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var39;
													}
												} else {
										...
										Nameable.Interpreter_intStackSize -= var36.intArgumentCount;
