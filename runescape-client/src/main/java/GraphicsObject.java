...
public class GraphicsObject extends Renderable {
	...
	final void advance(int var1) {
		if (!this.isFinished) {
			...
			if (!this.sequenceDefinition.method3945()) {
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
									...
									for (var20 = 0; var20 < var10.rawHeight; ++var20) {
										for (var21 = 0; var21 < var10.rawWidth; ++var21) {
											...
											if (var10.itemIds[var19] <= 0) {
												...
												if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5 || var10 == Nameable.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
													SpritePixels var35;
													...
													if (var35 != null) {
														if (var10 == Nameable.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
									...
									if (var10.type == 4) {
										...
										SpritePixels var40;
										if (!var10.isIf3) {
											var40 = var10.method5783(class264.runCs1(var10), Messages.urlRequester);
											if (var40 != null) {
											...
											if (var10.itemId != -1) {
												...
												var40 = var10.method5783(false, Messages.urlRequester);
											}
