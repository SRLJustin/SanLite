	...
	static boolean updateExternalPlayer(PacketBuffer var0, int var1) {
		...
		if (var2 == 0) {
			...
			if (Client.players[var1] != null) {
				...
				var11.resetPath((var9 << 13) + var3 - class28.baseX * 64, (var10 << 13) + var4 - WorldMapLabelSize.baseY * 64);
		...
		for (int var0 = 0; var0 < Client.soundEffectCount; ++var0) {
			...
			if (Client.queuedSoundEffectDelays[var0] >= -10) {
				...
				if (Client.queuedSoundEffectDelays[var0] < 0) {
					...
					if (var2 > 0) {
						RawSound var9 = var1.toRawSound().resample(WorldMapRegion.field2722);
		...
		if (Client.field734) {
			...
			if (!var12) {
				if (class19.clientPreferences.method2258() != 0 && Client.currentTrackGroupId != -1) {
					AttackOption.method2410(class121.field1515, Client.currentTrackGroupId, 0, class19.clientPreferences.method2258(), false);
				}
