...
public class FriendSystem {
	...
	final void readUpdate(Buffer var1, int var2) {
		...
		if (class463.friendsChatManager != null) {
			class463.friendsChatManager.clearFriends();
		}
		...
		if (var1 != null) {
			...
			if (var2.hasCleanName()) {
				if (this.friendsList.removeByUsername(var2)) {
					...
					PacketBufferNode var3 = Renderable.getPacketBufferNode(ClientPacket.field3151, Client.packetWriter.isaacCipher);
		...
		if (var1 != null) {
			...
			if (var2.hasCleanName()) {
				if (this.ignoreList.removeByUsername(var2)) {
					UserComparator7.method2926();
					PacketBufferNode var3 = Renderable.getPacketBufferNode(ClientPacket.field3122, Client.packetWriter.isaacCipher);
					var3.packetBuffer.writeByte(class96.stringCp1252NullTerminatedByteSize(var1));
					var3.packetBuffer.writeStringCp1252NullTerminated(var1);
					Client.packetWriter.addNode(var3);
				}
