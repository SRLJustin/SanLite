...
public class PacketBufferNode extends Node {
	...
	static final void method5389(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		if (var2 == 1) {
			...
			var9.packetBuffer.method8619(var3);
			var9.packetBuffer.method8441(class158.baseY * 64 + var1);
			var9.packetBuffer.method8619(Client.field663);
			...
			var9.packetBuffer.method8619(class26.baseX * 64 + var0);
			var9.packetBuffer.writeByte(Client.field733.method3956(82) ? 1 : 0);
			var9.packetBuffer.method8441(var3);
			Client.packetWriter.addNode(var9);
		} else if (var2 == 6) {
			Client.mouseCrossX = var7;
			Client.mouseCrossY = var8;
			...
			if (var2 == 7) {
				...
				if (var14 != null) {
					...
					var10.packetBuffer.method8441(class69.selectedItemId);
					var10.packetBuffer.method8619(var3);
					var10.packetBuffer.method8546(Client.field733.method3956(82) ? 1 : 0);
					var10.packetBuffer.method8523(class230.selectedItemWidget);
				...
				if (var14 != null) {
					...
					var10.packetBuffer.method8546(Client.field733.method3956(82) ? 1 : 0);
					var10.packetBuffer.method8619(Client.field663);
				...
				if (var14 != null) {
					...
					var10.packetBuffer.method8441(var3);
				...
				if (var2 == 14) {
					...
					if (var16 != null) {
						...
						var10.packetBuffer.method8441(Client.field663);
						var10.packetBuffer.writeByte(Client.field733.method3956(82) ? 1 : 0);
						var10.packetBuffer.method8619(Client.selectedSpellChildIndex);
						var10.packetBuffer.method8443(var3);
						Client.packetWriter.addNode(var10);
					...
					var9.packetBuffer.method8434(Client.field733.method3956(82) ? 1 : 0);
					var9.packetBuffer.method8619(class158.baseY * 64 + var1);
					var9.packetBuffer.method8441(class69.selectedItemId);
					var9.packetBuffer.method8443(var3);
					var9.packetBuffer.method8453(class230.selectedItemWidget);
					var9.packetBuffer.method8441(class1.selectedItemSlot);
					var9.packetBuffer.writeShort(class26.baseX * 64 + var0);
					Client.packetWriter.addNode(var9);
				} else if (var2 == 17) {
					Client.mouseCrossX = var7;
					...
					var9.packetBuffer.method8441(Client.selectedSpellChildIndex);
					var9.packetBuffer.method8441(class158.baseY * 64 + var1);
					var9.packetBuffer.method8453(class124.selectedSpellWidget);
					var9.packetBuffer.method8630(Client.field733.method3956(82) ? 1 : 0);
					var9.packetBuffer.method8441(class26.baseX * 64 + var0);
					var9.packetBuffer.method8441(var3);
					var9.packetBuffer.method8619(Client.field663);
					Client.packetWriter.addNode(var9);
				} else if (var2 == 18) {
					...
					if (var2 == 24) {
						...
						if (var17 != null) {
							...
							if (var13) {
								...
								var11.packetBuffer.method8523(var1);
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								var9.packetBuffer.method8523(var1);
								Client.packetWriter.addNode(var9);
								...
								if (Client.meslayerContinueWidget == null) {
									...
									class143.method3053(Client.meslayerContinueWidget);
								}
							} else if (var2 == 31) {
								...
								var9.packetBuffer.method8441(var4);
								...
								var9.packetBuffer.method8523(class124.selectedSpellWidget);
								var9.packetBuffer.method8441(var4);
								Client.packetWriter.addNode(var9);
								Client.field697 = 0;
								class133.field1575 = class281.getWidget(var1);
								...
								if (var2 == 39) {
									...
									var9.packetBuffer.method8441(var4);
									var9.packetBuffer.method8635(var1);
									var9.packetBuffer.method8441(var0);
									Client.packetWriter.addNode(var9);
									Client.field697 = 0;
									class133.field1575 = class281.getWidget(var1);
									Client.field745 = var0;
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var17 != null) {
													...
													var10.packetBuffer.method8443(Client.field663);
													var10.packetBuffer.method8443(var0);
													var10.packetBuffer.method8437(class124.selectedSpellWidget);
													var10.packetBuffer.writeShort(var4);
													var10.packetBuffer.method8453(var1);
													var10.packetBuffer.method8441(Client.selectedSpellChildIndex);
													Client.packetWriter.addNode(var10);
												}
												break label662;
											}
											...
											if (var2 == 1005) {
												...
												if (var17 != null && var17.itemQuantities[var0] >= 100000) {
													...
													var10.packetBuffer.method8441(var4);
													Client.packetWriter.addNode(var10);
												}
		...
		if (Client.isItemSelected != 0) {
			Client.isItemSelected = 0;
			class143.method3053(class281.getWidget(class230.selectedItemWidget));
		}
