			...
			for (var3 = 0; var3 < 104; ++var3) {
				for (var4 = 0; var4 < 104; ++var4) {
					if ((Tiles.Tiles_renderFlags[var2][var3][var4] & 1) == 1) {
						...
						if (var5 >= 0) {
							var1[var5].method3840(var3, var4);
						}
					}
				}
			}
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var20 > 0 || var21 > 0) {
								...
								if (var20 > 0) {
									...
									var33 = var13 / var16;
									var34 = var14 / var16;
									var30 = SecureRandomCallable.method2068(var32, var33, var34);
									...
									var31 = SecureRandomCallable.method2068(var32, var33, var34);
								}
								...
								if (var21 == 0) {
									...
									if (var48 >= 0) {
										...
										var39 = SecureRandomCallable.method2068(var35.hue, var35.saturation, var35.lightness);
										...
										var40 = SecureRandomCallable.method2068(var41, var35.saturation, var42);
									}
									...
									if (var35.secondaryRgb != -1) {
										...
										var40 = SecureRandomCallable.method2068(var42, var35.secondarySaturation, var43);
										var41 = Rasterizer3D.Rasterizer3D_colorPalette[InvDefinition.method3334(var40, 96)];
									}
