...
public class class202 {
	...
	static void method4236(int var0, Coord var1, boolean var2) {
		...
		int var6 = WorldMapData_1.baseY * 8 + (class67.localPlayer.y >> 7);
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			DevicePcmPlayerProvider.archive5 = class440.method7848(0, false, true, true, false);
			HorizontalAlignment.archive6 = class440.method7848(1, false, true, true, false);
			class119.archive2 = class440.method7848(2, true, false, true, false);
			class301.archive7 = class440.method7848(3, false, true, true, false);
			UserComparator10.archive4 = class440.method7848(4, false, true, true, false);
			class434.archive9 = class440.method7848(5, true, true, true, false);
			class14.field76 = class440.method7848(6, true, true, true, false);
			FaceNormal.archive11 = class440.method7848(7, false, true, true, false);
			ChatChannel.archive8 = class440.method7848(8, false, true, true, false);
			class83.field1081 = class440.method7848(9, false, true, true, false);
			class163.archive10 = class440.method7848(10, false, true, true, false);
			class283.field3325 = class440.method7848(11, false, true, true, false);
			class102.archive12 = class440.method7848(12, false, true, true, false);
			NameableContainer.archive13 = class440.method7848(13, true, false, true, false);
			class14.archive14 = class440.method7848(14, false, true, true, false);
			class19.archive15 = class440.method7848(15, false, true, true, false);
			HealthBar.field1252 = class440.method7848(17, true, true, true, false);
			class67.archive18 = class440.method7848(18, false, true, true, false);
			UserComparator10.archive19 = class440.method7848(19, false, true, true, false);
			Huffman.archive20 = class440.method7848(20, false, true, true, false);
			PcmPlayer.field308 = class440.method7848(21, false, true, true, true);
			...
			var23 += HorizontalAlignment.archive6.percentage() * 4 / 100;
			...
			var23 += class14.field76.percentage() * 2 / 100;
			...
			var23 += NameableContainer.archive13.percentage() * 2 / 100;
			...
			var23 += HealthBar.field1252.method5963() && HealthBar.field1252.isFullyLoaded() ? 1 : 0;
			if (var23 != 100) {
				if (var23 != 0) {
				...
				class122.method2926(HorizontalAlignment.archive6, "Skeletons");
				class122.method2926(UserComparator10.archive4, "Sound FX");
				class122.method2926(class434.archive9, "Maps");
				class122.method2926(class14.field76, "Music Tracks");
				...
				class271.field3203 = new GraphicsDefaults();
				class271.field3203.decode(HealthBar.field1252);
			...
			if (Client.titleLoadingStage == 45) {
				...
				class327.field4119 = new Decimator(22050, PcmPlayer.field307);
				Login.Login_loadingText = "Prepared sound engine";
				Login.Login_loadingPercent = 35;
				Client.titleLoadingStage = 50;
				FloorOverlayDefinition.WorldMapElement_fonts = new Fonts(ChatChannel.archive8, NameableContainer.archive13);
			} else {
				int var1;
				if (Client.titleLoadingStage == 50) {
					...
					if (Client.titleLoadingStage == 80) {
						...
						if (class14.compass == null) {
							class14.compass = class114.SpriteBuffer_getSprite(ChatChannel.archive8, class271.field3203.compass, 0);
						} else {
							++var23;
						}

						if (GraphicsObject.redHintArrowSprite == null) {
							GraphicsObject.redHintArrowSprite = class114.SpriteBuffer_getSprite(ChatChannel.archive8, class271.field3203.field4408, 0);
						} else {
							++var23;
						}

						if (WorldMapArea.mapSceneSprites == null) {
							WorldMapArea.mapSceneSprites = class390.method7253(ChatChannel.archive8, class271.field3203.mapScenes, 0);
						} else {
							++var23;
						}

						if (class6.headIconPkSprites == null) {
							class6.headIconPkSprites = AbstractRasterProvider.method8301(ChatChannel.archive8, class271.field3203.headIconsPk, 0);
						} else {
							++var23;
						}

						if (class28.headIconPrayerSprites == null) {
							class28.headIconPrayerSprites = AbstractRasterProvider.method8301(ChatChannel.archive8, class271.field3203.field4411, 0);
						} else {
							++var23;
						}

						if (class135.headIconHintSprites == null) {
							class135.headIconHintSprites = AbstractRasterProvider.method8301(ChatChannel.archive8, class271.field3203.field4417, 0);
						} else {
							++var23;
						}

						if (class97.mapMarkerSprites == null) {
							class97.mapMarkerSprites = AbstractRasterProvider.method8301(ChatChannel.archive8, class271.field3203.field4407, 0);
						} else {
							++var23;
						}

						if (SpotAnimationDefinition.crossSprites == null) {
							SpotAnimationDefinition.crossSprites = AbstractRasterProvider.method8301(ChatChannel.archive8, class271.field3203.field4413, 0);
						} else {
							++var23;
						}

						if (class296.mapDotSprites == null) {
							class296.mapDotSprites = AbstractRasterProvider.method8301(ChatChannel.archive8, class271.field3203.field4414, 0);
						} else {
							++var23;
						}

						if (ChatChannel.scrollBarSprites == null) {
							ChatChannel.scrollBarSprites = class390.method7253(ChatChannel.archive8, class271.field3203.field4416, 0);
						} else {
							++var23;
						}

						if (class65.modIconSprites == null) {
							class65.modIconSprites = class390.method7253(ChatChannel.archive8, class271.field3203.field4415, 0);
						} else {
							++var23;
						}
						...
						if (!class83.field1081.isFullyLoaded()) {
							...
							Rasterizer3D.method4135(class130.textureProvider);
							Rasterizer3D.method4136(Player.clientPreferences.method2387());
						...
						if (!class301.archive7.isFullyLoaded()) {
							...
							Login.Login_loadingPercent = 96;
						} else if (!NameableContainer.archive13.isFullyLoaded()) {
							Login.Login_loadingText = "Loading interfaces - " + (96 + NameableContainer.archive13.loadPercent() / 50) + "%";
							Login.Login_loadingPercent = 96;
						} else {
					...
					Archive var7 = HorizontalAlignment.archive6;
					...
					Archive var13 = NameableContainer.archive13;
					...
					class150.Ignored_cached = new class429(class153.field1729, 47, class271.clientLanguage, class119.archive2);
					LoginType.varcs = new Varcs();
					Archive var16 = class119.archive2;
					Archive var17 = ChatChannel.archive8;
					Archive var18 = NameableContainer.archive13;
