...
public class class347 {
	...
	public class347() {
		...
		for (byte var3 = 12; var1 < 16; var2 -= var3) {
			var4 = SecureRandomCallable.method2282((double)((float)var2 / 360.0F), 0.9998999834060669D, (double)(0.425F * (float)var1 / 16.0F + 0.075F));
			field4307[var1] = var4;
			++var1;
		}
		...
		for (int var6 = var2 / 6; var1 < field4307.length; var2 -= var6) {
			var4 = var1 * 2;

			for (int var5 = SecureRandomCallable.method2282((double)((float)var2 / 360.0F), 0.9998999834060669D, 0.5D); var1 < var4 && var1 < field4307.length; ++var1) {
				field4307[var1] = var5;
			}
		}
