...
public class class463 implements class349 {
	...
	static {
		field4897 = new class463(2, 0, Integer.class, new class460());
		field4898 = new class463(0, 1, Long.class, new class462());
		field4903 = new class463(1, 2, String.class, new class464());
	}
