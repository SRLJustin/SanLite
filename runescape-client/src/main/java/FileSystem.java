...
public class FileSystem {
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			ClanChannelMember.archive5 = UserComparator4.method2542(0, false, true, true, false);
			Decimator.archive6 = UserComparator4.method2542(1, false, true, true, false);
			Renderable.archive2 = UserComparator4.method2542(2, true, false, true, false);
			class306.archive7 = UserComparator4.method2542(3, false, true, true, false);
			class271.archive4 = UserComparator4.method2542(4, false, true, true, false);
			class120.archive9 = UserComparator4.method2542(5, true, true, true, false);
			PacketBuffer.field4700 = UserComparator4.method2542(6, true, true, true, false);
			FloorUnderlayDefinition.archive11 = UserComparator4.method2542(7, false, true, true, false);
			class299.archive8 = UserComparator4.method2542(8, false, true, true, false);
			class201.field2366 = UserComparator4.method2542(9, false, true, true, false);
			KitDefinition.archive10 = UserComparator4.method2542(10, false, true, true, false);
			class17.field89 = UserComparator4.method2542(11, false, true, true, false);
			SequenceDefinition.archive12 = UserComparator4.method2542(12, false, true, true, false);
			MouseRecorder.archive13 = UserComparator4.method2542(13, true, false, true, false);
			Varcs.archive14 = UserComparator4.method2542(14, false, true, true, false);
			class268.archive15 = UserComparator4.method2542(15, false, true, true, false);
			MouseHandler.field230 = UserComparator4.method2542(17, true, true, true, false);
			class340.archive18 = UserComparator4.method2542(18, false, true, true, false);
			Tile.archive19 = UserComparator4.method2542(19, false, true, true, false);
			Friend.archive20 = UserComparator4.method2542(20, false, true, true, false);
			Timer.field4232 = UserComparator4.method2542(21, false, true, true, true);
			...
			var23 += Decimator.archive6.percentage() * 4 / 100;
			...
			var23 += PacketBuffer.field4700.percentage() * 2 / 100;
			...
			if (var23 != 100) {
				...
				ApproximateRouteStrategy.method1070(Decimator.archive6, "Skeletons");
				ApproximateRouteStrategy.method1070(class271.archive4, "Sound FX");
				ApproximateRouteStrategy.method1070(class120.archive9, "Maps");
				ApproximateRouteStrategy.method1070(PacketBuffer.field4700, "Music Tracks");
				...
				if (Client.titleLoadingStage == 60) {
					...
					if (Client.titleLoadingStage == 80) {
						...
						if (class16.compass == null) {
							class16.compass = WorldMapScaleHandler.SpriteBuffer_getSprite(class299.archive8, class181.field1983.compass, 0);
						} else {
							++var23;
						}

						if (MouseRecorder.redHintArrowSprite == null) {
							MouseRecorder.redHintArrowSprite = WorldMapScaleHandler.SpriteBuffer_getSprite(class299.archive8, class181.field1983.field4366, 0);
						} else {
							++var23;
						}

						if (class120.mapSceneSprites == null) {
							class120.mapSceneSprites = DefaultsGroup.method6840(class299.archive8, class181.field1983.mapScenes, 0);
						} else {
							++var23;
						}

						if (BufferedSource.headIconPkSprites == null) {
							BufferedSource.headIconPkSprites = Tiles.method2024(class299.archive8, class181.field1983.headIconsPk, 0);
						} else {
							++var23;
						}

						if (MusicPatchNode.headIconPrayerSprites == null) {
							MusicPatchNode.headIconPrayerSprites = Tiles.method2024(class299.archive8, class181.field1983.field4370, 0);
						} else {
							++var23;
						}

						if (class229.headIconHintSprites == null) {
							class229.headIconHintSprites = Tiles.method2024(class299.archive8, class181.field1983.field4369, 0);
						} else {
							++var23;
						}

						if (class7.mapMarkerSprites == null) {
							class7.mapMarkerSprites = Tiles.method2024(class299.archive8, class181.field1983.field4371, 0);
						} else {
							++var23;
						}

						if (Canvas.crossSprites == null) {
							Canvas.crossSprites = Tiles.method2024(class299.archive8, class181.field1983.field4373, 0);
						} else {
							++var23;
						}

						if (MusicPatchNode.mapDotSprites == null) {
							MusicPatchNode.mapDotSprites = Tiles.method2024(class299.archive8, class181.field1983.field4374, 0);
						} else {
							++var23;
						}

						if (InterfaceParent.scrollBarSprites == null) {
							InterfaceParent.scrollBarSprites = DefaultsGroup.method6840(class299.archive8, class181.field1983.field4375, 0);
						} else {
							++var23;
						}

						if (VarpDefinition.modIconSprites == null) {
							VarpDefinition.modIconSprites = DefaultsGroup.method6840(class299.archive8, class181.field1983.field4376, 0);
						} else {
							++var23;
						}
						...
						if (!class201.field2366.isFullyLoaded()) {
							...
							GameBuild.textureProvider = new TextureProvider(class201.field2366, class299.archive8, 20, FriendsChatMember.clientPreferences.method2220(), Client.isLowDetail ? 64 : 128);
							Rasterizer3D.method3943(GameBuild.textureProvider);
							Rasterizer3D.method3938(FriendsChatMember.clientPreferences.method2220());
					...
					GroundObject.method3921(Renderable.archive2, FloorUnderlayDefinition.archive11);
					...
					class134.method2851(Renderable.archive2, ClanChannelMember.archive5, Decimator.archive6);
					...
					Bounds.Ignored_cached = new class428(class20.field111, 47, MilliClock.clientLanguage, Renderable.archive2);
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (FriendsChatMember.clientPreferences.method2216()) {
									var13 += 15;
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
											...
											if (var10.itemIds[var19] <= 0) {
												...
												if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5 || var10 == class16.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
													...
													if (var35 != null) {
														...
														} else if (var10 == WallObject.field2634 && var19 == Client.field594) {
									...
									if (var10.type == 4) {
										...
										SpritePixels var40;
										if (!var10.isIf3) {
											var40 = var10.method5570(WorldMapRegion.runCs1(var10), MilliClock.urlRequester);
											if (var40 != null) {
											...
											if (var10.itemId != -1) {
												...
												var40 = var10.method5570(false, MilliClock.urlRequester);
											}
