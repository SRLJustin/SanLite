	...
	static void method5263(int var0, String var1) {
		...
		for (int var6 = 0; var6 < var2; ++var6) {
			...
			if (var7 != null && var7 != class387.localPlayer && var7.username != null && var7.username.equals(var5)) {
				...
				if (var0 == 1) {
					var8 = Renderable.getPacketBufferNode(ClientPacket.field3082, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method8684(var3[var6]);
					var8.packetBuffer.method8765(0);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 4) {
					var8 = Renderable.getPacketBufferNode(ClientPacket.field3149, Client.packetWriter.isaacCipher);
					var8.packetBuffer.writeShort(var3[var6]);
					var8.packetBuffer.method8674(0);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 6) {
					var8 = Renderable.getPacketBufferNode(ClientPacket.field3110, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method8674(0);
					var8.packetBuffer.writeShort(var3[var6]);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 7) {
					var8 = Renderable.getPacketBufferNode(ClientPacket.field3070, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method8684(var3[var6]);
					var8.packetBuffer.method8673(0);
					Client.packetWriter.addNode(var8);
				}
