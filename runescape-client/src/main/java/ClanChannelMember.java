	...
	static final void method2908(class263 var0) {
		...
		if (class263.field3024 == var0) {
			...
			if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
				var5 = var5 * 128 + 64;
				var6 = var6 * 128 + 64;
				GraphicsObject var42 = new GraphicsObject(var2, FriendSystem.Client_plane, var5, var6, SecureRandomFuture.getTileHeight(var5, var6, FriendSystem.Client_plane) - var7, var3, Client.cycle);
				...
				if (class263.field3021 == var0) {
					...
					if (class263.field3027 == var0) {
						...
						if (var7 >= 0 && var8 >= 0 && var7 < 103 && var8 < 103) {
							if (var5 == 0) {
								WallObject var36 = Decimator.scene.method4129(FriendSystem.Client_plane, var7, var8);
								if (var36 != null) {
							...
							if (var5 == 1) {
								DecorativeObject var43 = Decimator.scene.method4130(FriendSystem.Client_plane, var7, var8);
								if (var43 != null) {
									var11 = class141.Entity_unpackID(var43.tag);
									if (var3 != 4 && var3 != 5) {
										if (var3 == 6) {
											...
											var43.renderable1 = new DynamicObject(var11, 4, var4 + 4, FriendSystem.Client_plane, var7, var8, var9, false, var43.renderable1);
											var43.renderable2 = new DynamicObject(var11, 4, (var4 + 2 & 3) + 4, FriendSystem.Client_plane, var7, var8, var9, false, var43.renderable2);
										}
									} else {
							...
							if (var5 == 2) {
								GameObject var44 = Decimator.scene.getGameObject(FriendSystem.Client_plane, var7, var8);
								if (var3 == 11) {
									var3 = 10;
								}
							...
							if (var5 == 3) {
								GroundObject var45 = Decimator.scene.getGroundObject(FriendSystem.Client_plane, var7, var8);
								if (var45 != null) {
						...
						if (class263.field3019 == var0) {
							...
							if (class263.field3023 == var0) {
								...
								if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104 && var9 >= 0 && var7 >= 0 && var9 < 104 && var7 < 104 && var12 != 65535) {
									...
									var9 = var9 * 128 + 64;
									var7 = var7 * 128 + 64;
									Projectile var31 = new Projectile(var12, FriendSystem.Client_plane, var4, var5, SecureRandomFuture.getTileHeight(var4, var5, FriendSystem.Client_plane) - var11, var8 + Client.cycle, var13 + Client.cycle, var10, var2, var41, var6);
