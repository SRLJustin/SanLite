...
public class class352 {
	...
	static final void method6432(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		if (var2 == 1) {
			...
			var9.packetBuffer.method7647(Decimator.baseX * 64 + var0);
			...
			var9.packetBuffer.writeIntME(class150.selectedItemWidget);
			...
			var9.packetBuffer.method7675(Decimator.baseX * 64 + var0);
			var9.packetBuffer.writeShort(Client.field646);
			var9.packetBuffer.writeIntME(class282.selectedSpellWidget);
			...
			var9.packetBuffer.writeShort(Decimator.baseX * 64 + var0);
			var9.packetBuffer.method7675(class7.baseY * 64 + var1);
			...
			var9.packetBuffer.method7676(Decimator.baseX * 64 + var0);
			var9.packetBuffer.method7675(class7.baseY * 64 + var1);
			var9.packetBuffer.method7878(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			Client.packetWriter.addNode(var9);
		} else if (var2 == 5) {
			...
			if (var2 == 7) {
				...
				if (var14 != null) {
					...
					var10.packetBuffer.method7676(Client.field646);
				...
				if (var2 == 14) {
					...
					if (var16 != null) {
						...
						var10.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
						var10.packetBuffer.method7676(var3);
						var10.packetBuffer.writeIntME(class150.selectedItemWidget);
						Client.packetWriter.addNode(var10);
					}
				} else if (var2 == 15) {
					var16 = Client.players[var3];
					if (var16 != null) {
						...
						var10.packetBuffer.method7676(var3);
						var10.packetBuffer.method7647(Client.field646);
					...
					if (var2 == 24) {
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								Client.packetWriter.addNode(var9);
								Client.field593 = 0;
								WallObject.field2634 = HitSplatDefinition.getWidget(var1);
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var17 != null) {
													...
													var10.packetBuffer.method7675(Client.field646);
													var10.packetBuffer.method7673(class282.selectedSpellWidget);
		...
		if (Client.isItemSelected != 0) {
			Client.isItemSelected = 0;
			class125.method2770(HitSplatDefinition.getWidget(class150.selectedItemWidget));
		}
		...
		if (WallObject.field2634 != null && Client.field593 == 0) {
	...
	static void method6438(int var0, int var1) {
		...
		if (var2 != null) {
			method6432(var2.param0, var2.param1, var2.opcode, var2.identifier, var2.field859, var2.field857, var2.field860, var0, var1);
		}
