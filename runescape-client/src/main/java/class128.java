	...
	static final void drawActor2d(Actor var0, int var1, int var2, int var3, int var4, int var5) {
		if (var0 != null && var0.isVisible()) {
			...
			if (var0.overheadText != null && (var1 >= var75 || !var0.field1187 && (Client.publicChatMode == 4 || !var0.isAutoChatting && (Client.publicChatMode == 0 || Client.publicChatMode == 3 || Client.publicChatMode == 1 && ((Player)var0).isFriend())))) {
				ClientPreferences.method2513(var0, var0.defaultHeight + 15);
				if (Client.viewportTempX > -1 && Client.field761 < Client.field606) {
					Client.field794[Client.field761] = class146.fontBold12.stringWidth(var0.overheadText) / 2;
					Client.field609[Client.field761] = class146.fontBold12.ascent;
					Client.field607[Client.field761] = Client.viewportTempX;
					Client.field608[Client.field761] = Client.viewportTempY - var89;
					Client.field611[Client.field761] = var0.field1202;
					Client.field612[Client.field761] = var0.field1229;
					Client.field702[Client.field761] = var0.field1248;
					Client.field605[Client.field761] = var0.overheadText;
					++Client.field761;
					var89 += 12;
				}
			}
