...
public class ClientPreferences {
	...
	ClientPreferences(Buffer var1) {
		...
		if (var1 != null && var1.array != null) {
			...
			if (var2 >= 0 && var2 <= ClientPreferences_optionCount) {
				...
				if (var2 > 8) {
					this.field1245 = var1.readUnsignedByte() == 1;
				}
	...
	Buffer toBuffer() {
		...
		while (var2.hasNext()) {
			...
			var1.method8523((Integer)var3.getKey());
			var1.method8523((Integer)var3.getValue());
		}
		...
		var1.writeByte(this.field1245 ? 1 : 0);
		var1.method8523(this.field1246);
		return var1;
	}
	...
	void method2434() {
		this.method2384(!this.field1245);
	}
