...
public class ClientPreferences {
	...
	ClientPreferences(Buffer var1) {
		...
		if (var1 != null && var1.array != null) {
			...
			if (var2 >= 0 && var2 <= ClientPreferences_optionCount) {
				...
				if (var2 > 8) {
					this.field1240 = var1.readUnsignedByte() == 1;
				}
	...
	Buffer toBuffer() {
		...
		var1.writeByte(this.field1240 ? 1 : 0);
	...
	void method2369() {
		this.method2338(!this.field1240);
	}
			...
			for (var3 = 0; var3 < 104; ++var3) {
				for (var4 = 0; var4 < 104; ++var4) {
					if ((Tiles.Tiles_renderFlags[var2][var3][var4] & 1) == 1) {
						...
						if (var5 >= 0) {
							var1[var5].method3871(var3, var4);
						}
					}
				}
			}
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var20 > 0 || var21 > 0) {
								...
								if (var20 > 0) {
									...
									var33 = var13 / var16;
									var34 = var14 / var16;
									var30 = Client.method1637(var32, var33, var34);
									...
									var31 = Client.method1637(var32, var33, var34);
								}
								...
								if (var21 == 0) {
									...
									if (var47 >= 0) {
										...
										var39 = Client.method1637(var35.hue, var35.saturation, var35.lightness);
										...
										var40 = Client.method1637(var41, var35.saturation, var42);
									}
									...
									if (var35.secondaryRgb != -1) {
										...
										var40 = Client.method1637(var42, var35.secondarySaturation, var43);
										var41 = Rasterizer3D.Rasterizer3D_colorPalette[World.method1692(var40, 96)];
									}
