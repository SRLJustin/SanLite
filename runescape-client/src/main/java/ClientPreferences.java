...
public class ClientPreferences {
	...
	ClientPreferences(Buffer var1) {
		...
		if (var1 != null && var1.array != null) {
			...
			if (var2 >= 0 && var2 <= ClientPreferences_optionCount) {
				...
				if (var2 > 8) {
					this.field1237 = var1.readUnsignedByte() == 1;
				}
	...
	Buffer toBuffer() {
		...
		var1.writeByte(this.field1237 ? 1 : 0);
	...
	void method2395() {
		this.method2394(!this.field1237);
	}
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.movementSequence != -1) {
			...
			if (var2 != null) {
				if (!var2.method3945() && var2.frameIds != null) {
		...
		if (var0.spotAnimation != -1 && Client.cycle >= var0.field1147) {
			...
			if (var11 != -1) {
				...
				if (var12 != null && var12.frameIds != null && !var12.method3945()) {
					++var0.field1176;
		...
		if (var0.sequence != -1 && var0.sequenceDelay == 0) {
			...
			if (var2 == null) {
				var0.sequence = -1;
			} else if (!var2.method3945() && var2.frameIds != null) {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) {
			class82.worldToScreen(Client.field516 * 64 + (Client.hintArrowX - class128.baseX * 64 << 7), Client.field517 * 64 + (Client.hintArrowY - WorldMapData_1.baseY * 8 << 7), Client.field670 * 2);
		...
		var16 = WorldMapData_1.baseY * 8 + (class67.localPlayer.y >> 7);
