...
public class ClientPreferences {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) {
			class82.worldToScreen(Client.field516 * 64 + (Client.hintArrowX - class128.baseX * 64 << 7), Client.field517 * 64 + (Client.hintArrowY - WorldMapData_1.baseY * 64 << 7), Client.field670 * 4);
