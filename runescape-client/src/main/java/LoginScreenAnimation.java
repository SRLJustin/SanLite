...
public class LoginScreenAnimation {
	...
	final void method2207(int var1) {
		...
		if (this.field1235 * 16 == 0 && this.field1224 * 16 == 0) {
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			this.field1234[var7] = (int)(Math.sin((double)this.field1218 / 14.0D) * 16.0D + Math.sin((double)this.field1218 / 15.0D) * 14.0D + Math.sin((double)this.field1218 / 16.0D) * 12.0D);
			++this.field1218;
		}

		this.field1226 = this.field1226 * 10000 + var1 * 10000;
	...
	final void method2213(int var1) {
		...
		if (this.field1235 * 16 > 0) {
			this.method2224(this.field1235 * 16, this.field1217);
		} else if (this.field1224 * 16 > 0) {
			this.method2224(this.field1224 * 16, this.field1222);
		} else {
	...
	final void method2215(IndexedSprite var1) {
		...
		for (var2 = 0; var2 < 5000; ++var2) {
			...
			this.field1233[var3] = (int)(Math.random() * 256.0D);
		}
