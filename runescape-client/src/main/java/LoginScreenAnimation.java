...
public class LoginScreenAnimation {
	...
	static void method2379() {
		if (Decimator.worldMap != null) {
			Decimator.worldMap.method7508(Tiles.Client_plane, class128.baseX * 64 + (class67.localPlayer.x >> 7), WorldMapData_1.baseY * 8 + (class67.localPlayer.y >> 7), false);
