...
public class LoginScreenAnimation {
	...
	void initColors() {
		...
		this.field1241 = new int[32768];
		this.field1255 = new int[32768];
	}
	...
	final void method2450(int var1) {
		...
		if (this.field1253 * 934620171 > 0) {
			this.field1253 -= var1 * -1605632372;
		}

		if (this.field1252 * 16 == 0 && this.field1253 * 934620171 == 0) {
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			this.field1246[var7] = (int)(Math.sin((double)this.field1242 / 14.0D) * 16.0D + Math.sin((double)this.field1242 / 15.0D) * 14.0D + Math.sin((double)this.field1242 / 16.0D) * 12.0D);
			++this.field1242;
		}
	...
	final void method2452(int var1) {
		...
		} else if (this.field1253 * 934620171 > 0) {
			this.method2460(this.field1253 * 934620171, this.field1251);
		} else {
	...
	final void method2476(int var1) {
		...
		for (int var3 = 1; var3 < 255; ++var3) {
			...
			if (var5 + 128 >= class25.rasterProvider.width) {
				var7 = class25.rasterProvider.width - var5;
			}

			int var8 = var5 + (var3 + 8) * class25.rasterProvider.width;
			var2 += var6;
			...
			for (int var9 = var6; var9 < var7; ++var9) {
				...
				if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) {
					...
					int var14 = class25.rasterProvider.pixels[var8];
					class25.rasterProvider.pixels[var8++] = -16777216 | ((var14 & 16711935) * var13 + (var10 & 16711935) * var12 & -16711936) + (var13 * (var14 & 65280) + var12 * (var10 & 65280) & 16711680) >> 8;
				} else {
					++var8;
				}
			}
	...
	final void method2455(IndexedSprite var1) {
		...
		for (var2 = 0; var2 < 5000; ++var2) {
			...
			this.field1256[var3] = (int)(Math.random() * 256.0D);
		}
		...
		if (var1 != null) {
			...
			for (var3 = 0; var3 < var1.subHeight * -517064944; ++var3) {
	...
	public static void method2477(Widget var0) {
	...
	static final void method2463(int var0) {
		...
		Rasterizer3D.method4414((double)var1);
