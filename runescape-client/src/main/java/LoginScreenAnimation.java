...
public class LoginScreenAnimation {
	...
	final void method2292(int var1) {
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			this.field1218[var7] = (int)(Math.sin((double)this.field1219 / 14.0D) * 16.0D + Math.sin((double)this.field1219 / 15.0D) * 14.0D + Math.sin((double)this.field1219 / 16.0D) * 12.0D);
			++this.field1219;
		}

		this.field1231 = this.field1231 * 10000 + var1 * 100;
		...
		if (var7 > 0) {
			...
			int var12;
			int var13;
			for (var11 = 0; var11 < this.field1231 * 10000; ++var11) {
		...
		for (int var3 = 1; var3 < 255; ++var3) {
			...
			for (int var9 = var6; var9 < var7; ++var9) {
				...
				if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) {
					...
					class268.rasterProvider.pixels[var8++] = -16777216 | ((var14 & 16711935) * var13 + (var10 & 16711935) * var12 & -16711936) + (var13 * (var14 & 65280) + var12 * (var10 & 65280) & 16711680) >> 8;
				} else {
					++var8;
				}
			}
