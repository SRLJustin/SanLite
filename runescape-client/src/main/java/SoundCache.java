...
public class SoundCache {
	...
	static final void method765(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.field538; ++var1) {
			...
			if ((var4 & 1024) != 0) {
				var3.field1189 = Client.cycle + var0.method7775();
				var3.field1135 = Client.cycle + var0.method7774();
				var3.field1191 = var0.readByte();
				var3.field1192 = var0.method7769();
				var3.field1193 = var0.method7952();
				var3.field1133 = (byte)var0.method7767();
			}
			...
			if ((var4 & 2) != 0) {
				var3.spotAnimation = var0.method7775();
				var5 = var0.method7785();
				var3.field1143 = var5 >> 16;
			...
			if ((var4 & 32) != 0) {
				...
				if (var6 > 0) {
					for (var7 = 0; var7 < var6; ++var7) {
						...
						if (var9 != 32767) {
							var10 = var0.readUShortSmart();
							var11 = var0.method7767();
							int var12 = var9 > 0 ? var0.method7767() : var11;
			...
			if ((var4 & 8) != 0) {
				var3.definition = BuddyRankComparator.getNpcDefinition(var0.method7776());
				var3.field1205 = var3.definition.size * 1526988800;
			...
			if ((var4 & 128) != 0) {
				var3.targetIndex = var0.method7776();
			...
			if (class101.field1366 && (var4 & 256) != 0 || !class101.field1366 && (var4 & 64) != 0) {
				var3.field1140 = var0.method7952();
				var3.field1182 = var0.method7769();
				var3.field1181 = var0.method7768();
				var3.field1183 = var0.method7768();
				var3.field1184 = var0.method7776() + Client.cycle;
				var3.field1194 = var0.method7775() + Client.cycle;
			...
			if ((var4 & 1) != 0) {
				var5 = var0.method7776();
				var6 = var0.method7775();
				if (class101.field1366) {
					var3.field1161 = var0.method7766() == 1;
				}

				var7 = var3.x - (var5 - class28.baseX * 64 - class28.baseX * 64) * 64;
				var8 = var3.y - (var6 - WorldMapLabelSize.baseY * 64 - WorldMapLabelSize.baseY * 64) * 64;
				if (var7 != 0 || var8 != 0) {
