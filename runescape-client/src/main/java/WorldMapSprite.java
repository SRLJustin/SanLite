						...
						if (class262.field3019 == var0) {
							...
							if (class262.field3024 == var0) {
								...
								if (var17 != null) {
									...
									if (var29 != null) {
										...
										var17.field1108 = var4 * 128 + var20 * 64;
							...
							if (class262.field3015 == var0) {
								...
								if (var8 >= 0 && var9 >= 0 && var8 < 103 && var9 < 103) {
									if (var5 == 0) {
										WallObject var33 = class356.scene.method4333(PacketWriter.Client_plane, var8, var9);
										if (var33 != null) {
									...
									if (var5 == 1) {
										DecorativeObject var42 = class356.scene.method4178(PacketWriter.Client_plane, var8, var9);
										if (var42 != null) {
									...
									if (var5 == 3) {
										GroundObject var44 = class356.scene.getGroundObject(PacketWriter.Client_plane, var8, var9);
										if (var44 != null) {
