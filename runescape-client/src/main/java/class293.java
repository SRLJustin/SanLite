...
public class class293 {
	...
	static {
		field3375 = new short[]{6798, 8741, 25238, 4626, 4550};
		...
		field3376 = new short[]{-10304, 9104, -1, -1, -1};
		...
		if (var0 > 0L && var0 < 6582952005840035281L) {
			if (var0 % 37L == 0L) {
				...
				while (var0 != 0L) {
					long var6 = var0;
					var0 /= 37L;
					var5.append(class345.base37Table[(int)(var6 - 37L * var0)]);
				}
	...
	static int method5430(Widget var0) {
		if (var0.type != 11) {
			...
			Interpreter.Interpreter_intStack[++class12.Interpreter_intStackSize - 1] = var0.method5455(var1);
			return 1;
		}
	}
}
