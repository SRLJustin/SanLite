...
public class class325 {
	...
	public class325() {
		...
		for (byte var3 = 12; var1 < 16; var2 -= var3) {
			var4 = StructComposition.method3616((double)((float)var2 / 360.0F), 0.9998999834060669D, (double)(0.075F + 0.425F * (float)var1 / 16.0F));
		...
		for (int var6 = var2 / 6; var1 < class344.field4152.length; var2 -= var6) {
			...
			for (int var5 = StructComposition.method3616((double)((float)var2 / 360.0F), 0.9998999834060669D, 0.5D); var1 < var4 && var1 < class344.field4152.length; ++var1) {
	...
	void method6033(int var1) {
		int var2 = var1 * 2 + 1;
		double[] var3 = WorldMapEvent.method5119(0.0D, (double)((float)var1 / 3.0F), var1);
