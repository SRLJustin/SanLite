	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState == 20) {
				class147.titleboxSprite.drawAt(Login.loginBoxX + 180 - class147.titleboxSprite.subWidth / 2, 271 - class147.titleboxSprite.subHeight * -517064944 / 2);
				var25 = 201;
				...
				if (Login.loginIndex != 4 && Login.loginIndex != 10) {
					...
					for (var5 = FriendLoginUpdate.method7586(); var0.stringWidth(var5) > var27; var5 = var5.substring(0, var5.length() - 1)) {
					}

					var0.draw(AbstractFont.escapeBrackets(var5), Login.loginBoxX + 180 - 70, var26, 16777215, 0);
					var26 += 15;
					var7 = Login.Login_password;
					var6 = class25.method366('*', var7.length());
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
				...
				if (Login.loginIndex == 0) {
					...
					var19 = 291;
					Login.field906.drawAt(var4 - 73, var19 - 20);
					...
					if (Login.loginIndex == 2) {
						...
						for (var5 = FriendLoginUpdate.method7586(); var0.stringWidth(var5) > var27; var5 = var5.substring(1)) {
						}
						...
						var10 = var11 ? (var12 ? class100.field1335 : Login.field910) : (var12 ? ChatChannel.field1005 : Login.field932);
						...
						IndexedSprite var14 = var15 ? (var16 ? class100.field1335 : Login.field910) : (var16 ? ChatChannel.field1005 : Login.field932);
						...
						short var18 = 321;
						Login.field906.drawAt(var17 - 73, var18 - 20);
						...
						case 2:
							WallObject.field2768 = "Having trouble logging in?";
							break;
						default:
							WallObject.field2768 = "Can't login? Click here.";
						}

						Calendar.field3727 = new Bounds(class143.loginBoxCenter, var25, var1.stringWidth(WallObject.field2768), 11);
						class290.field3364 = new Bounds(class143.loginBoxCenter, var25, var1.stringWidth("Still having trouble logging in?"), 11);
						var1.drawCentered(WallObject.field2768, class143.loginBoxCenter, var25, 16777215, 0);
						...
						if (Login.field930) {
							var10 = Login.field910;
						} else {
							var10 = Login.field932;
						}
						...
						short var29 = 321;
						Login.field906.drawAt(var28 - 73, var29 - 20);
						...
						short var21 = 321;
						Login.field906.drawAt(var23 - 73, var21 - 20);
						...
						if (class209.field2376 && !Client.onMobile) {
							...
							for (var30 = 0; var30 < 8; ++var30) {
								Login.field906.method9071(var4, var26, 30, 40);
								boolean var34 = var30 == Login.field925 & Client.cycle % 40 < 20;
								var0.draw((Login.field926[var30] == null ? "" : Login.field926[var30]) + (var34 ? class149.colorStartTag(16776960) + "|" : ""), var4 + 10, var26 + 27, 16777215, 0);
								if (var30 != 1 && var30 != 3) {
									var4 += 35;
								} else {
									var4 += 50;
							...
							short var35 = 321;
							Login.field906.drawAt(var30 - 73, var35 - 20);
							var0.drawCentered("Submit", var30, var35 + 5, 16777215, 0);
							var30 = class143.loginBoxCenter + 80;
							Login.field906.drawAt(var30 - 73, var35 - 20);
							var0.drawCentered("Cancel", var30, var35 + 5, 16777215, 0);
						} else {
							var25 = 216;
						...
						var4 = var27 + 20;
						class19.field109.drawAt(var26 - 109, var4);
						if (Login.field927.isEmpty()) {
							Canvas.field140.drawAt(var26 - 48, var4 + 18);
						} else {
							Canvas.field140.drawAt(var26 - 48, var4 + 5);
							var0.drawCentered(Login.field927, var26, var4 + 68 - 15, 16776960, 0);
						}
						...
						var27 = 311;
						Login.field906.drawAt(var26 - 73, var27 - 20);
						...
						var4 = Login.loginBoxX + 180;
						var25 = 311;
						Login.field906.drawAt(var4 - 73, var25 - 20);
						...
						short var32 = 276;
						Login.field906.drawAt(var31 - 73, var32 - 20);
						if (Login.field916 == 1) {
			...
			Login.field908[PacketWriter.clientPreferences.method2570() ? 1 : 0].drawAt(Login.xPadding + 765 - 40, 463);
			if (Client.gameState > 5 && class36.clientLanguage == Language.Language_EN) {
				if (Login.field935 != null) {
					...
					byte var33 = 100;
					byte var36 = 35;
					Login.field935.drawAt(var26, var27);
					var0.drawCentered("World" + " " + Client.worldId, var33 / 2 + var26, var36 / 2 + var27 - 2, 16777215, 0);
					if (ClanChannel.World_request != null) {
						var1.drawCentered("Loading...", var33 / 2 + var26, var36 / 2 + var27 + 12, 16777215, 0);
					} else {
						var1.drawCentered("Click to switch", var33 / 2 + var26, var36 / 2 + var27 + 12, 16777215, 0);
					}
				} else {
