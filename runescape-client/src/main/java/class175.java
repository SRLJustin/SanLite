...
public class class175 {
	...
	static void method3524(GameEngine var0, Font var1) {
		int var4;
		int var81;
		int var82;
		if (Login.worldSelectOpen) {
			...
			if ((MouseHandler.MouseHandler_lastButton == 1 || !SceneTilePaint.mouseCam && MouseHandler.MouseHandler_lastButton == 4) && MouseHandler.MouseHandler_lastPressedX >= Login.xPadding + 765 - 50 && MouseHandler.MouseHandler_lastPressedY >= 453) {
				...
				if (!StructComposition.clientPreferences.method2428()) {
					Archive var2 = class162.archive11;
					int var35 = var2.getGroupId("scape main");
					var4 = var2.getFileId(var35, "");
					KeyHandler.method426(var2, var35, var4, 255, false);
				} else {
					class6.method39();
				}
			}
											...
											if (Login.Login_username.length() == 0) {
												...
												if (var44 == 0L) {
													...
													for (var22 = 0; var22 < 4; ++var22) {
														var120.method8536(var97.nextInt());
													}

													var120.method8536(var104[0]);
													var120.method8536(var104[1]);
													...
													for (var22 = 0; var22 < 3; ++var22) {
														var20.method8536(var97.nextInt());
													}
													...
													if (Login.Login_username.length() == 0) {
														...
														if (var48 == 0L) {
															...
															for (var24 = 0; var24 < 4; ++var24) {
																var21.method8536(var102.nextInt());
															}

															var21.method8536(var23[0]);
															var21.method8536(var23[1]);
															...
															for (var24 = 0; var24 < 3; ++var24) {
																var52.method8536(var102.nextInt());
															}
													...
													label1734: {
														...
														if (var115 == null) {
															...
															if (!var101) {
																...
																if (!var17) {
																	KeyHandler.field172 = 8388607;
																} else {
																	KeyHandler.field172 = (int)(var115.getTime() / 86400000L - 11745L);
																}
