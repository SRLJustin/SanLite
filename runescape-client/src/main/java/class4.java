		...
		if (var0 != Client.gameState) {
			...
			if (var0 != 5 && var0 != 10) {
				if (var0 == 20) {
					...
					FriendsChatMember.method6613(KitDefinition.archive10, class299.archive8, false, var7);
				} else if (var0 == 11) {
					FriendsChatMember.method6613(KitDefinition.archive10, class299.archive8, false, 4);
				} else if (var0 == 50) {
					ItemComposition.setLoginResponseString("", "Updating date of birth...", "");
					FriendsChatMember.method6613(KitDefinition.archive10, class299.archive8, false, 7);
				...
				boolean var1 = FriendsChatMember.clientPreferences.method2229() >= Client.field480;
				int var2 = var1 ? 0 : 12;
				FriendsChatMember.method6613(KitDefinition.archive10, class299.archive8, true, var2);
			}
