...
public final class class417 {
	...
	float[] method7911() {
		...
		if ((double)this.field4644[2] < 0.999D && (double)this.field4644[2] > -0.999D) {
			...
			var1[0] = 0.0F;
			var1[1] = (float)Math.atan2((double)this.field4644[2], 0.0D);
	...
	public int hashCode() {
		boolean var1 = true;
		byte var2 = 1;
		int var3 = var2 * 31 + Arrays.hashCode(this.field4644);
		return var3;
	}
