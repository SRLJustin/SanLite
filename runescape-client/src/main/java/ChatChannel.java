		...
		if (var0 != null && var0.isVisible()) {
					...
					if (var79 == null) {
						...
						if (var13 != null && var81 != null) {
							...
							if (var17 >= 0 && var17 < 255) {
								...
								Rasterizer2D.Rasterizer2D_expandClip(var22, var23, var94 + var22, var86 + var23);
							...
							if (Client.viewportTempX > -1) {
								...
								Rasterizer2D.Rasterizer2D_fillRectangle(var86 + var94, var22, var15 - var94, 5, 16711680);
							}
			...
			for (int var77 = 0; var77 < 4; ++var77) {
				...
				if (var12 >= 0) {
					...
					var91 = GrandExchangeOfferOwnWorldComparator.method1095(var0.hitSplatTypes[var77]);
					var14 = var91.field2014;
				...
				if (var90 - var14 <= Client.cycle) {
					if (var91 == null) {
						...
						if (Client.viewportTempX > -1) {
							...
							int var63 = var91.field2019 - var62 * var91.field2019 / var91.field2014;
							int var64 = var62 * var91.field2021 / var91.field2014 + -var91.field2021;
							int var65 = var63 + (var2 + Client.viewportTempX - (var51 >> 1));
							int var66 = var3 + Client.viewportTempY - 12 + var64;
							int var67 = var66;
							int var68 = var66 + var42;
							int var69 = var66 + var91.field2024 + 15;
