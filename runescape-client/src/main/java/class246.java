		...
		if (var0 != Client.gameState) {
			...
			if (var0 != 5 && var0 != 10) {
				if (var0 == 20) {
					...
					class129.method3086(ApproximateRouteStrategy.field490, WorldMapEvent.archive8, false, var1);
				} else if (var0 == 11) {
					class129.method3086(ApproximateRouteStrategy.field490, WorldMapEvent.archive8, false, 4);
				} else if (var0 == 50) {
					class70.setLoginResponseString("", "Updating date of birth...", "");
					class129.method3086(ApproximateRouteStrategy.field490, WorldMapEvent.archive8, false, 7);
				...
				class129.method3086(ApproximateRouteStrategy.field490, WorldMapEvent.archive8, true, var1);
			}
