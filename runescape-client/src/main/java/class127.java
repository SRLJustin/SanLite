...
public class class127 extends class128 {
	...
	static final void method2887(int var0, int var1) {
		if (Client.hintArrowType == 2) {
			GrandExchangeOfferOwnWorldComparator.worldToScreen((Client.hintArrowX - class300.baseX * 64 << 7) + Client.field507 * 4096, Client.field508 * 64 + (Client.hintArrowY - Message.baseY * 64 << 7), Client.field506 * 2);
