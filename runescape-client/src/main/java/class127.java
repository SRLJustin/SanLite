...
public class class127 implements class349 {
	...
	static {
		field1566 = new class127(0, 0, (String)null, -1, -1);
		field1559 = new class127(1, 1, (String)null, 0, 2);
		field1568 = new class127(2, 2, (String)null, 1, 2);
		field1560 = new class127(3, 3, (String)null, 2, 2);
		field1562 = new class127(4, 4, (String)null, 3, 1);
		field1578 = new class127(5, 5, (String)null, 4, 1);
		field1564 = new class127(6, 6, (String)null, 5, 1);
		field1565 = new class127(7, 7, (String)null, 6, 3);
		field1561 = new class127(8, 8, (String)null, 7, 3);
		field1567 = new class127(9, 9, (String)null, 8, 3);
		field1563 = new class127(10, 10, (String)null, 0, 7);
		field1569 = new class127(11, 11, (String)null, 1, 7);
		field1570 = new class127(12, 12, (String)null, 2, 7);
		field1571 = new class127(13, 13, (String)null, 3, 7);
		field1572 = new class127(14, 14, (String)null, 4, 7);
		field1573 = new class127(15, 15, (String)null, 5, 7);
		field1574 = new class127(16, 16, (String)null, 0, 5);
	}
		...
		while (!var0) {
			...
			for (int var1 = 0; var1 < Client.menuOptionsCount - 1; ++var1) {
				if (Client.menuOpcodes[var1] < 1000 && Client.menuOpcodes[var1 + 1] > 1000) {
					...
					var4 = Client.field655[var1];
					Client.field655[var1] = Client.field655[var1 + 1];
					Client.field655[var1 + 1] = var4;
