...
public class TaskHandler implements Runnable {
	...
	static final void method3430() {
		if (class142.FriendsChatManager_inFriendsChat) {
			...
			class142.FriendsChatManager_inFriendsChat = false;
		}
	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
			...
			if (var7 != 0L) {
				...
				if (var1 == 0) {
					MusicPatchNode.scene.removeWallObject(var0, var2, var3);
				...
				if (var1 == 3) {
					MusicPatchNode.scene.removeGroundObject(var0, var2, var3);
					var13 = PlayerComposition.getObjectDefinition(var14);
