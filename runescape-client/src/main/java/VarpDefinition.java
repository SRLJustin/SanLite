	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		for (var16 = 0; var16 < 5; ++var16) {
			if (Client.field569[var16]) {
				var17 = (int)(Math.random() * (double)(Client.field769[var16] * 2 + 1) - (double)Client.field769[var16] + Math.sin((double)Client.field771[var16] / 100.0D * (double)Client.field772[var16]) * (double)Client.field525[var16]);
				if (var16 == 0) {
		...
		GroundObject.method4314(var0, var1, var2, var3);
		if (Client.hintArrowType == 2) {
			class467.worldToScreen(Client.field762 * 64 + (Client.field520 - ParamComposition.baseX * 64 << 7), Client.field703 * 64 + (Client.field539 - Client.baseY * 64 << 7), Client.field522 * 4);
		...
		((TextureProvider)Rasterizer3D.Rasterizer3D_textureLoader).animate(Client.field574);
		class220.method4628(var0, var1, var2, var3);
