					...
					if (var9.contentType == 1337) {
						...
						if (var9.isIf3) {
									...
									case 1:
										if (ParamComposition.method3596(class326.getWidgetFlags(var9))) {
											...
											if (var22 != null) {
												...
												var23.packetBuffer.method7867(var22[0]);
							...
							if (var9.hasListener) {
								...
								int var39;
								int var40;
								if (var9.onVarTransmit != null && Client.field693 > var9.field3479) {
									if (var9.varTransmitTriggers != null && Client.field693 - var9.field3479 <= 32) {
										label825:
										for (var40 = var9.field3479; var40 < Client.field693; ++var40) {
											var29 = Client.field692[var40 & 31];
									...
									var9.field3479 = Client.field693;
								}
								...
								if (var9.onInvTransmit != null && Client.field695 > var9.field3480) {
									if (var9.invTransmitTriggers != null && Client.field695 - var9.field3480 <= 32) {
										...
										for (var40 = var9.field3480; var40 < Client.field695; ++var40) {
											var29 = Client.field492[var40 & 31];
								...
								if (var9.onStatTransmit != null && Client.field697 > var9.field3433) {
									if (var9.statTransmitTriggers != null && Client.field697 - var9.field3433 <= 32) {
										label777:
										for (var40 = var9.field3433; var40 < Client.field697; ++var40) {
											var29 = Client.field568[var40 & 31];
									...
									var9.field3433 = Client.field697;
								}
