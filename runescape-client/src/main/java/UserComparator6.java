...
public class UserComparator6 extends AbstractUserComparator {
	...
	static final void method2611(int var0, int var1) {
		if (Client.hintArrowType == 2) {
			Bounds.worldToScreen(Client.field499 * 64 + (Client.hintArrowX - Decimator.baseX * 64 << 7), (Client.hintArrowY - class7.baseY * 64 << 7) + Client.field500 * 4096, Client.field498 * 4);
