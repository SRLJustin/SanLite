...
public enum StudioGame implements class349 {
	...
	static int method6441(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) {
			...
			class288.privateChatMode = class189.method3719(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1]);
			...
			PacketBufferNode var13 = Renderable.getPacketBufferNode(ClientPacket.field3068, Client.packetWriter.isaacCipher);
			...
			if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) {
				...
				var6 = Renderable.getPacketBufferNode(ClientPacket.field3104, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) {
					...
					if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYUID) {
						...
						if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) {
							...
							var12 = Renderable.getPacketBufferNode(ClientPacket.field3075, Client.packetWriter.isaacCipher);
