...
public class class122 {
	...
	public class122(int var1, Buffer var2, boolean var3) {
		this.field1496 = new class417();
		this.field1493 = true;
		this.field1494 = new class417();
		this.field1486 = true;
		this.field1487 = new class417();
	...
	static int method3027(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.SOUND_SYNTH) {
			...
			class275.method5533(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize], Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1], Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 2]);
			return 1;
