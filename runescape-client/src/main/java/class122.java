...
public class class122 extends DualNode {
	...
	class122(AbstractArchive var1, AbstractArchive var2, int var3, boolean var4) {
		...
		this.field1497 = 0;
		this.field1496 = var3;
		byte[] var5 = var1.takeFile(this.field1496 >> 16 & 65535, this.field1496 & 65535);
			...
			if (var0 == ScriptOpcodes.INTERPOLATE) {
				...
				if (var3 == 0) {
					...
					case 4:
						...
						break;
					default:
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = (int)Math.pow((double)var3, 1.0D / (double)var4);
					}
