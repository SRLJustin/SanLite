...
public class SpriteMask extends DualNode {
	...
	static final void method5457() {
			...
			if (Client.queuedSoundEffectDelays[var0] >= -10) {
				...
				if (Client.queuedSoundEffectDelays[var0] < 0) {
					...
					if (Client.soundLocations[var0] != 0) {
						...
						var2 = (var3 - var8) * FriendsChatMember.clientPreferences.method2226() / var3;
					} else {
						var2 = FriendsChatMember.clientPreferences.method2204();
					}
		...
		if (Client.field729 && !class260.method5128()) {
			if (FriendsChatMember.clientPreferences.method2222() != 0 && Client.currentTrackGroupId != -1) {
				class118.method2713(PacketBuffer.field4700, Client.currentTrackGroupId, 0, FriendsChatMember.clientPreferences.method2222(), false);
			}
