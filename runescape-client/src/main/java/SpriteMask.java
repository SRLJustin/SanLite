...
public class SpriteMask extends DualNode {
	...
	static void playSong(int var0) {
		if (var0 == -1 && !Client.field671) {
			class177.method3538();
		} else if (var0 != -1 && var0 != Client.currentTrackGroupId && PacketWriter.clientPreferences.method2495() != 0 && !Client.field671) {
			class284.method5566(2, class153.archive11, var0, 0, PacketWriter.clientPreferences.method2495(), false);
		}
