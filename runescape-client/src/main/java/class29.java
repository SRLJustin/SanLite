					...
					if (var9.contentType == 1337) {
						...
						if (var9.isIf3) {
							...
							if (var21) {
								...
								if (var9.type == 11 && var9.method5623(MouseHandler.MouseHandler_lastPressedX, MouseHandler.MouseHandler_lastPressedY, var6, var7)) {
									...
									case 0:
										...
										break;
									case 1:
										if (DecorativeObject.method4551(class124.getWidgetFlags(var9))) {
											...
											if (var22 != null) {
												...
												var23.packetBuffer.method7929(var9.childIndex);
												var23.packetBuffer.writeInt(var22[1]);
												var23.packetBuffer.method7783(var22[2]);
							...
							if (var9.hasListener) {
								...
								if (var9.field3369 && var36 && var9.onClickRepeat != null) {
									var37 = new ScriptEvent();
									var37.field1046 = true;
									var37.widget = var9;
								...
								if (var9.field3509 && var35 && var9.onMouseRepeat != null) {
									var37 = new ScriptEvent();
									var37.field1046 = true;
									var37.widget = var9;
									var37.mouseX = MouseHandler.MouseHandler_x - var26;
								...
								int var39;
								int var40;
								if (var9.onVarTransmit != null && Client.field606 > var9.field3512) {
									if (var9.varTransmitTriggers != null && Client.field606 - var9.field3512 <= 32) {
										label824:
										for (var40 = var9.field3512; var40 < Client.field606; ++var40) {
									...
									var9.field3512 = Client.field606;
								}
								...
								if (var9.onInvTransmit != null && Client.field683 > var9.field3367) {
									if (var9.invTransmitTriggers != null && Client.field683 - var9.field3367 <= 32) {
										label800:
										for (var40 = var9.field3367; var40 < Client.field683; ++var40) {
								...
								if (var9.onStatTransmit != null && Client.field685 > var9.field3514) {
									if (var9.statTransmitTriggers != null && Client.field685 - var9.field3514 <= 32) {
										label776:
										for (var40 = var9.field3514; var40 < Client.field685; ++var40) {
											var29 = Client.field756[var40 & 31];
									...
									var9.field3514 = Client.field685;
								}
