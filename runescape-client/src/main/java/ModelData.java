...
public class ModelData extends Renderable {
	...
	static {
		field2314 = new int[10000];
		field2290 = new int[10000];
		field2308 = 0;
	...
	public ModelData(ModelData[] var1, int var2) {
		...
		if (var9) {
			this.field2301 = new int[this.verticesCount][];
			this.field2302 = new int[this.verticesCount][];
		}
		...
		for (var10 = 0; var10 < var2; ++var10) {
			...
			if (var11 != null) {
				...
				for (var12 = 0; var12 < var11.faceCount; ++var12) {
					...
					this.indices1[this.faceCount] = this.method3811(var11, var11.indices1[var12]);
					this.indices2[this.faceCount] = this.method3811(var11, var11.indices2[var12]);
					this.indices3[this.faceCount] = this.method3811(var11, var11.indices3[var12]);
					++this.faceCount;
				}
				...
				for (var12 = 0; var12 < var11.textureTriangleCount; ++var12) {
					...
					if (var13 == 0) {
						this.texTriangleX[this.textureTriangleCount] = (short)this.method3811(var11, var11.texTriangleX[var12]);
						this.texTriangleY[this.textureTriangleCount] = (short)this.method3811(var11, var11.texTriangleY[var12]);
						this.texTriangleZ[this.textureTriangleCount] = (short)this.method3811(var11, var11.texTriangleZ[var12]);
					}
	...
	void method3812(byte[] var1) {
		...
		if (var18 == 1) {
			for (var53 = 0; var53 < var9; ++var53) {
				...
				this.field2301[var53] = new int[var54];
				this.field2302[var53] = new int[var54];

				for (var55 = 0; var55 < var54; ++var55) {
					this.field2301[var53][var55] = var6.readUnsignedByte();
					this.field2302[var53][var55] = var6.readUnsignedByte();
				}
			}
		}
	...
	void method3889(byte[] var1) {
		...
		if (var17 == 1) {
			for (var40 = 0; var40 < var9; ++var40) {
				...
				this.field2301[var40] = new int[var41];
				this.field2302[var40] = new int[var41];

				for (var42 = 0; var42 < var41; ++var42) {
					this.field2301[var40][var42] = var8.readUnsignedByte();
					this.field2302[var40][var42] = var8.readUnsignedByte();
				}
			}
		}
	...
	final int method3811(ModelData var1, int var2) {
		...
		if (var3 == -1) {
			...
			if (var1.field2301 != null) {
				this.field2301[this.verticesCount] = var1.field2301[var2];
				this.field2302[this.verticesCount] = var1.field2302[var2];
			}
	...
	public ModelData method3847(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
		...
		int var7 = var2 + this.field2310;
		int var8 = var2 + this.field2315;
		int var9 = var4 + this.field2313;
		int var10 = var4 + this.field2312;
	...
	void calculateBounds() {
		if (!this.isBoundsCalculated) {
			super.height = 0;
			this.field2309 = 0;
			this.field2310 = 999999;
			this.field2315 = -999999;
			this.field2312 = -99999;
	...
	public final Model toModel(int var1, int var2, int var3, int var4, int var5) {
		...
		if (this.textureTriangleCount > 0 && this.textureCoords != null) {
			...
			var8.field2570 = new int[var8.field2569];
			var8.field2571 = new int[var8.field2569];
			var8.field2572 = new int[var8.field2569];
			var10 = 0;

			int var11;
			for (var11 = 0; var11 < this.textureTriangleCount; ++var11) {
				if (var9[var11] > 0 && this.textureRenderTypes[var11] == 0) {
					var8.field2570[var10] = this.texTriangleX[var11] & '\uffff';
					var8.field2571[var10] = this.texTriangleY[var11] & '\uffff';
					var8.field2572[var10] = this.texTriangleZ[var11] & '\uffff';
					var9[var11] = var10++;
				} else {
					var9[var11] = -1;
				}
			...
			if (var12 == -1) {
				if (var17 != 0) {
					if (var17 == 1) {
						...
						var8.faceColors1[var16] = method3834(this.faceColors[var16] & '\uffff', var14);
					...
					var8.faceColors1[var16] = method3834(var15, var14);
					...
					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
					var8.faceColors2[var16] = method3834(var15, var14);
					...
					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
					var8.faceColors3[var16] = method3834(var15, var14);
				}
			} else if (var17 != 0) {
				if (var17 == 1) {
					var19 = this.faceNormals[var16];
					var14 = (var4 * var19.y + var5 * var19.z + var3 * var19.x) / (var7 / 2 + var7) + var1;
					var8.faceColors1[var16] = method3817(var14);
					var8.faceColors3[var16] = -1;
				} else {
					var8.faceColors3[var16] = -2;
				}
				...
				var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
				var8.faceColors2[var16] = method3817(var14);
				if (this.vertexVertices != null && this.vertexVertices[this.indices3[var16]] != null) {
					var13 = this.vertexVertices[this.indices3[var16]];
				} else {
					var13 = this.vertexNormals[this.indices3[var16]];
				...
				var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
				var8.faceColors3[var16] = method3817(var14);
			}
		}
	...
	static void method3862(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
		...
		for (var9 = 0; var9 < var0.verticesCount; ++var9) {
			...
			if (var10.magnitude != 0) {
				...
				if (var11 <= var1.field2309) {
					int var12 = var0.verticesX[var9] - var2;
					if (var12 >= var1.field2310 && var12 <= var1.field2315) {
						int var13 = var0.verticesZ[var9] - var4;
						if (var13 >= var1.field2313 && var13 <= var1.field2312) {
							for (int var14 = 0; var14 < var8; ++var14) {
								...
								if (var12 == var7[var14] && var13 == var1.verticesZ[var14] && var11 == var1.verticesY[var14] && var15.magnitude != 0) {
									...
									++var6;
									field2314[var9] = field2308;
									field2290[var14] = field2308;
								}
							}
						}
					}
		...
		if (var6 >= 3 && var5) {
			for (var9 = 0; var9 < var0.faceCount; ++var9) {
				if (field2314[var0.indices1[var9]] == field2308 && field2314[var0.indices2[var9]] == field2308 && field2314[var0.indices3[var9]] == field2308) {
			...
			for (var9 = 0; var9 < var1.faceCount; ++var9) {
				if (field2308 == field2290[var1.indices1[var9]] && field2308 == field2290[var1.indices2[var9]] && field2308 == field2290[var1.indices3[var9]]) {
