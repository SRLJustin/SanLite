...
public class class276 {
	...
	static {
		field3170 = new class276(4);
		field3158 = new class276(5);
		field3159 = new class276(6);
		field3171 = new class276(15);
		field3161 = new class276(4);
		field3166 = new class276(2);
		field3168 = new class276(7);
		field3164 = new class276(16);
		field3165 = new class276(8);
		field3157 = new class276(5);
		field3167 = new class276(14);
		field3160 = new class276(5);
		field3169 = new class276(7);
		field3163 = new class276(14);
	}
	...
	static final void method5485(MenuAction var0, int var1, int var2) {
		if (var0 != null) {
			WorldMapData_0.method4844(var0.param0, var0.param1, var0.opcode, var0.identifier, var0.field904, var0.field903, var0.field899, var1, var2);
		}
