	...
	public static void RunException_sendStackTrace(String var0, Throwable var1) {
		if (var1 != null) {
			...
			try {
				...
				URL var3 = new URL(RunException.RunException_applet.getCodeBase(), "clienterror.ws?cv=" + RunException.field4838 + "&cs=" + RunException.field4839 + "&u=" + RunException.localPlayerName + "&v1=" + class360.javaVendor + "&v2=" + TaskHandler.javaVersion + "&ct=" + class20.clientType + "&e=" + var2);
