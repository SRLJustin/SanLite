...
public abstract class AbstractWorldMapIcon {
	...
	static final void drawObject(int var0, int var1, int var2, int var3, int var4) {
		long var5 = WorldMapAreaData.scene.getWallObjectTag(var0, var1, var2);
		int var7;
		int var8;
		int var9;
		int var10;
		...
		if (var5 != 0L) {
			...
			if (var15.mapSceneId != -1) {
				...
				if (var16 != null) {
					...
					int var18 = (var15.sizeY * 4 - var16.subHeight * -517064944) / 2;
		...
		if (var5 != 0L) {
			...
			if (var20.mapSceneId != -1) {
				...
				if (var28 != null) {
					...
					var14 = (var20.sizeY * 4 - var28.subHeight * -517064944) / 2;
		...
		var5 = WorldMapAreaData.scene.getGroundObjectTag(var0, var1, var2);
		if (0L != var5) {
			...
			if (var23.mapSceneId != -1) {
				...
				if (var24 != null) {
					...
					int var11 = (var23.sizeY * 4 - var24.subHeight * -517064944) / 2;
