...
public class WorldMapCacheName {
	...
	static {
		field3010 = new WorldMapCacheName("details");
		field3005 = new WorldMapCacheName("compositemap");
		field3009 = new WorldMapCacheName("compositetexture");
		field3007 = new WorldMapCacheName("area");
		field3004 = new WorldMapCacheName("labels");
	}
			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					if (class281.friendsChatManager != null) {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = class281.friendsChatManager.name;
					} else {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (class281.friendsChatManager != null) {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = class281.friendsChatManager.getSize();
					} else {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize];
					if (class281.friendsChatManager != null && var3 < class281.friendsChatManager.getSize()) {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = class281.friendsChatManager.get(var3).getUsername().getName();
					} else {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize];
					if (class281.friendsChatManager != null && var3 < class281.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = ((Buddy)class281.friendsChatManager.get(var3)).getWorld();
					} else {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize];
					if (class281.friendsChatManager != null && var3 < class281.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = ((Buddy)class281.friendsChatManager.get(var3)).rank;
					} else {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = 0;
					}
					...
					Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = class281.friendsChatManager != null ? class281.friendsChatManager.minKick : 0;
					return 1;
					...
					Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = class281.friendsChatManager != null ? class281.friendsChatManager.rank : 0;
					return 1;
					...
					var3 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize];
					if (class281.friendsChatManager != null && var3 < class281.friendsChatManager.getSize() && class281.friendsChatManager.get(var3).getUsername().equals(class155.localPlayer.username)) {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (class281.friendsChatManager != null && class281.friendsChatManager.owner != null) {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = class281.friendsChatManager.owner;
					} else {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize];
					if (class281.friendsChatManager != null && var3 < class281.friendsChatManager.getSize() && ((FriendsChatMember)class281.friendsChatManager.get(var3)).isFriend()) {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (var0 == 3628) {
						...
						if (var0 == 3629) {
							...
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.removeComparator();
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new UserComparator1(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new UserComparator2(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new UserComparator3(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new UserComparator4(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new UserComparator5(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new UserComparator6(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new UserComparator7(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new UserComparator8(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new UserComparator9(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new UserComparator10(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize] == 1;
							if (class281.friendsChatManager != null) {
								class281.friendsChatManager.addComparator(new BuddyRankComparator(var7));
							}
					...
					var3 = Interpreter.Interpreter_intStack[--class87.Interpreter_intStackSize];
					if (class281.friendsChatManager != null && var3 < class281.friendsChatManager.getSize() && ((FriendsChatMember)class281.friendsChatManager.get(var3)).isIgnored()) {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class87.Interpreter_intStackSize - 1] = 0;
					}
