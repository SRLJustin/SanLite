...
public class WorldMapCacheName {
	...
	static {
		field2910 = new WorldMapCacheName("details");
		field2907 = new WorldMapCacheName("compositemap");
		field2908 = new WorldMapCacheName("compositetexture");
		field2909 = new WorldMapCacheName("area");
		field2911 = new WorldMapCacheName("labels");
	}
