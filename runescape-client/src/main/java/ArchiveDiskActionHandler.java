	...
	static final void method5793() {
		...
		if (!var0) {
			...
			for (var1 = 0; var1 < Actor.regionLandArchives.length; ++var1) {
				...
				if (var15 != null) {
					var3 = (Client.regions[var1] >> 8) * 64 - class28.baseX * 64;
					var4 = (Client.regions[var1] & 255) * 64 - WorldMapLabelSize.baseY * 64;
			...
			if (!var0) {
				...
				if (!Client.isInInstance) {
					...
					for (var2 = 0; var2 < var1; ++var2) {
						var3 = (Client.regions[var2] >> 8) * 64 - class28.baseX * 64;
						var4 = (Client.regions[var2] & 255) * 64 - WorldMapLabelSize.baseY * 64;
					...
					for (var2 = 0; var2 < var1; ++var2) {
						...
						if (var13 != null) {
							var4 = (Client.regions[var2] >> 8) * 64 - class28.baseX * 64;
							var5 = (Client.regions[var2] & 255) * 64 - WorldMapLabelSize.baseY * 64;
							Renderable.playPcmPlayers();
				...
				if (Client.isInInstance) {
					...
					for (var2 = 0; var2 < 4; ++var2) {
						...
						for (var3 = 0; var3 < 13; ++var3) {
							for (var4 = 0; var4 < 13; ++var4) {
								boolean var16 = false;
								var6 = Client.field495[var2][var3][var4];
								if (var6 != -1) {
									var7 = var6 >> 24 & 3;
									var8 = var6 >> 1 & 3;
									var9 = var6 >> 14 & 1023;
					...
					for (var2 = 0; var2 < 13; ++var2) {
						for (var3 = 0; var3 < 13; ++var3) {
							var4 = Client.field495[0][var2][var3];
							if (var4 == -1) {
					...
					for (var2 = 0; var2 < 4; ++var2) {
						...
						for (var3 = 0; var3 < 13; ++var3) {
							for (var4 = 0; var4 < 13; ++var4) {
								var5 = Client.field495[var2][var3][var4];
								if (var5 != -1) {
									var6 = var5 >> 24 & 3;
									var7 = var5 >> 1 & 3;
									var8 = var5 >> 14 & 1023;
