...
public class WorldMapSection0 implements WorldMapSection {
	...
	static int method4868(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CAM_FORCEANGLE) {
			...
			int var4 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1];
			...
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.camAngleX;
			return 1;
		} else if (var0 == ScriptOpcodes.CAM_GETANGLE_YA) {
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.camAngleY;
			return 1;
			...
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.camFollowHeight;
			return 1;
		} else {
			return 2;
		}
