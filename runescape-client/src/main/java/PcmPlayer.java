...
public class PcmPlayer {
	...
	protected PcmPlayer() {
		...
		this.field307 = true;
		this.field322 = 0;
		this.field323 = new PcmStream[8];
		this.field314 = new PcmStream[8];
	}
	...
	static int method826() {
		return KeyHandler.KeyHandler_keyCodes.length;
	}
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field1215 >= Client.cycle) {
			...
			if (var0.field1189 >= Client.cycle) {
				...
				if (!var16) {
					...
					if (var12 != null && !var12.method4070()) {
		...
		if (var0.field1228 != 0) {
			if (var0.targetIndex != -1) {
				Object var14 = null;
				var3 = class323.field3800 ? 65536 : 32768;
		...
		if (var0.movementSequence != -1) {
			...
			if (var2 != null) {
				if (!var2.method4070() && var2.frameIds != null) {
		...
		if (var0.spotAnimation != -1 && Client.cycle >= var0.field1207) {
			...
			if (var11 != -1) {
				...
				if (var12 != null && var12.frameIds != null && !var12.method4070()) {
					++var0.field1208;
					if (var0.spotAnimationFrame < var12.frameIds.length && var0.field1208 > var12.frameLengths[var0.spotAnimationFrame]) {
						var0.field1208 = 1;
		...
		if (var0.sequence != -1 && var0.sequenceDelay == 0) {
			...
			if (var2 == null) {
				var0.sequence = -1;
			} else if (!var2.method4070() && var2.frameIds != null) {
