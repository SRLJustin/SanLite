	...
	static int method2709(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CLIENTCLOCK) {
			...
			if (var0 == ScriptOpcodes.INV_GETOBJ) {
				...
				var3 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
				var4 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1];
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = FriendsChatMember.method6838(var3, var4);
				return 1;
				...
				if (var0 == ScriptOpcodes.COORD) {
					...
					var5 = WorldMapData_1.baseY * 8 + (class67.localPlayer.y >> 7);
