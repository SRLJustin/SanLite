...
public class MusicPatch extends Node {
	...
	MusicPatch(byte[] var1) {
		...
		this.field3418 = new short[128];
		this.field3410 = new byte[128];
		this.field3411 = new byte[128];
		this.field3408 = new MusicPatchNode2[128];
		this.field3413 = new byte[128];
		this.field3414 = new int[128];
		...
		if (var16 != null) {
			...
			for (var29 = 0; var29 < var49; ++var29) {
				var47 = var46 + (this.field3411[var29] & 255);
				if (var47 < 0) {
					var47 = 0;
				}
				...
				this.field3411[var29] = (byte)var47;
			}
			...
			for (var47 = var49; var47 < 128; ++var47) {
				var48 = var46 + (this.field3411[var47] & 255);
				if (var48 < 0) {
					var48 = 0;
				}
				...
				this.field3411[var47] = (byte)var48;
			}
