...
public class class201 {
	...
	static final void drawScrollBar(int var0, int var1, int var2, int var3, int var4) {
		...
		Rasterizer2D.method8052(var0, var6 + var1 + 16, var5, Client.field553);
		Rasterizer2D.method8052(var0 + 1, var6 + var1 + 16, var5, Client.field553);
		Rasterizer2D.method8050(var0, var6 + var1 + 16, 16, Client.field553);
		Rasterizer2D.method8050(var0, var6 + var1 + 17, 16, Client.field553);
		Rasterizer2D.method8052(var0 + 15, var6 + var1 + 16, var5, Client.field558);
		Rasterizer2D.method8052(var0 + 14, var6 + var1 + 17, var5 - 1, Client.field558);
		Rasterizer2D.method8050(var0, var5 + var6 + var1 + 15, 16, Client.field558);
		Rasterizer2D.method8050(var0 + 1, var5 + var6 + var1 + 14, 15, Client.field558);
	}
}
