		...
		if (var4 != null) {
			...
			label951: {
						...
						try {
							...
							while (true) {
								...
								if (var33 >= 100) {
									...
									var14 = FileSystem.method3276(var33, var4, var35);
									switch(var14) {
									case 0:
										var30 = false;
										break label952;
									...
									if (var33 != ScriptOpcodes.INVOKE) {
										if (var33 == ScriptOpcodes.GET_VARC_INT) {
											...
											if (var33 == ScriptOpcodes.GET_VARC_STRING_OLD) {
												...
												IntegerNode var37 = (IntegerNode)var38.get((long)Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize]);
												if (var37 != null) {
													var20 += var37.integer;
												}
											} else {
												...
												if (var33 == ScriptOpcodes.GET_VARCLANSETTING) {
													var39 = WorldMapDecoration.field2816.getTitleGroupValue(var7[var20]);
													if (var39 == null) {
														Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = -1;
													} else {
														Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = var39;
													}
												} else {
													...
													var39 = SoundCache.field327.method7099(var7[var20]);
													if (var39 == null) {
														Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = -1;
													} else {
														Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = var39;
										...
										var13 = var7[var20];
										Script var36 = Message.getScript(var13);
										...
										TaskHandler.Interpreter_intStackSize -= var36.intArgumentCount;
										GrandExchangeOfferAgeComparator.Interpreter_stringStackSize -= var36.stringArgumentCount;
				...
				while (Interpreter.field841.size() > 0) {
					...
					ArchiveLoader.widgetDefaultMenuAction(var34.method2444(), var34.method2449(), var34.method2445(), var34.method2446(), "");
				}
	...
	static final void method4875(int var0) {
		...
		if (var0 != class260.clientPreferences.method2335()) {
			if (class260.clientPreferences.method2335() == 0 && Client.currentTrackGroupId != -1) {
				FriendsChatManager.method6678(MouseHandler.field244, Client.currentTrackGroupId, 0, var0, false);
