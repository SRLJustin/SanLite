...
public class class386 {
	...
	final float method6771() {
		return (float)Math.sqrt((double)(this.field4392 * this.field4392 + this.field4390 * this.field4390 + this.field4391 * this.field4391));
	}

	public String toString() {
		return this.field4392 + ", " + this.field4390 + ", " + this.field4391;
	}
}
