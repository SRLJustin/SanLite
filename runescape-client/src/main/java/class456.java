...
public class class456 implements class345 {
	...
	static {
		field4874 = new class456(0, 0, Integer.class, new class453());
		field4870 = new class456(2, 1, Long.class, new class455());
		field4871 = new class456(1, 2, String.class, new class457());
	}
