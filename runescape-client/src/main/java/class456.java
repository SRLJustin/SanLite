...
public class class456 extends DualNode {
	...
	static final void method8293(int var0, int var1, int var2, int var3, int var4, int var5, Scene var6, CollisionMap var7) {
		if (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var1][var2] & 2) != 0 || (Tiles.Tiles_renderFlags[var0][var1][var2] & 16) == 0) {
			...
			if (var5 == 22) {
				...
				if (var5 >= 12) {
					...
					var6.newWallObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field999[var4], 0, var19, var21);
					if (var4 == 0) {
						if (var8.clipped) {
					...
					var6.newWallObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field1000[var4], 0, var19, var21);
					if (var8.clipped) {
						if (var4 == 0) {
							class32.field179[var0][var1][var2 + 1] = 50;
						} else if (var4 == 1) {
					...
					if (var5 == 2) {
						...
						var6.newWallObject(var0, var1, var2, var16, (Renderable)var31, (Renderable)var32, Tiles.field999[var4], Tiles.field999[var28], var19, var21);
						if (var8.modelClipped) {
							if (var4 == 0) {
								var10000 = UserComparator7.field1410[var0][var1];
								var10000[var2] |= 585;
						...
						var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field999[var4], 0, 0, 0, var19, var21);
					} else {
						Object var25;
						long var29;
						if (var5 == 5) {
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, Tiles.field999[var4], 0, var28 * Tiles.field991[var4], var28 * Tiles.field1003[var4], var19, var21);
						} else if (var5 == 6) {
							var28 = 8;
							var29 = var6.getWallObjectTag(var0, var1, var2);
							if (var29 != 0L) {
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, 256, var4, var28 * Tiles.field993[var4], var28 * Tiles.field1004[var4], var19, var21);
						} else if (var5 == 7) {
							var23 = var4 + 2 & 3;
							if (var8.animationId == -1 && var8.transforms == null) {
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)var26, 256, var4, var28 * Tiles.field993[var4], var28 * Tiles.field1004[var4], var19, var21);
						}
					}
				}
			} else {
