	...
	static int method4444(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var13 = Renderable.getPacketBufferNode(ClientPacket.field3148, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					var7 = Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize];
					var11 = Renderable.getPacketBufferNode(ClientPacket.field3115, Client.packetWriter.isaacCipher);
					...
					var7 = Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize];
					var11 = Renderable.getPacketBufferNode(ClientPacket.field3063, Client.packetWriter.isaacCipher);
					var11.packetBuffer.writeByte(var7.length() + 1);
					var11.packetBuffer.writeStringCp1252NullTerminated(var7);
					Client.packetWriter.addNode(var11);
					return 1;
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var3 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize];
						var15 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1];
						Widget var12 = var2 ? Interpreter.scriptDotWidget : class85.field1091;
						UserComparator9.clickWidget(var12, var3, var15);
						return 1;
					} else if (var0 == ScriptOpcodes.MOUSECAM) {
						FriendsChatMember.mouseCam = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
						return 1;
						...
						var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
						var11 = Renderable.getPacketBufferNode(ClientPacket.field3147, Client.packetWriter.isaacCipher);
						...
						if (var4.length() > 500) {
							...
							var6.packetBuffer.method8673(var3);
						...
						Client.field798 = 3;
						Client.field677 = var2 ? Interpreter.scriptDotWidget.id : class85.field1091.id;
						return 1;
					} else {
						boolean var10;
