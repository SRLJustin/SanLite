			...
			if (var0 == ScriptOpcodes.INTERPOLATE) {
				...
				if (var3 == 0) {
					...
					case 4:
						...
						break;
					default:
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (int)Math.pow((double)var3, 1.0D / (double)var4);
					}
				...
				Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize - 1] = FriendsChatMember.method6650(Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize - 1]);
				return 1;
			} else if (var0 == 4033) {
