	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				WorldMapData_1.crossSprites[mouseCrossState * 20 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				WorldMapData_1.crossSprites[mouseCrossState * 20 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3036 == var1.serverPacket) {
					...
					class21.field119 = var3.readUnsignedByte() * 16384;
				...
				if (ServerPacket.field3035 == var1.serverPacket) {
					isCameraLocked = true;
					field755 = false;
					Message.field478 = var3.readUnsignedByte() * 16384;
					class12.field75 = var3.readUnsignedByte() * 16384;
