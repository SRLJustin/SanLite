													...
													do {
														...
														if (var40 == null) {
															...
															if (field724) {
																...
																var4 = PlayerComposition.field3193 * 16384 + 64;
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				UserComparator5.crossSprites[mouseCrossState * 400 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				UserComparator5.crossSprites[mouseCrossState * 400 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field2942 == var1.serverPacket) {
					isCameraLocked = true;
					field724 = false;
					PlayerComposition.field3193 = var3.readUnsignedByte() * 128;
					MusicPatchNode.field3150 = var3.readUnsignedByte() * 16384;
					ModeWhere.field3951 = var3.readUnsignedShort();
					WorldMapSection1.field2755 = var3.readUnsignedByte();
					ChatChannel.field956 = var3.readUnsignedByte();
					if (ChatChannel.field956 >= 100) {
						var17 = PlayerComposition.field3193 * 16384 + 64;
						var5 = MusicPatchNode.field3150 * 128 + 64;
