...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	static {
		...
		field599 = 0;
		field571 = 50;
		field601 = new int[field571];
		field602 = new int[field571];
		field781 = new int[field571];
		field577 = new int[field571];
		field605 = new int[field571];
		field617 = new int[field571];
		field726 = new int[field571];
		field729 = new String[field571];
		...
		field749 = -1;
		mapIconCount = 0;
		field607 = new int[1000];
		field591 = new int[1000];
	...
	protected final void setUp() {
		...
		class1.worldPort = gameBuild == 0 ? 43594 : worldId + 40000;
		class10.js5Port = gameBuild == 0 ? 443 : worldId + 50000;
		...
		this.setUpKeyboard();
		this.method506();
		class326.field3826 = this.mouseWheel();
		this.method505(field752, 0);
		this.method505(field702, 1);
		class12.field64 = new ArchiveDisk(255, JagexCache.JagexCache_dat2File, JagexCache.JagexCache_idx255File, 500000);
	...
	protected final void doCycle() {
		...
		this.method521();
		class9.method93();
		if (class326.field3826 != null) {
			var1 = class326.field3826.useRotation();
		...
		if (gameState == 0) {
			...
			PacketWriter.method2842(this, MenuAction.fontPlain12);
			class366.load();
			class204.method4130();
	...
	protected final void draw(boolean var1) {
		...
		if (var2 && field671 && SoundSystem.pcmPlayer0 != null) {
		...
		if (gameState == 30 && gameDrawingMode == 0 && !var1 && !isResizable) {
			for (var4 = 0; var4 < rootWidgetCount; ++var4) {
				if (field678[var4]) {
					class25.rasterProvider.draw(rootWidgetXs[var4], rootWidgetYs[var4], rootWidgetWidths[var4], rootWidgetHeights[var4]);
					field678[var4] = false;
				}
			}
		} else if (gameState > 0) {
			class25.rasterProvider.drawFull(0, 0);
			...
			if (--field529 + 1 <= 0) {
				try {
					...
					if (js5ConnectState == 3) {
						if (Decimator.js5Socket.vmethod7795() > 0) {
							int var5 = Decimator.js5Socket.vmethod7777();
							if (var5 != 0) {
								this.js5Error(var5);
								return;
							}
		...
		try {
			...
			if (loginState == 3) {
				...
				if (((AbstractSocket)var1).isAvailable(1)) {
					var12 = ((AbstractSocket)var1).vmethod7777();
					if (SoundSystem.pcmPlayer0 != null) {
						SoundSystem.pcmPlayer0.method783();
					}
			...
			if (loginState == 4) {
				if (var2.offset < 8) {
					var12 = ((AbstractSocket)var1).vmethod7795();
			...
			if (loginState == 5) {
				...
				var33.packetBuffer.method8648(class12.archive12.hash);
				var33.packetBuffer.method8648(class372.archive2.hash);
				var33.packetBuffer.method8648(ApproximateRouteStrategy.field490.hash);
				var33.packetBuffer.method8846(MusicPatchNode.field3448.hash);
				var33.packetBuffer.writeIntME(NetCache.archive10.hash);
				var33.packetBuffer.method8846(0);
				var33.packetBuffer.method8846(class174.archive14.hash);
				var33.packetBuffer.writeInt(GameEngine.archive19.hash);
				var33.packetBuffer.writeIntME(class419.archive18.hash);
				var33.packetBuffer.writeInt(class27.archive20.hash);
				var33.packetBuffer.method8648(class13.archive6.hash);
				var33.packetBuffer.method8846(class144.archive3.hash);
				var33.packetBuffer.writeIntME(WorldMapEvent.archive8.hash);
				var33.packetBuffer.writeInt(PendingSpawn.archive13.hash);
				var33.packetBuffer.writeIntME(class153.archive11.hash);
				var33.packetBuffer.writeIntME(class286.archive15.hash);
				var33.packetBuffer.method8648(class148.field1704.hash);
				var33.packetBuffer.method8648(class151.field1750.hash);
				var33.packetBuffer.method8846(CollisionMap.field2354.hash);
				var33.packetBuffer.writeInt(DynamicObject.archive9.hash);
				var33.packetBuffer.method8846(FriendsChatManager.archive7.hash);
			...
			int var13;
			if (loginState == 6 && ((AbstractSocket)var1).vmethod7795() > 0) {
				var12 = ((AbstractSocket)var1).vmethod7777();
				if (var12 == 61) {
					var13 = ((AbstractSocket)var1).vmethod7795();
					class209.field2376 = var13 == 1 && ((AbstractSocket)var1).vmethod7777() == 1;
					ModeWhere.method6787(5);
				}
			...
			if (loginState == 7 && ((AbstractSocket)var1).vmethod7795() >= 2) {
			...
			if (loginState == 8 && ((AbstractSocket)var1).vmethod7795() >= MidiPcmStream.field3381) {
				var2.offset = 0;
			...
			if (loginState == 9 && this.field551.method54()) {
				...
				var29.packetBuffer.method8877(this.field550);
				packetWriter.addNode(var29);
				packetWriter.flush();
				this.field550 = null;
				ModeWhere.method6787(6);
			...
			if (loginState == 10 && ((AbstractSocket)var1).vmethod7795() > 0) {
				class121.field1483 = ((AbstractSocket)var1).vmethod7777();
				ModeWhere.method6787(11);
			}

			if (loginState == 11 && ((AbstractSocket)var1).vmethod7795() >= class121.field1483) {
				((AbstractSocket)var1).read(var2.array, 0, class121.field1483);
				var2.offset = 0;
				ModeWhere.method6787(6);
			}

			if (loginState == 12 && ((AbstractSocket)var1).vmethod7795() > 0) {
				field646 = (((AbstractSocket)var1).vmethod7777() + 3) * 60;
			...
			if (loginState == 13) {
				...
				if (loginState == 14 && ((AbstractSocket)var1).vmethod7795() >= 1) {
					TriBool.field4580 = ((AbstractSocket)var1).vmethod7777();
					ModeWhere.method6787(15);
				}

				boolean var43;
				if (loginState == 15 && ((AbstractSocket)var1).vmethod7795() >= TriBool.field4580) {
					boolean var44 = ((AbstractSocket)var1).vmethod7777() == 1;
					...
					staffModLevel = ((AbstractSocket)var1).vmethod7777();
					playerMod = ((AbstractSocket)var1).vmethod7777() == 1;
					localPlayerIndex = ((AbstractSocket)var1).vmethod7777();
					localPlayerIndex <<= 8;
					localPlayerIndex += ((AbstractSocket)var1).vmethod7777();
					field630 = ((AbstractSocket)var1).vmethod7777();
					...
					var2.offset = 0;
					ServerPacket[] var39 = class179.ServerPacket_values();
				...
				if (loginState != 16) {
					if (loginState == 17 && ((AbstractSocket)var1).vmethod7795() >= 2) {
						var2.offset = 0;
						((AbstractSocket)var1).read(var2.array, 0, 2);
						var2.offset = 0;
					...
					if (loginState == 18 && ((AbstractSocket)var1).vmethod7795() >= Canvas.field138) {
						var2.offset = 0;
					...
					if (loginState == 19) {
						if (packetWriter.serverPacketLength == -1) {
							if (((AbstractSocket)var1).vmethod7795() < 2) {
								return;
							}
						...
						if (((AbstractSocket)var1).vmethod7795() >= packetWriter.serverPacketLength) {
					...
					if (((AbstractSocket)var1).vmethod7795() >= packetWriter.serverPacketLength) {
						...
						var29 = Renderable.getPacketBufferNode(ClientPacket.field3126, packetWriter.isaacCipher);
						...
						packetWriter.addNode(var29);
						class463.friendsChatManager = null;
			...
			if (gameState == 30) {
				while (true) {
					...
					if (!var30) {
						...
						int var15;
						if (timer.field4471) {
							var14 = Renderable.getPacketBufferNode(ClientPacket.field3089, packetWriter.isaacCipher);
							var14.packetBuffer.writeByte(0);
							var15 = var14.packetBuffer.offset;
							timer.write(var14.packetBuffer);
							var14.packetBuffer.method8810(var14.packetBuffer.offset - var15);
						...
						synchronized(class36.mouseRecorder.lock) {
							if (!field534) {
								...
								if (var31 != null) {
									var31.packetBuffer.method8810(var31.packetBuffer.offset - var3);
						...
						if (MouseHandler.MouseHandler_lastButton == 1 || !FriendsChatMember.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
							...
							var5 = (int)var16;
							var18 = Renderable.getPacketBufferNode(ClientPacket.field3064, packetWriter.isaacCipher);
						...
						if (field702.field2335 > 0) {
							var14 = Renderable.getPacketBufferNode(ClientPacket.field3154, packetWriter.isaacCipher);
							...
							for (var5 = 0; var5 < field702.field2335; ++var5) {
								...
								var14.packetBuffer.method8674(field702.field2328[var5]);
							}
						...
						if (field597 && field697 <= 0) {
							field697 = 20;
							field597 = false;
							var14 = Renderable.getPacketBufferNode(ClientPacket.field3146, packetWriter.isaacCipher);
							var14.packetBuffer.method8684(camAngleX);
							var14.packetBuffer.writeShort(camAngleY);
							packetWriter.addNode(var14);
						}

						if (GameEngine.hasFocus && !field515) {
							field515 = true;
							var14 = Renderable.getPacketBufferNode(ClientPacket.field3100, packetWriter.isaacCipher);
						...
						for (PendingSpawn var38 = (PendingSpawn)pendingSpawns.last(); var38 != null; var38 = (PendingSpawn)pendingSpawns.previous()) {
							...
							if (var38.field1143 == 0) {
								...
								if (var38.field1154 > 0) {
									--var38.field1154;
								}

								if (var38.field1154 == 0 && var38.x >= 1 && var38.y >= 1 && var38.x <= 102 && var38.y <= 102) {
						...
						if (class378.field4437 != null) {
							++field743;
							if (field743 >= 15) {
								LoginScreenAnimation.method2477(class378.field4437);
								class378.field4437 = null;
							}
						}

						Widget var40 = class25.mousedOverWidgetIf1;
						Widget var33 = class18.field102;
						class25.mousedOverWidgetIf1 = null;
																			...
																			do {
																				...
																				if (var45 == null) {
																					...
																					if (WorldMapLabelSize.dragInventoryWidget != null) {
																						LoginScreenAnimation.method2477(WorldMapLabelSize.dragInventoryWidget);
																						++itemDragDuration;
																						if (MouseHandler.MouseHandler_currentButton == 0) {
																							if (field624) {
																								if (WorldMapLabelSize.dragInventoryWidget == class157.hoveredItemContainer && dragItemSlotSource != dragItemSlotDestination) {
																									...
																									var18 = Renderable.getPacketBufferNode(ClientPacket.field3144, packetWriter.isaacCipher);
																									var18.packetBuffer.method8683(dragItemSlotSource);
																									var18.packetBuffer.method8682(dragItemSlotDestination);
																									var18.packetBuffer.method8673(var35);
																									var18.packetBuffer.method8648(WorldMapLabelSize.dragInventoryWidget.id);
																									packetWriter.addNode(var18);
																								}
																					...
																					if (Scene.shouldSendWalk()) {
																						...
																						var18 = Renderable.getPacketBufferNode(ClientPacket.field3158, packetWriter.isaacCipher);
																						var18.packetBuffer.writeByte(5);
																						var18.packetBuffer.writeShort(ParamComposition.baseX * 64 + var4);
																						var18.packetBuffer.method8765(field702.method4143(82) ? (field702.method4143(81) ? 2 : 1) : 0);
																					...
																					if (var40 != class25.mousedOverWidgetIf1) {
																						if (var40 != null) {
																							LoginScreenAnimation.method2477(var40);
																						}

																						if (class25.mousedOverWidgetIf1 != null) {
																							LoginScreenAnimation.method2477(class25.mousedOverWidgetIf1);
																						}
																					}

																					if (var33 != class18.field102 && field665 == field666) {
																						if (var33 != null) {
																							LoginScreenAnimation.method2477(var33);
																						}

																						if (class18.field102 != null) {
																							LoginScreenAnimation.method2477(class18.field102);
																						}
																					}
																					...
																					if (oculusOrbState == 0) {
																						...
																						if (field702.method4143(13)) {
																							packetWriter.addNode(Renderable.getPacketBufferNode(ClientPacket.field3159, packetWriter.isaacCipher));
																							oculusOrbState = 0;
																						}
																					}

																					if (MouseHandler.MouseHandler_currentButton == 4 && FriendsChatMember.mouseCam) {
																						var4 = MouseHandler.MouseHandler_y - field547;
																						field584 = var4 * 2;
																						field547 = var4 != -1 && var4 != 1 ? (field547 + MouseHandler.MouseHandler_y) / 2 : MouseHandler.MouseHandler_y;
																						...
																						field547 = MouseHandler.MouseHandler_y;
																						field585 = MouseHandler.MouseHandler_x;
																					}

																					camAngleY = field583 / 2 + camAngleY & 2047;
																					camAngleX += field584 / 2;
																					if (camAngleX < 128) {
																						camAngleX = 128;
																					}
																					...
																					if (field767) {
																						...
																						var5 = class108.field1416 * 16384 + 64;
																					...
																					var5 = GameEngine.field236.method353();
																					PacketBufferNode var27;
																					if (var4 > 15000 && var5 > 15000) {
																						logoutTimer = 250;
																						MouseHandler.MouseHandler_idleCycles = 14500;
																						var27 = Renderable.getPacketBufferNode(ClientPacket.field3140, packetWriter.isaacCipher);
																					...
																					if (packetWriter.pendingWrites > 50) {
																						var27 = Renderable.getPacketBufferNode(ClientPacket.field3098, packetWriter.isaacCipher);
																						packetWriter.addNode(var27);
																					}
					...
					var31 = Renderable.getPacketBufferNode(ClientPacket.field3132, packetWriter.isaacCipher);
					var31.packetBuffer.writeByte(0);
					var3 = var31.packetBuffer.offset;
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				Calendar.crossSprites[mouseCrossState * 400 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				Calendar.crossSprites[mouseCrossState * 400 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
		...
		class12.method172(class103.Client_plane, class387.localPlayer.x, class387.localPlayer.y, field574);
		field574 = 0;
	}
	...
	boolean method1770(PacketWriter var1, int var2) {
		if (var1.serverPacketLength == 0) {
			...
			if (class463.friendsChatManager == null) {
				class463.friendsChatManager = new FriendsChatManager(WorldMapCacheName.loginType, Decimator.client);
			}

			class463.friendsChatManager.method7554(var1.packetBuffer, var2);
		}
	...
	boolean method1235(PacketWriter var1) {
		if (class463.friendsChatManager != null) {
			class463.friendsChatManager.method7550(var1.packetBuffer);
		}
		...
		if (var2 == null) {
			...
			try {
				...
				if (var1.serverPacket == null) {
					...
					var1.field1397 = true;
					ServerPacket[] var4 = class179.ServerPacket_values();
				...
				if (ServerPacket.field3205 == var1.serverPacket) {
					class25.field147 = var3.method8677();
				...
				if (ServerPacket.field3306 == var1.serverPacket) {
					...
					class275.method5533(var20, var5, var21);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3272 == var1.serverPacket) {
					var20 = var3.method8714();
					var5 = var3.readUnsignedShort();
					var21 = var3.method8698();
					var76 = class133.getWidget(var21);
					var76.field3585 = var5 + (var20 << 16);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3298 == var1.serverPacket) {
					var62 = var3.method8786();
					var14 = var3.method8676() * 4;
					var66 = var3.method8875();
					var18 = var3.method8676();
					var13 = var3.method8676() * 4;
					var15 = var3.readUnsignedShort();
					var17 = var3.readUnsignedByte();
					var12 = var3.method8719();
					var16 = var3.method8719();
					var21 = var3.method8692();
					var20 = var21 >> 16;
					var5 = var21 >> 8 & 255;
					var7 = var20 + (var21 >> 4 & 7);
					var23 = var5 + (var21 & 7);
					var64 = var3.method8689();
					var9 = var66 + var7;
					var10 = var62 + var23;
				...
				if (ServerPacket.field3227 == var1.serverPacket) {
					var66 = var3.method8875();
					var18 = var3.method8677();
					var15 = var3.method8714();
					var12 = var3.readUnsignedShort();
					var17 = var3.method8676();
					var21 = var3.method8692();
					var20 = var21 >> 16;
					var5 = var21 >> 8 & 255;
					var7 = var20 + (var21 >> 4 & 7);
					...
					var13 = var3.method8677() * 4;
					var62 = var3.readByte();
					var16 = var3.method8714();
					var14 = var3.method8677() * 4;
					var9 = var66 + var7;
					var10 = var62 + var23;
					if (var7 >= 0 && var23 >= 0 && var7 < 104 && var23 < 104 && var9 >= 0 && var10 >= 0 && var9 < 104 && var10 < 104 && var12 != 65535) {
						var7 = var7 * 128 + 64;
				...
				if (ServerPacket.field3225 == var1.serverPacket) {
					...
					class482 var56 = class208.Ignored_cached.method8003(var3);
				...
				if (ServerPacket.field3196 == var1.serverPacket) {
					...
					class108.field1416 = var3.readUnsignedByte() * 128;
					...
					if (UserComparator7.field1444 >= 100) {
						...
						class366.cameraZ = class108.field1416 * 16384 + 64;
				...
				if (ServerPacket.field3211 == var1.serverPacket) {
					var20 = var3.method8719();
					VarpDefinition.method3596(var20);
					field661[++field524 - 1 & 31] = var20 & 32767;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3256 == var1.serverPacket) {
					...
					if (meslayerContinueWidget != null) {
						LoginScreenAnimation.method2477(meslayerContinueWidget);
						meslayerContinueWidget = null;
					}
				...
				if (ServerPacket.field3239 == var1.serverPacket) {
					...
					var5 = var3.method8700();
					var21 = var3.method8700();
					var76 = class133.getWidget(var21);
					...
					if (!var76.isIf3) {
						...
						LoginScreenAnimation.method2477(var76);
					} else {
						var76.itemId = var20;
				...
				if (ServerPacket.field3232 == var1.serverPacket) {
					...
					if (!var68) {
						field739[field740] = var30;
						field740 = (field740 + 1) % 100;
				...
				if (ServerPacket.field3286 == var1.serverPacket) {
					var5 = var3.method8714();
					var20 = var3.method8730();
					Player var77;
					...
					if (var77 != null) {
						...
						var77.field1210 = var21 >> 16;
						var77.field1207 = (var21 & 65535) + cycle;
						var77.spotAnimationFrame = 0;
						var77.field1208 = 0;
						if (var77.field1207 > cycle) {
				...
				if (ServerPacket.field3285 == var1.serverPacket) {
					...
					for (; var21-- > 0; var87.field1055 = true) {
						var7 = var3.readInt();
				...
				if (ServerPacket.field3283 == var1.serverPacket) {
					...
					if (var75 != null) {
						...
						} else if (var5 == -1 || var75.sequence == -1 || class85.SequenceDefinition_get(var5).field2292 >= class85.SequenceDefinition_get(var75.sequence).field2292) {
							var75.sequence = var5;
							var75.sequenceFrame = 0;
							var75.sequenceFrameCycle = 0;
							var75.sequenceDelay = var21;
							var75.field1205 = 0;
							var75.field1230 = var75.pathLength;
						}
					}
				...
				if (ServerPacket.field3303 == var1.serverPacket) {
					...
					var10 = var3.method8677();
					var9 = var3.method8730();
				...
				if (ServerPacket.field3231 == var1.serverPacket) {
					class288.privateChatMode = class189.method3719(var3.readUnsignedByte());
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3297 == var1.serverPacket) {
					class25.field147 = var3.method8677();
					class373.field4406 = var3.method8677();

					while (var3.offset < var1.serverPacketLength) {
						var20 = var3.readUnsignedByte();
						class280 var82 = class27.method424()[var20];
						Decimator.method1123(var82);
					}
				...
				if (ServerPacket.field3220 == var1.serverPacket) {
					var20 = var3.method8730();
					short var72 = (short)var3.method8688();
					var21 = var3.method8677();
					var7 = var3.method8700();
					NPC var57 = npcs[var20];
					if (var57 != null) {
						var57.method2623(var21, var7, var72);
					}
				...
				if (ServerPacket.field3212 == var1.serverPacket) {
					class189.method3718(var3.readStringCp1252NullTerminated());
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3254 == var1.serverPacket) {
					var20 = var3.readUnsignedShort();
					var75 = npcs[var20];
					var21 = var3.method8719();
					var5 = var3.method8699();
					if (var75 != null) {
						var75.spotAnimation = var21;
						var75.field1210 = var5 >> 16;
						var75.field1207 = (var5 & 65535) + cycle;
						var75.spotAnimationFrame = 0;
						var75.field1208 = 0;
						if (var75.field1207 > cycle) {
				...
				if (ServerPacket.field3246 == var1.serverPacket) {
					...
					LoginScreenAnimation.method2477(var81);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3258 == var1.serverPacket) {
					var20 = var3.method8719();
					var5 = var3.method8698();
					var21 = var3.method8730();
					...
					if (var20 != var8.modelAngleX || var21 != var8.modelAngleY || var7 != var8.modelZoom) {
						...
						var8.modelZoom = var7;
						LoginScreenAnimation.method2477(var8);
					}
				...
				if (ServerPacket.field3229 == var1.serverPacket) {
					class123.method3032();
					var20 = var3.method8678();
					var5 = var3.method8678();
					var21 = var3.method8700();
				...
				if (ServerPacket.field3236 == var1.serverPacket) {
					...
					class123.method3032();
					field661[++field524 - 1 & 31] = var5 & 32767;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3252 == var1.serverPacket) {
					class123.method3032();
					field496 = var3.readUnsignedShort();
					field761 = cycleCntr;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3290 == var1.serverPacket) {
					...
					var7 = var20 + (var21 >> 4 & 7);
					var23 = var5 + (var21 & 7);
					var9 = var3.method8676();
					var10 = var9 >> 2;
					var64 = var9 & 3;
					var12 = field573[var10];
					var13 = var3.method8714();
					if (var7 >= 0 && var23 >= 0 && var7 < 103 && var23 < 103) {
						if (var12 == 0) {
							WallObject var91 = WorldMapAreaData.scene.method4478(class103.Client_plane, var7, var23);
							if (var91 != null) {
							...
							DecorativeObject var90 = WorldMapAreaData.scene.method4479(class103.Client_plane, var7, var23);
							if (var90 != null) {
							...
							GroundObject var89 = WorldMapAreaData.scene.getGroundObject(class103.Client_plane, var7, var23);
							if (var89 != null) {
				...
				if (ServerPacket.field3250 == var1.serverPacket) {
					...
					if (var9 != var29.color) {
						var29.color = var9;
						LoginScreenAnimation.method2477(var29);
					}
				...
				if (ServerPacket.field3274 == var1.serverPacket) {
					tradeChatMode = var3.method8676();
					publicChatMode = var3.method8677();
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3243 == var1.serverPacket) {
					rebootTimer = var3.method8730() * 30;
					field761 = cycleCntr;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3204 == var1.serverPacket) {
					class373.field4406 = var3.method8676();
					class25.field147 = var3.readUnsignedByte();

					for (var20 = class373.field4406; var20 < class373.field4406 + 8; ++var20) {
						for (var5 = class25.field147; var5 < class25.field147 + 8; ++var5) {
					...
					for (PendingSpawn var51 = (PendingSpawn)pendingSpawns.last(); var51 != null; var51 = (PendingSpawn)pendingSpawns.previous()) {
						if (var51.x >= class373.field4406 && var51.x < class373.field4406 + 8 && var51.y >= class25.field147 && var51.y < class25.field147 + 8 && var51.plane == class103.Client_plane) {
							var51.field1143 = 0;
						}
					}
				...
				if (ServerPacket.field3253 == var1.serverPacket) {
					var50 = var3.readStringCp1252NullTerminated();
					var5 = var3.method8677();
					var21 = var3.method8678();
					if (var21 >= 1 && var21 <= 8) {
				...
				if (ServerPacket.field3261 == var1.serverPacket) {
					...
					PacketBufferNode var22 = Renderable.getPacketBufferNode(ClientPacket.field3071, packetWriter.isaacCipher);
					var22.packetBuffer.writeIntME(var20);
					var22.packetBuffer.method8846(var5);
					var22.packetBuffer.method8765(GameEngine.fps);
	...
	final void menu() {
		...
		if (WorldMapLabelSize.dragInventoryWidget == null) {
			if (clickedWidget == null) {
				...
				if (isMenuOpen) {
					int var3;
					if (var1 != 1 && (FriendsChatMember.mouseCam || var1 != 4)) {
					...
					if ((var1 == 1 || !FriendsChatMember.mouseCam && var1 == 4) && var2 >= 0) {
					...
					if ((var1 == 1 || !FriendsChatMember.mouseCam && var1 == 4) && this.shouldLeftClickOpenMenu()) {
						var1 = 2;
					}

					if ((var1 == 1 || !FriendsChatMember.mouseCam && var1 == 4) && menuOptionsCount > 0) {
						GroundObject.method4313(var2);
					}
	...
	final boolean shouldLeftClickOpenMenu() {
		...
		return (field648 && menuOptionsCount > 2 || ArchiveDisk.method7839(var1)) && !menuShiftClick[var1];
	}
	...
	final void method1730() {
		LoginScreenAnimation.method2477(clickedWidget);
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (field502 != null) {
						...
						if (var13 != null) {
							PacketBufferNode var12 = Renderable.getPacketBufferNode(ClientPacket.field3119, packetWriter.isaacCipher);
							var12.packetBuffer.writeShort(clickedWidget.itemId);
							var12.packetBuffer.writeInt(field502.id);
							var12.packetBuffer.writeShort(field502.childIndex);
							var12.packetBuffer.method8684(field502.itemId);
							var12.packetBuffer.writeShort(clickedWidget.childIndex);
							var12.packetBuffer.method8648(clickedWidget.id);
