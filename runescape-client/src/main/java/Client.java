...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	static {
		...
		field583 = new int[]{768, 1024, 1280, 512, 1536, 256, 0, 1792};
	...
	final void doCycleLoggedOut() {
		...
		try {
			...
			if (loginState == 5) {
				...
				var40.packetBuffer.method7867(class291.archive14.hash);
				var40.packetBuffer.writeInt(class145.archive8.hash);
				var40.packetBuffer.method7867(class10.archive2.hash);
				var40.packetBuffer.method7867(ObjectSound.archive19.hash);
				...
				var40.packetBuffer.method7867(JagexCache.archive10.hash);
				...
				var40.packetBuffer.method7867(KeyHandler.archive0.hash);
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				class11.crossSprites[mouseCrossState * 400 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				class11.crossSprites[mouseCrossState * 400 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
				...
				if (var6 - 64 <= var5.field814 && class131.clientPreferences.method2270() != 0 && var1 == var5.plane) {
					...
					if (var5.stream1 == null) {
						if (var5.soundEffectId >= 0) {
							...
							if (var8 != null) {
								RawSound var9 = var8.toRawSound().resample(WorldMapRectangle.field2354);
					...
					if (var5.stream2 == null) {
						if (var5.soundEffectIds != null && (var5.field821 -= var4) <= 0) {
							...
							if (var13 != null) {
								RawSound var14 = var13.toRawSound().resample(WorldMapRectangle.field2354);
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3104 == var1.serverPacket) {
					isCameraLocked = true;
					field754 = false;
					class286.field3274 = var3.readUnsignedByte() * 16384;
					class54.field447 = var3.readUnsignedByte() * 128;
					...
					if (ArchiveDisk.field4309 >= 100) {
						...
						class154.cameraZ = class54.field447 * 16384 + 64;
				...
				if (ServerPacket.field3074 == var1.serverPacket) {
					...
					class143.method3072();
					field492[++field695 - 1 & 31] = var5 & 32767;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3128 == var1.serverPacket) {
					...
					if (hintArrowType >= 2 && hintArrowType <= 6) {
						...
						field518 = var3.readUnsignedByte() * 2;
					}
				...
				if (ServerPacket.field3078 == var1.serverPacket) {
					isCameraLocked = true;
					field754 = false;
					class154.field1691 = var3.readUnsignedByte() * 128;
					class67.field881 = var3.readUnsignedByte() * 16384;
					...
					if (class386.field4337 >= 100) {
						var20 = class154.field1691 * 16384 + 64;
				...
				if (ServerPacket.field3100 == var1.serverPacket) {
					...
					var5 = var3.readUnsignedByte();
					var6 = var3.readUnsignedShort();
					Actor.method2181(var20, var5, var6);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3079 == var1.serverPacket) {
					...
					field492[++field695 - 1 & 31] = var20 & 32767;
					var1.serverPacket = null;
					return true;
				}
