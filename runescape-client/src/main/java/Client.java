...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	protected final void setUp() {
		...
		if (var1 != null && var2 != null) {
			WallObject.ByteArrayPool_alternativeSizes = var1;
			class239.ByteArrayPool_altSizeArrayCounts = new int[var1.length];
			class357.ByteArrayPool_arrays = new byte[var1.length][][];

			for (int var3 = 0; var3 < WallObject.ByteArrayPool_alternativeSizes.length; ++var3) {
			...
			WallObject.ByteArrayPool_alternativeSizes = null;
		...
		this.setUpKeyboard();
		this.method514();
		class9.field49 = this.mouseWheel();
		this.method513(field734, 0);
		this.method513(field733, 1);
		GameObject.field2740 = new ArchiveDisk(255, JagexCache.JagexCache_dat2File, JagexCache.JagexCache_idx255File, 500000);
		...
		DecorativeObject.friendSystem = new FriendSystem(ViewportMouse.loginType);
	...
	protected final void doCycle() {
		...
		if (class9.field49 != null) {
			int var1 = class9.field49.useRotation();
		...
		if (gameState == 0) {
			...
			FontName.method8081(this, Language.fontPlain12);
			class28.load();
			class354.method6768();
	...
	protected final void draw(boolean var1) {
		...
		if (var2 && field638 && HealthBar.pcmPlayer0 != null) {
				...
				try {
					label246: {
						...
						for (int var17 = 0; var17 < 100; ++var17) {
							int var18 = NetCache.NetCache_socket.vmethod7506();
							if (var18 < 0) {
								throw new IOException();
							}
							...
							if (var7 > 0) {
								...
								if (UserComparator6.NetCache_currentResponse == null) {
									...
									class420.NetCache_responseArchiveBuffer.method8523(var12);
			...
			if (--field521 + 1 <= 0) {
				try {
					...
					if (js5ConnectState == 3) {
						if (class297.js5Socket.vmethod7506() > 0) {
							int var5 = class297.js5Socket.vmethod7491();
							if (var5 != 0) {
								this.js5Error(var5);
								return;
							}
		...
		try {
			...
			if (loginState == 3) {
				...
				if (((AbstractSocket)var1).isAvailable(1)) {
					var12 = ((AbstractSocket)var1).vmethod7491();
					if (HealthBar.pcmPlayer0 != null) {
						HealthBar.pcmPlayer0.method808();
					}
			...
			if (loginState == 4) {
				if (var2.offset < 8) {
					var12 = ((AbstractSocket)var1).vmethod7506();
			...
			if (loginState == 5) {
				...
				var33.offset = 0;
				var33.writeByte(1);
				var33.method8523(var32[0]);
				var33.method8523(var32[1]);
				var33.method8523(var32[2]);
				var33.method8523(var32[3]);
				var33.writeLong(FileSystem.field1807);
				int var11;
				if (gameState == 40) {
					var33.method8523(class120.field1445[0]);
					var33.method8523(class120.field1445[1]);
					var33.method8523(class120.field1445[2]);
					var33.method8523(class120.field1445[3]);
				} else {
					if (gameState == 50) {
						var33.writeByte(class131.field1562.rsOrdinal());
						var33.method8523(HealthBarDefinition.field1923);
					} else {
						...
						case 0:
							...
							var33.method8523((Integer)var6.get(var10));
							break;
						case 1:
						case 3:
				...
				var5.packetBuffer.method8523(209);
				var5.packetBuffer.method8523(1);
				...
				var5.packetBuffer.method8523(Canvas.field126);
				...
				var5.packetBuffer.method8523(field522.hash);
				var5.packetBuffer.method8453(ChatChannel.archive14.hash);
				var5.packetBuffer.method8453(class382.field4449.hash);
				var5.packetBuffer.method8635(class139.archive20.hash);
				var5.packetBuffer.method8523(Canvas.archive4.hash);
			...
			int var17;
			if (loginState == 6 && ((AbstractSocket)var1).vmethod7506() > 0) {
				var12 = ((AbstractSocket)var1).vmethod7491();
				if (var12 == 61) {
					var17 = ((AbstractSocket)var1).vmethod7506();
					ItemContainer.field1020 = var17 == 1 && ((AbstractSocket)var1).vmethod7491() == 1;
					ReflectionCheck.method713(5);
				}
			...
			if (loginState == 7 && ((AbstractSocket)var1).vmethod7506() >= 2) {
			...
			if (loginState == 8 && ((AbstractSocket)var1).vmethod7506() >= GraphicsObject.field867) {
				var2.offset = 0;
			...
			if (loginState == 10 && ((AbstractSocket)var1).vmethod7506() > 0) {
				ObjectComposition.field2132 = ((AbstractSocket)var1).vmethod7491();
				ReflectionCheck.method713(11);
			}

			if (loginState == 11 && ((AbstractSocket)var1).vmethod7506() >= ObjectComposition.field2132) {
				((AbstractSocket)var1).read(var2.array, 0, ObjectComposition.field2132);
				var2.offset = 0;
				ReflectionCheck.method713(6);
			}

			if (loginState == 12 && ((AbstractSocket)var1).vmethod7506() > 0) {
				field574 = (((AbstractSocket)var1).vmethod7491() + 3) * 60;
			...
			if (loginState == 13) {
				...
				if (loginState == 14 && ((AbstractSocket)var1).vmethod7506() >= 1) {
					GraphicsObject.field860 = ((AbstractSocket)var1).vmethod7491();
					ReflectionCheck.method713(15);
				}

				if (loginState == 15 && ((AbstractSocket)var1).vmethod7506() >= GraphicsObject.field860) {
					boolean var46 = ((AbstractSocket)var1).vmethod7491() == 1;
					...
					staffModLevel = ((AbstractSocket)var1).vmethod7491();
					playerMod = ((AbstractSocket)var1).vmethod7491() == 1;
					localPlayerIndex = ((AbstractSocket)var1).vmethod7491();
					localPlayerIndex <<= 8;
					localPlayerIndex += ((AbstractSocket)var1).vmethod7491();
					field778 = ((AbstractSocket)var1).vmethod7491();
				...
				if (loginState != 16) {
					if (loginState == 17 && ((AbstractSocket)var1).vmethod7506() >= 2) {
						var2.offset = 0;
						((AbstractSocket)var1).read(var2.array, 0, 2);
						var2.offset = 0;
					...
					if (loginState == 18 && ((AbstractSocket)var1).vmethod7506() >= class154.field1724) {
						var2.offset = 0;
					...
					if (loginState == 19) {
						if (packetWriter.serverPacketLength == -1) {
							if (((AbstractSocket)var1).vmethod7506() < 2) {
								return;
							}
						...
						if (((AbstractSocket)var1).vmethod7506() >= packetWriter.serverPacketLength) {
					...
					if (((AbstractSocket)var1).vmethod7506() >= packetWriter.serverPacketLength) {
						...
						pendingSpawns = new NodeDeque();
						DecorativeObject.friendSystem.clear();
						...
						class9.method61();
						MenuAction.friendsChatManager = null;
				...
				while (true) {
					...
					if (!var29) {
								...
								for (var7 = 0; var7 < GrandExchangeOfferOwnWorldComparator.mouseRecorder.index && (var30 == null || var30.packetBuffer.offset - var3 < 246); ++var7) {
									...
									if (var9 != field504 || var8 != field630) {
										...
										if (var12 < 8 && var10 >= -32 && var10 <= 31 && var11 >= -32 && var11 <= 31) {
											...
											if (var9 != -1 && var8 != -1) {
												var30.packetBuffer.method8523(var9 | var8 << 16);
											} else {
												var30.packetBuffer.method8523(Integer.MIN_VALUE);
											}
										} else {
						...
						if (field589 && field779 <= 0) {
							...
							var14.packetBuffer.method8441(camAngleY);
							packetWriter.addNode(var14);
						}

						if (ChatChannel.hasFocus && !field507) {
							field507 = true;
						...
						for (PendingSpawn var38 = (PendingSpawn)pendingSpawns.last(); var38 != null; var38 = (PendingSpawn)pendingSpawns.previous()) {
							...
							if (var38.field1132 == 0) {
								...
								if (var38.field1135 > 0) {
									--var38.field1135;
								}

								if (var38.field1135 == 0 && var38.x >= 1 && var38.y >= 1 && var38.x <= 102 && var38.y <= 102 && (var38.field1127 < 0 || SoundSystem.method862(var38.field1127, var38.field1129))) {
						...
						for (var1 = 0; var1 < soundEffectCount; ++var1) {
							...
							if (queuedSoundEffectDelays[var1] >= -10) {
								...
								if (queuedSoundEffectDelays[var1] < 0) {
									...
									if (var3 > 0) {
										RawSound var23 = var31.toRawSound().resample(FaceNormal.field2521);
						...
						if (field638) {
							...
							if (!var29) {
								if (BufferedSink.clientPreferences.method2391() != 0 && currentTrackGroupId != -1) {
									class18.method266(ReflectionCheck.archive10, currentTrackGroupId, 0, BufferedSink.clientPreferences.method2391(), false);
								}
						...
						if (class133.field1575 != null) {
							++field697;
							if (field697 >= 15) {
								class143.method3053(class133.field1575);
															...
															while (true) {
																...
																if (var53 == null) {
																	...
																	if (VerticalAlignment.dragInventoryWidget != null) {
																		class143.method3053(VerticalAlignment.dragInventoryWidget);
																		++itemDragDuration;
																		if (MouseHandler.MouseHandler_currentButton == 0) {
																			if (field616) {
																				...
																				if (var50 != null) {
																					PacketBufferNode.method5389(var50.param0, var50.param1, var50.opcode, var50.identifier, var50.field883, var50.field884, var50.field889, var3, var4);
																				}
																	...
																	if (var40 != Occluder.mousedOverWidgetIf1) {
																		if (var40 != null) {
																			class143.method3053(var40);
																		}

																		if (Occluder.mousedOverWidgetIf1 != null) {
																			class143.method3053(Occluder.mousedOverWidgetIf1);
																		}
																	}

																	if (var33 != Occluder.field2556 && field527 == field786) {
																		if (var33 != null) {
																			class143.method3053(var33);
																		}

																		if (Occluder.field2556 != null) {
																			class143.method3053(Occluder.field2556);
																		}
																	}
																	...
																	if (field758) {
																		...
																		var3 = class278.field3264 * 16384 + 64;
																	...
																	DecorativeObject.friendSystem.processFriendUpdates();
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				class199.crossSprites[mouseCrossState * 20 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				class199.crossSprites[mouseCrossState * 20 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
	...
	boolean method1200(PacketWriter var1, int var2) {
		if (var1.serverPacketLength == 0) {
			...
			if (MenuAction.friendsChatManager == null) {
				MenuAction.friendsChatManager = new FriendsChatManager(ViewportMouse.loginType, ClanChannelMember.client);
			}

			MenuAction.friendsChatManager.method7267(var1.packetBuffer, var2);
		}
	...
	boolean method1217(PacketWriter var1) {
		if (MenuAction.friendsChatManager != null) {
			MenuAction.friendsChatManager.method7268(var1.packetBuffer);
		}
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3192 == var1.serverPacket) {
					...
					PlayerType var59 = (PlayerType)DecorativeObject.findEnumerated(class303.PlayerType_values(), var3.readUnsignedByte());
					...
					if (var67 == null) {
						...
						while (true) {
							if (var15 >= 100) {
								if (var59.isUser && DecorativeObject.friendSystem.isIgnored(new Username(var21, ViewportMouse.loginType))) {
									var66 = true;
								}
								break;
							}
				...
				if (ServerPacket.field3147 == var1.serverPacket) {
					...
					if (meslayerContinueWidget != null) {
						class143.method3053(meslayerContinueWidget);
						meslayerContinueWidget = null;
					}
				...
				if (ServerPacket.field3195 == var1.serverPacket) {
					...
					var57.packetBuffer.method8523(var20);
				...
				if (ServerPacket.field3216 == var1.serverPacket) {
					...
					if (var63) {
						var52 = var3.readStringCp1252NullTerminated();
						if (DecorativeObject.friendSystem.isIgnored(new Username(var52, ViewportMouse.loginType))) {
							var82 = true;
						}
					}
				...
				if (ServerPacket.field3194 == var1.serverPacket) {
					...
					PlayerType var29 = (PlayerType)DecorativeObject.findEnumerated(class303.PlayerType_values(), var3.readUnsignedByte());
					var12 = var9 + (var33 << 32);
					boolean var84 = false;
					...
					if (var29.isUser && DecorativeObject.friendSystem.isIgnored(new Username(var47, ViewportMouse.loginType))) {
						var84 = true;
					}
				...
				if (ServerPacket.field3143 == var1.serverPacket) {
					...
					class273.method5375(var20, var5, var22);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3158 == var1.serverPacket) {
					DecorativeObject.friendSystem.ignoreList.read(var3, var1.serverPacketLength);
				...
				if (ServerPacket.field3132 == var1.serverPacket) {
					...
					GroundObject.method4135(var5, var20);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3179 == var1.serverPacket) {
					DecorativeObject.friendSystem.readUpdate(var3, var1.serverPacketLength);
					field701 = cycleCntr;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3204 == var1.serverPacket) {
					...
					class471 var49 = class203.Ignored_cached.method7747(var3);
				...
				if (ServerPacket.field3159 == var1.serverPacket) {
					...
					var31 = (long)var3.readUnsignedShort();
					var33 = (long)var3.readMedium();
					PlayerType var41 = (PlayerType)DecorativeObject.findEnumerated(class303.PlayerType_values(), var3.readUnsignedByte());
					...
					if (DecorativeObject.friendSystem.isIgnored(new Username(var47, ViewportMouse.loginType))) {
						var88 = true;
					}
				...
				if (ServerPacket.field3205 == var1.serverPacket) {
					...
					if (hintArrowType >= 2 && hintArrowType <= 6) {
						...
						hintArrowType = 2;
						field512 = var3.readUnsignedShort();
						field513 = var3.readUnsignedShort();
				...
				if (ServerPacket.field3167 == var1.serverPacket) {
					DecorativeObject.friendSystem.method1842();
					field701 = cycleCntr;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3130 == var1.serverPacket) {
					...
					if (var27 >= 0 && var26 >= 0 && var27 < 103 && var26 < 103) {
						if (var39 == 0) {
							WallObject var65 = class139.scene.method4293(ApproximateRouteStrategy.Client_plane, var27, var26);
							if (var65 != null) {
							...
							DecorativeObject var64 = class139.scene.method4294(ApproximateRouteStrategy.Client_plane, var27, var26);
							if (var64 != null) {
							...
							GroundObject var62 = class139.scene.getGroundObject(ApproximateRouteStrategy.Client_plane, var27, var26);
							if (var62 != null) {
		...
		if (VerticalAlignment.dragInventoryWidget == null) {
			if (clickedWidget == null) {
				...
				if (VerticalAlignment.dragInventoryWidget != null && !field616 && menuOptionsCount > 0 && !this.shouldLeftClickOpenMenu()) {
					...
					if (var11 != null) {
						PacketBufferNode.method5389(var11.param0, var11.param1, var11.opcode, var11.identifier, var11.field883, var11.field884, var11.field889, var23, var10);
					}
	...
	final boolean shouldLeftClickOpenMenu() {
		...
		return (field719 && menuOptionsCount > 2 || class37.method710(var1)) && !menuShiftClick[var1];
	}
	...
	final void method1208() {
		class143.method3053(clickedWidget);
		++Script.field973;
		int var1;
		int var2;
		if (field640 && field684) {
			...
			if (var1 + clickedWidget.width > field603 + field680.width) {
				var1 = field603 + field680.width - clickedWidget.width;
			}
			...
			if (Script.field973 > clickedWidget.dragThreshold && (var3 > var5 || var3 < -var5 || var4 > var5 || var4 < -var5)) {
				isDraggingWidget = true;
			}

			int var6 = var1 - field603 + field680.scrollX;
				...
				if (isDraggingWidget) {
					...
					if (field683 != null) {
						...
						if (var18 != null) {
							...
							var19.packetBuffer.method8523(clickedWidget.id);
							var19.packetBuffer.writeShort(clickedWidget.itemId);
							var19.packetBuffer.writeShort(clickedWidget.childIndex);
							var19.packetBuffer.writeShort(field683.childIndex);
							var19.packetBuffer.method8523(field683.id);
							var19.packetBuffer.method8441(field683.itemId);
					...
					if (var10 != null) {
						PacketBufferNode.method5389(var10.param0, var10.param1, var10.opcode, var10.identifier, var10.field883, var10.field884, var10.field889, var14, var9);
					}
			...
			if (Script.field973 > 1) {
				if (!isDraggingWidget && menuOptionsCount > 0) {
					...
					if (var17 != null) {
						PacketBufferNode.method5389(var17.param0, var17.param1, var17.opcode, var17.identifier, var17.field883, var17.field884, var17.field889, var1, var2);
					}
				...
				for (int var1 = 0; var1 <= 28; ++var1) {
					...
					if (var2 != null) {
						...
						case 9:
							...
							break;
						case 10:
							class376.field4411 = (StudioGame)DecorativeObject.findEnumerated(Script.method2127(), Integer.parseInt(var2));
	...
	static void method1227(Font var0, Font var1) {
		...
		if (DirectByteArrayCopier.worldSelectBackSprites != null) {
			...
			if (GameObject.worldSelectLeftSprite != null && Login.worldSelectPage > 0) {
				GameObject.worldSelectLeftSprite.drawAt(8, class10.canvasHeight / 2 - GameObject.worldSelectLeftSprite.subHeight * -507610800 / 2);
			}

			if (DevicePcmPlayerProvider.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) {
				DevicePcmPlayerProvider.worldSelectRightSprite.drawAt(GameEngine.canvasWidth - DevicePcmPlayerProvider.worldSelectRightSprite.subWidth - 8, class10.canvasHeight / 2 - DevicePcmPlayerProvider.worldSelectRightSprite.subHeight * -507610800 / 2);
			}
