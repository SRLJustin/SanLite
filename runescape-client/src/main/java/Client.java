...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	static {
		...
		field647 = new int[]{768, 1024, 1280, 512, 1536, 256, 0, 1792};
	...
	protected final void setUp() {
		...
		ChatChannel.field992 = new ArchiveDisk(255, JagexCache.JagexCache_dat2File, JagexCache.JagexCache_idx255File, 500000);
		Player.clientPreferences = Decimator.method1102();
		this.setUpClipboard();
		class11.method119(this, class345.field4194);
		DecorativeObject.setWindowedMode(Player.clientPreferences.method2411());
	...
	protected final void doCycle() {
		...
		if (gameState == 0) {
			...
			ByteArrayPool.method6698(this, class1.fontPlain12);
			class202.load();
			class18.method282();
				...
				try {
					label244: {
						...
						for (int var17 = 0; var17 < 100; ++var17) {
							int var18 = NetCache.NetCache_socket.vmethod7029();
							if (var18 < 0) {
								throw new IOException();
							}
			...
			if (--field522 + 1 <= 0) {
				try {
					...
					if (js5ConnectState == 3) {
						if (WorldMapLabelSize.js5Socket.vmethod7029() > 0) {
							int var4 = WorldMapLabelSize.js5Socket.vmethod7013();
							if (var4 != 0) {
								this.js5Error(var4);
								return;
							}
		...
		try {
			...
			if (loginState == 3) {
				...
				if (((AbstractSocket)var1).isAvailable(1)) {
					var15 = ((AbstractSocket)var1).vmethod7013();
					if (class241.pcmPlayer0 != null) {
						class241.pcmPlayer0.method774();
					}
			...
			if (loginState == 4) {
				if (var2.offset < 8) {
					var15 = ((AbstractSocket)var1).vmethod7029();
			...
			if (loginState == 5) {
				...
				var44.packetBuffer.writeIntME(HealthBar.field1252.hash);
				var44.packetBuffer.method7972(UserComparator10.archive4.hash);
				var44.packetBuffer.method7971(NameableContainer.archive13.hash);
				...
				var44.packetBuffer.writeIntME(class301.archive7.hash);
				var44.packetBuffer.writeIntME(Huffman.archive20.hash);
				var44.packetBuffer.writeInt(HorizontalAlignment.archive6.hash);
				var44.packetBuffer.writeInt(class83.field1081.hash);
				var44.packetBuffer.method7972(class14.field76.hash);
				...
				var44.packetBuffer.writeIntME(class102.archive12.hash);
			...
			int var20;
			if (loginState == 6 && ((AbstractSocket)var1).vmethod7029() > 0) {
				var15 = ((AbstractSocket)var1).vmethod7013();
				if (var15 == 61) {
					var20 = ((AbstractSocket)var1).vmethod7029();
					UserComparator9.field1387 = var20 == 1 && ((AbstractSocket)var1).vmethod7013() == 1;
					class142.method3196(5);
				}
			...
			if (loginState == 7 && ((AbstractSocket)var1).vmethod7029() >= 2) {
			...
			if (loginState == 8 && ((AbstractSocket)var1).vmethod7029() >= class455.field4809) {
				var2.offset = 0;
			...
			if (loginState == 10 && ((AbstractSocket)var1).vmethod7029() > 0) {
				ScriptFrame.field464 = ((AbstractSocket)var1).vmethod7013();
				class142.method3196(11);
			}

			if (loginState == 11 && ((AbstractSocket)var1).vmethod7029() >= ScriptFrame.field464) {
				((AbstractSocket)var1).read(var2.array, 0, ScriptFrame.field464);
				var2.offset = 0;
				class142.method3196(6);
			}

			if (loginState == 12 && ((AbstractSocket)var1).vmethod7029() > 0) {
				field527 = (((AbstractSocket)var1).vmethod7013() + 3) * 60;
			...
			if (loginState == 13) {
				...
				if (loginState == 14 && ((AbstractSocket)var1).vmethod7029() >= 1) {
					class9.field31 = ((AbstractSocket)var1).vmethod7013();
					class142.method3196(15);
				}

				if (loginState == 15 && ((AbstractSocket)var1).vmethod7029() >= class9.field31) {
					boolean var47 = ((AbstractSocket)var1).vmethod7013() == 1;
					...
					staffModLevel = ((AbstractSocket)var1).vmethod7013();
					playerMod = ((AbstractSocket)var1).vmethod7013() == 1;
					localPlayerIndex = ((AbstractSocket)var1).vmethod7013();
					localPlayerIndex <<= 8;
					localPlayerIndex += ((AbstractSocket)var1).vmethod7013();
					field621 = ((AbstractSocket)var1).vmethod7013();
				...
				if (loginState == 16) {
					if (((AbstractSocket)var1).vmethod7029() >= packetWriter.serverPacketLength) {
						var2.offset = 0;
					...
					if (loginState == 17 && ((AbstractSocket)var1).vmethod7029() >= 2) {
						var2.offset = 0;
						((AbstractSocket)var1).read(var2.array, 0, 2);
						var2.offset = 0;
					...
					if (loginState == 18 && ((AbstractSocket)var1).vmethod7029() >= class97.field1320) {
						var2.offset = 0;
					...
					if (loginState == 19) {
						if (packetWriter.serverPacketLength == -1) {
							if (((AbstractSocket)var1).vmethod7029() < 2) {
								return;
							}
				...
				if (gameState == 30) {
					...
					if (packetWriter.field1349 > 750) {
						...
						if (DevicePcmPlayerProvider.field153 != null) {
							++field609;
							if (field609 >= 15) {
								class403.method7332(DevicePcmPlayerProvider.field153);
						...
						if (Decimator.method1091() && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81] && mouseWheelRotation != 0) {
							...
							if (var3 != class67.localPlayer.plane) {
								...
								var5 = class67.localPlayer.pathY[0] + WorldMapData_1.baseY * 8;
												...
												while (true) {
													do {
														...
														if (var36 == null) {
															...
															if (Nameable.dragInventoryWidget != null) {
																class403.method7332(Nameable.dragInventoryWidget);
																++itemDragDuration;
																if (MouseHandler.MouseHandler_currentButton == 0) {
																	if (field763) {
																		if (Nameable.dragInventoryWidget == SceneTilePaint.hoveredItemContainer && dragItemSlotSource != dragItemSlotDestination) {
																			Widget var38 = Nameable.dragInventoryWidget;
																			byte var29 = 0;
																			...
																			var26.packetBuffer.writeIntME(Nameable.dragInventoryWidget.id);
																	...
																	Nameable.dragInventoryWidget = null;
															...
															if (Scene.shouldSendWalk()) {
																...
																var39.packetBuffer.writeShort(WorldMapData_1.baseY * 8 + var4);
															...
															if (var33 != class148.mousedOverWidgetIf1) {
																if (var33 != null) {
																	class403.method7332(var33);
																}

																if (class148.mousedOverWidgetIf1 != null) {
																	class403.method7332(class148.mousedOverWidgetIf1);
																}
															}

															if (var34 != GrandExchangeEvent.field4105 && field657 == field560) {
																if (var34 != null) {
																	class403.method7332(var34);
																}

																if (GrandExchangeEvent.field4105 != null) {
																	class403.method7332(GrandExchangeEvent.field4105);
																}
															}
	...
	boolean method1206(PacketWriter var1, int var2) {
		if (var1.serverPacketLength == 0) {
			class145.friendsChatManager = null;
		} else {
			if (class145.friendsChatManager == null) {
				class145.friendsChatManager = new FriendsChatManager(Players.loginType, IgnoreList.client);
			}

			class145.friendsChatManager.method6823(var1.packetBuffer, var2);
		}
	...
	boolean method1207(PacketWriter var1) {
		if (class145.friendsChatManager != null) {
			class145.friendsChatManager.method6806(var1.packetBuffer);
		}
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3170 == var1.serverPacket) {
					...
					if (var6 != null) {
						class403.method7332(var6);
					}

					class33.method647();
					field693[++field694 - 1 & 31] = var5 & 32767;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3150 == var1.serverPacket) {
					...
					if (hintArrowType >= 2 && hintArrowType <= 6) {
						...
						field670 = var3.readUnsignedByte() * 4;
					}
				...
				if (ServerPacket.field3091 == var1.serverPacket) {
					...
					class452 var55 = class150.Ignored_cached.method7271(var3);
				...
				if (ServerPacket.field3116 == var1.serverPacket) {
					isCameraLocked = true;
					field544 = false;
					class119.field1479 = var3.readUnsignedByte() * 16384;
					...
					if (class93.field1270 >= 100) {
						var20 = class119.field1479 * 128 + 64;
				...
				if (ServerPacket.field3078 == var1.serverPacket) {
					isCameraLocked = true;
					field544 = false;
					SceneTilePaint.field2638 = var3.readUnsignedByte() * 128;
					...
					if (UserComparator6.field1398 >= 100) {
						TaskHandler.cameraX = SceneTilePaint.field2638 * 16384 + 64;
				...
				if (ServerPacket.field3126 == var1.serverPacket) {
					...
					var5 = var3.readUnsignedByte();
					var21 = var3.readUnsignedShort();
					class67.method2032(var20, var5, var21);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3142 == var1.serverPacket) {
					...
					field693[++field694 - 1 & 31] = var20 & 32767;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3171 == var1.serverPacket) {
					...
					if (var7 >= 0 && var8 >= 0 && var7 < 103 && var8 < 103) {
						if (var12 == 0) {
							WallObject var87 = MusicPatchNode.scene.method4281(Tiles.Client_plane, var7, var8);
							if (var87 != null) {
							...
							DecorativeObject var86 = MusicPatchNode.scene.method4282(Tiles.Client_plane, var7, var8);
							if (var86 != null) {
							...
							GroundObject var85 = MusicPatchNode.scene.getGroundObject(Tiles.Client_plane, var7, var8);
							if (var85 != null) {
				...
				if (ServerPacket.field3097 == var1.serverPacket) {
					...
					if (meslayerContinueWidget != null) {
						class403.method7332(meslayerContinueWidget);
						meslayerContinueWidget = null;
					}
				...
				var22 = "" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1350 != null ? var1.field1350.id : -1) + "," + (var1.field1345 != null ? var1.field1345.id : -1) + "," + var1.serverPacketLength + "," + (class67.localPlayer.pathX[0] + class128.baseX * 64) + "," + (class67.localPlayer.pathY[0] + WorldMapData_1.baseY * 8) + ",";
	...
	final void menu() {
		...
		if (Nameable.dragInventoryWidget == null) {
			if (clickedWidget == null) {
					...
					if (isMenuOpen) {
						...
						if (var20 == 1 || !Renderable.mouseCam && var20 == 4) {
							...
							if (var21 != -1 && var21 >= 0) {
								...
								int var12 = field615[var21];
								String var13 = menuActions[var21];
								String var14 = menuTargets[var21];
								class17.method273(var8, var17, var10, var11, var12, var13, var14, MouseHandler.MouseHandler_lastPressedX, MouseHandler.MouseHandler_lastPressedY);
							}
						...
						if ((var20 == 1 || !Renderable.mouseCam && var20 == 4) && menuOptionsCount > 0 && var2 >= 0) {
							...
							class17.method273(var3, var4, var5, var22, var21, var16, var9, MouseHandler.MouseHandler_lastPressedX, MouseHandler.MouseHandler_lastPressedY);
						}
				...
				if (Nameable.dragInventoryWidget != null && !field763 && menuOptionsCount > 0 && !this.shouldLeftClickOpenMenu()) {
					NPCComposition.method3663(draggedWidgetX, draggedWidgetY);
				}
				...
				Nameable.dragInventoryWidget = SpotAnimationDefinition.getWidget(var5);
				...
				if (var2 >= 0) {
					...
					class146.tempMenuAction.field880 = field615[var2];
					class146.tempMenuAction.field879 = menuActions[var2];
					class146.tempMenuAction.field883 = menuTargets[var2];
				}
	...
	final boolean shouldLeftClickOpenMenu() {
		...
		return (field520 && menuOptionsCount > 2 || class1.method15(var1)) && !menuShiftClick[var1];
	}
	...
	final void method1208() {
		class403.method7332(clickedWidget);
