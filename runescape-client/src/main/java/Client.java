			...
			try {
				...
				if (ServerPacket.field3103 == var1.serverPacket) {
					...
					if (hintArrowType >= 2 && hintArrowType <= 6) {
						...
						field501 = var3.readUnsignedByte() * 2;
					}
				...
				if (ServerPacket.field3121 == var1.serverPacket) {
					isCameraLocked = true;
					field667 = false;
					class12.field65 = var3.readUnsignedByte() * 128;
					class146.field1682 = var3.readUnsignedByte() * 16384;
					...
					if (UserComparator3.field1391 >= 100) {
						class18.cameraX = class12.field65 * 16384 + 64;
