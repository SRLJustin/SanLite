...
public enum class116 implements MouseWheel {
	...
	static final void method2678() {
		...
		Bounds.Ignored_cached.method7444();
		class149.method3062();
	...
	static final int method2682() {
		if (FriendsChatMember.clientPreferences.method2209()) {
