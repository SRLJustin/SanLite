...
public class GrandExchangeOfferOwnWorldComparator implements Comparator {
	...
	static int method1209(int var0, Script var1, boolean var2) {
		...
		if (var0 >= 2000) {
			...
			var3 = var2 ? Interpreter.scriptDotWidget : class85.field1091;
		}
		...
		if (var0 == ScriptOpcodes.CC_SETSCROLLPOS) {
			...
			if (var0 == ScriptOpcodes.CC_SETTEXTFONT) {
				...
				var13 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
				class485 var11 = (class485)class4.findEnumerated(WorldMapData_0.FillMode_values(), var13);
				if (var11 != null) {
					var3.fillMode = var11;
					LoginScreenAnimation.method2477(var3);
				}
	...
	static int method1208(int var0, Script var1, boolean var2) {
		...
		if (var0 >= 2000) {
			...
			var4 = var2 ? Interpreter.scriptDotWidget : class85.field1091;
		}
			...
			if (var0 == ScriptOpcodes.CC_SETDRAGGABLE) {
				...
				if (var0 != ScriptOpcodes.CC_SETOPKEY) {
					...
					if (var0 == ScriptOpcodes.CC_SETOPTKEY) {
						...
						ObjectSound.Widget_setKey(var4, var5, var8, var9);
						return 1;
