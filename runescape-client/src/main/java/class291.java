	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
				...
				if (Login.loginIndex == 0) {
					...
					if (Login.loginIndex == 2) {
						...
						var17 = GraphicsObject.method1852(FriendsChatMember.clientPreferences.method2211(), Login.field894);
						var17.drawAt(var7, var20);
						var7 = var7 + var17.subWidth + 5;
			...
			if (Client.gameState >= 10) {
				...
				Rasterizer2D.Rasterizer2D_setClip(Login.xPadding, 0, Login.xPadding + 765, DecorativeObject.canvasHeight);
			...
			class161.field1760[FriendsChatMember.clientPreferences.method2213() ? 1 : 0].drawAt(Login.xPadding + 765 - 40, 463);
