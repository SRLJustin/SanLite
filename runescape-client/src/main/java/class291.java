...
public class class291 {
	...
	static SpritePixels[] method5570() {
		...
		for (int var1 = 0; var1 < class457.SpriteBuffer_spriteCount; ++var1) {
			...
			byte[] var4 = class436.SpriteBuffer_pixels[var1];
		...
		class436.SpriteBuffer_pixels = null;
		return var0;
	}
	...
	static int method5563(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CC_SETOP) {
			var11 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] - 1;
			if (var11 >= 0 && var11 <= 9) {
				var4.setAction(var11, Interpreter.Interpreter_stringStack[--GrandExchangeOfferAgeComparator.Interpreter_stringStackSize]);
				return 1;
			} else {
			...
			if (var0 == ScriptOpcodes.CC_SETDRAGGABLE) {
				...
				var11 = Interpreter.Interpreter_intStack[TaskHandler.Interpreter_intStackSize];
				var6 = Interpreter.Interpreter_intStack[TaskHandler.Interpreter_intStackSize + 1];
				var4.parent = class293.getWidgetChild(var11, var6);
				return 1;
				...
				if (var0 != ScriptOpcodes.CC_SETOPKEY) {
					...
					if (var0 == ScriptOpcodes.CC_SETOPTKEY) {
						...
						RouteStrategy.Widget_setKey(var4, var5, var8, var9);
						return 1;
						...
						var11 = Interpreter.Interpreter_intStack[TaskHandler.Interpreter_intStackSize] - 1;
						if (var11 >= 0 && var11 <= 9) {
							HealthBarUpdate.Widget_setKeyIgnoreHeld(var4, var11);
							return 1;
						} else {
							throw new RuntimeException();
						}
