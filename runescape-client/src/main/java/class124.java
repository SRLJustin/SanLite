	...
	static int method2768(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.ENUM_STRING) {
			...
			if (var0 == ScriptOpcodes.ENUM_GETOUTPUTCOUNT) {
				...
				Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var4.size();
				return 1;
			} else {
				return 2;
			}
			...
			if (var3 == var7.inputType && var9 == var7.outputType) {
				for (int var8 = 0; var8 < var7.outputCount; ++var8) {
					if (var6 == var7.keys[var8]) {
						if (var9 == 115) {
							...
							Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var7.intVals[var8];
						}
				...
				if (var7 != null) {
					if (var9 == 115) {
						...
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var7.defaultInt;
					}
				}
