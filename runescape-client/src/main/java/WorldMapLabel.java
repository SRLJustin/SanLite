...
public class WorldMapLabel {
	...
	protected static int getGcDuration() {
		int var0 = 0;
		if (DecorativeObject.garbageCollector == null || !DecorativeObject.garbageCollector.isValid()) {
			try {
				...
				while (var1.hasNext()) {
					...
					if (var2.isValid()) {
						DecorativeObject.garbageCollector = var2;
		...
		if (DecorativeObject.garbageCollector != null) {
			long var9 = UserComparator8.method2748();
			long var3 = DecorativeObject.garbageCollector.getCollectionTime();
