...
class class361 implements Comparator {
	...
	static int method6588(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.SOUND_SYNTH) {
			...
			class174.method3443(Interpreter.Interpreter_intStack[TaskHandler.Interpreter_intStackSize], Interpreter.Interpreter_intStack[TaskHandler.Interpreter_intStackSize + 1], Interpreter.Interpreter_intStack[TaskHandler.Interpreter_intStackSize + 2]);
			return 1;
			...
			if (var0 != 3212 && var0 != 3213 && var0 != 3209 && var0 != 3181 && var0 != 3203 && var0 != 3205 && var0 != 3207) {
				if (var0 != 3214 && var0 != 3215 && var0 != 3210 && var0 != 3182 && var0 != 3204 && var0 != 3206 && var0 != 3208) {
					...
					if (var0 == 3215) {
						var6 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize];
						var4 = (class82)class271.findEnumerated(WallObject.method4494(), var6);
						if (var4 == null) {
				...
				if (var4 == class82.field1072) {
					...
					case 4:
						...
						break;
					case 5:
						DecorativeObject.method4516(var5);
						break;
					default:
						var7 = String.format("Unkown device option: %s.", var3.toString());
						throw new RuntimeException(var7);
