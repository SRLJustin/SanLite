	...
	static final void method6965() {
		...
		for (var1 = 0; var1 < class4.regionLandArchives.length; ++var1) {
			if (Renderable.regionMapArchiveIds[var1] != -1 && class4.regionLandArchives[var1] == null) {
				class4.regionLandArchives[var1] = NetCache.archive10.takeFile(Renderable.regionMapArchiveIds[var1], 0);
			...
			if (class217.regionLandArchiveIds[var1] != -1 && class323.regionMapArchives[var1] == null) {
				class323.regionMapArchives[var1] = NetCache.archive10.takeFileEncrypted(class217.regionLandArchiveIds[var1], 0, GrandExchangeOffer.xteaKeys[var1]);
			...
			if (!var0) {
				...
				if (Client.isInInstance) {
					...
					for (var2 = 0; var2 < 4; ++var2) {
						...
						for (var3 = 0; var3 < 13; ++var3) {
							for (var4 = 0; var4 < 13; ++var4) {
								boolean var18 = false;
								var6 = Client.field770[var2][var3][var4];
								if (var6 != -1) {
									var7 = var6 >> 24 & 3;
									var8 = var6 >> 1 & 3;
									var9 = var6 >> 14 & 1023;
					...
					for (var2 = 0; var2 < 13; ++var2) {
						for (var3 = 0; var3 < 13; ++var3) {
							var4 = Client.field770[0][var2][var3];
							if (var4 == -1) {
					...
					for (var2 = 0; var2 < 4; ++var2) {
						...
						for (var3 = 0; var3 < 13; ++var3) {
							for (var4 = 0; var4 < 13; ++var4) {
								var5 = Client.field770[var2][var3][var4];
								if (var5 != -1) {
									var6 = var5 >> 24 & 3;
									var7 = var5 >> 1 & 3;
									var8 = var5 >> 14 & 1023;
				...
				if (Decimator.client.hasFrame()) {
					var19 = Renderable.getPacketBufferNode(ClientPacket.field3096, Client.packetWriter.isaacCipher);
					...
					for (var7 = var3 - 1; var7 <= var4 + 1; ++var7) {
						for (var8 = var5 - 1; var8 <= var6 + 1; ++var8) {
							if (var7 < var3 || var7 > var4 || var8 < var5 || var8 > var6) {
								NetCache.archive10.loadRegionFromName("m" + var7 + "_" + var8);
								NetCache.archive10.loadRegionFromName("l" + var7 + "_" + var8);
							}
						}
					}
				}
