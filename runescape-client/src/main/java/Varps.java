...
public class Varps {
	...
	static Archive method5683(int var0, boolean var1, boolean var2, boolean var3, boolean var4) {
		...
		return new Archive(var5, GameObject.field2740, var0, var1, var2, var3, var4);
	}
}
