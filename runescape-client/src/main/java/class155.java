...
public class class155 {
	...
	public class155() {
		this.field1711 = -1;
		this.field1710 = null;
		this.field1715 = new float[4];
		this.field1716 = new ArrayList();
		this.field1722 = new ArrayList();
		this.field1718 = new ArrayList();
		this.field1719 = new HashMap();
		...
		if (var4 != 0) {
			...
			if (var4 == 1) {
				if (var2 == 1) {
					...
					class260.clientPreferences.method2322(0.9D);
				}
				...
				if (var2 == 2) {
					...
					ItemComposition.ItemDefinition_cachedSprites.clear();
					class260.clientPreferences.method2322(0.8D);
				}
				...
				if (var2 == 3) {
					...
					ItemComposition.ItemDefinition_cachedSprites.clear();
					class260.clientPreferences.method2322(0.7D);
				}
				...
				if (var2 == 4) {
					...
					ItemComposition.ItemDefinition_cachedSprites.clear();
					class260.clientPreferences.method2322(0.6D);
				}
			}
