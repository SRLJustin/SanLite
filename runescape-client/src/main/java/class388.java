...
public final class class388 {
	...
	float[] method7023() {
		...
		if ((double)this.field4410[2] < 0.999D && (double)this.field4410[2] > -0.999D) {
			...
			var1[0] = 0.0F;
			var1[1] = (float)Math.atan2((double)this.field4410[2], 0.0D);
	...
	public int hashCode() {
		boolean var1 = true;
		byte var2 = 1;
		int var3 = var2 * 31 + Arrays.hashCode(this.field4410);
		return var3;
	}
	...
	static boolean method7052(Date var0) {
		Date var1 = FriendsChatMember.method6695();
