		...
		if (var5 >= 5 && var5 <= 7) {
			...
			if (var5 >= 7) {
				for (var9 = 0; var9 < this.groupCount; ++var9) {
					this.groupIds[var9] = var7 += var4.method7715();
			...
			if (var5 >= 7) {
				for (var9 = 0; var9 < this.groupCount; ++var9) {
					...
					for (var13 = 0; var13 < var11; ++var13) {
						var14 = this.fileIds[var10][var13] = var7 += var4.method7715();
						if (var14 > var12) {
							var12 = var14;
						}
					}
		...
		for (int var1 = 0; var1 < Client.npcCount; ++var1) {
			...
			if (var2 != null && var2.isVisible() && var2.definition.isVisible == var0 && var2.definition.transformIsVisible()) {
				...
				if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) {
					if (var2.field1205 * 1073741824 == 1 && (var2.x & 127) == 64 && (var2.y & 127) == 64) {
					...
					class356.scene.drawEntity(PacketWriter.Client_plane, var2.x, var2.y, SceneTilePaint.getTileHeight(0 - 64 + var2.x, 0 - 64 + var2.y, PacketWriter.Client_plane), 0 - 64 + 60, var2, var2.rotation, var5, var2.isWalking);
				}
			}
		}
