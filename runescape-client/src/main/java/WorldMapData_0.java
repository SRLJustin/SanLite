...
public class WorldMapData_0 extends AbstractWorldMapData {
	...
	static final void method4844(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		if (var2 == 1) {
			...
			var9.packetBuffer.method8588(HealthBarUpdate.selectedItemId);
			var9.packetBuffer.method8599(ModeWhere.selectedItemWidget);
			var9.packetBuffer.method8588(class154.baseX * 64 + var0);
			...
			var9.packetBuffer.writeByte(Client.field747.method4106(82) ? 1 : 0);
			var9.packetBuffer.method8589(class154.baseX * 64 + var0);
			var9.packetBuffer.method8588(class365.baseY * 64 + var1);
			...
			if (var2 == 7) {
				...
				if (var14 != null) {
					...
					var10.packetBuffer.method8588(class101.selectedItemSlot);
					var10.packetBuffer.method8588(HealthBarUpdate.selectedItemId);
				...
				if (var14 != null) {
					...
					var10.packetBuffer.method8588(Client.selectedSpellChildIndex);
					var10.packetBuffer.method8589(var3);
					var10.packetBuffer.method8601(class358.selectedSpellWidget);
					var10.packetBuffer.method8588(Client.field677);
					var10.packetBuffer.method8580(Client.field747.method4106(82) ? 1 : 0);
					Client.packetWriter.addNode(var10);
				}
			} else if (var2 == 9) {
				...
				if (var14 != null) {
					...
					var10.packetBuffer.method8588(var3);
					var10.packetBuffer.writeByte(Client.field747.method4106(82) ? 1 : 0);
					Client.packetWriter.addNode(var10);
				}
			} else if (var2 == 12) {
				...
				if (var2 == 14) {
					...
					if (var16 != null) {
						...
						var10.packetBuffer.method8536(class358.selectedSpellWidget);
						var10.packetBuffer.method8589(Client.field677);
						Client.packetWriter.addNode(var10);
					}
				} else if (var2 == 16) {
					Client.mouseCrossX = var7;
					...
					var9.packetBuffer.method8536(ModeWhere.selectedItemWidget);
					...
					var9.packetBuffer.writeShort(var3);
					var9.packetBuffer.method8578(Client.field747.method4106(82) ? 1 : 0);
					var9.packetBuffer.writeShort(Client.field677);
					Client.packetWriter.addNode(var9);
				} else if (var2 == 18) {
					Client.mouseCrossX = var7;
					Client.mouseCrossY = var8;
					...
					if (var2 == 24) {
						...
						if (var17 != null) {
							...
							if (var12) {
								...
								var13.packetBuffer.method8536(var1);
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								var9.packetBuffer.method8536(var1);
								Client.packetWriter.addNode(var9);
								...
								var9.packetBuffer.method8607(var0);
								var9.packetBuffer.method8601(var1);
								var9.packetBuffer.method8588(var4);
								Client.packetWriter.addNode(var9);
								Client.field624 = 0;
								MusicPatchPcmStream.field3411 = class175.getWidget(var1);
								Client.field625 = var0;
								...
								var9.packetBuffer.method8536(var1);
								var9.packetBuffer.method8588(var4);
								var9.packetBuffer.method8588(var0);
								Client.packetWriter.addNode(var9);
								Client.field624 = 0;
								MusicPatchPcmStream.field3411 = class175.getWidget(var1);
								Client.field625 = var0;
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var17 != null) {
													...
													var10.packetBuffer.method8607(Client.field677);
													var10.packetBuffer.method8536(var1);
													var10.packetBuffer.method8601(class358.selectedSpellWidget);
		...
		if (Client.isItemSelected != 0) {
			Client.isItemSelected = 0;
			class69.method2030(class175.getWidget(ModeWhere.selectedItemWidget));
		}
