...
public class class174 {
	...
	static void method3376(GameEngine var0, Font var1) {
		int var5;
		if (Login.worldSelectOpen) {
			...
			if ((MouseHandler.MouseHandler_lastButton == 1 || !Bounds.mouseCam && MouseHandler.MouseHandler_lastButton == 4) && MouseHandler.MouseHandler_lastPressedX >= Login.xPadding + 765 - 50 && MouseHandler.MouseHandler_lastPressedY >= 453) {
				FriendsChatMember.clientPreferences.method2212(!FriendsChatMember.clientPreferences.method2213());
				if (!FriendsChatMember.clientPreferences.method2213()) {
					Renderable.method4229(PacketBuffer.field4700, "scape main", "", 255, false);
				} else {
					VarcInt.method3328();
				}
			}
						...
						if (Login.loginIndex == 1) {
							...
							if (Login.loginIndex == 2) {
								...
								if (var5 == 1 && Login.field868) {
									...
									if (!Client.Login_isUsernameRemembered && FriendsChatMember.clientPreferences.method2227() != null) {
								...
								if (var5 == 1 && Login.field894) {
									FriendsChatMember.clientPreferences.method2210(!FriendsChatMember.clientPreferences.method2211());
									if (!FriendsChatMember.clientPreferences.method2211()) {
										Login.Login_username = "";
										FriendsChatMember.clientPreferences.method2268((String)null);
										ReflectionCheck.method580();
									}
								...
								while (true) {
									...
									do {
										while (true) {
												...
												while (true) {
													while (ParamComposition.isKeyDown()) {
														if (class145.field1653 != 13) {
															...
															char var47 = WallObject.field2636;
															...
															if (WorldMapSectionType.method4879(WallObject.field2636) && Login.Login_username.length() < 320) {
											...
											char var49 = WallObject.field2636;
											...
											if (var46 && WorldMapSectionType.method4879(WallObject.field2636) && Login.Login_password.length() < 20) {
												Login.Login_password = Login.Login_password + WallObject.field2636;
											}
										}
									} while(var48 <= 0);
								...
								if (Login.loginIndex == 4) {
									...
									while (ParamComposition.isKeyDown()) {
										...
										for (var11 = 0; var11 < "1234567890".length(); ++var11) {
											if (WallObject.field2636 == "1234567890".charAt(var11)) {
												var10 = true;
												break;
											}
										}
									...
									while (ParamComposition.isKeyDown()) {
										...
										for (var12 = 0; var12 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".length(); ++var12) {
											if (WallObject.field2636 == "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(var12)) {
												var46 = true;
												break;
											}
										}
									...
									if (Login.loginIndex == 7) {
										if (class82.field1066 && !Client.onMobile) {
											...
											while (ParamComposition.isKeyDown()) {
												...
												if (WallObject.field2636 >= '0' && WallObject.field2636 <= '9') {
													Login.field892[Login.field891] = "" + WallObject.field2636;
													if (Login.field891 < 7) {
														++Login.field891;
													}
												}
	...
	static final void method3382(boolean var0) {
		if (var0) {
			...
			LinkedHashMap var1 = FriendsChatMember.clientPreferences.parameters;
