...
public class class130 extends DualNode {
	...
	static final void method3029() {
		for (int var0 = 0; var0 < Client.soundEffectCount; ++var0) {
			int var10002 = Client.field795[var0]--;
			if (Client.field795[var0] >= -10) {
				SoundEffect var1 = Client.field575[var0];
				if (var1 == null) {
					Object var10000 = null;
					var1 = SoundEffect.readSoundEffect(WorldMapSection0.archive9, Client.field766[var0], 0);
					if (var1 == null) {
						continue;
					}
					...
					Client.field575[var0] = var1;
				}

				if (Client.field795[var0] < 0) {
					int var2;
					if (Client.field621[var0] != 0) {
						int var3 = (Client.field621[var0] & 255) * 128;
						int var4 = Client.field621[var0] >> 16 & 255;
						int var5 = var4 * 128 + 64 - class155.localPlayer.x;
						if (var5 < 0) {
							var5 = -var5;
						}

						int var6 = Client.field621[var0] >> 8 & 255;
					...
					if (var2 > 0) {
						...
						var10.setNumLoops(Client.field767[var0] - 1);
				...
				for (int var11 = var0; var11 < Client.soundEffectCount; ++var11) {
					Client.field766[var11] = Client.field766[var11 + 1];
					Client.field575[var11] = Client.field575[var11 + 1];
					Client.field767[var11] = Client.field767[var11 + 1];
					Client.field795[var11] = Client.field795[var11 + 1];
					Client.field621[var11] = Client.field621[var11 + 1];
				}
		...
		if (Client.field764 && !class159.method3345()) {
			if (StructComposition.clientPreferences.method2425() != 0 && Client.currentTrackGroupId != -1) {
				KeyHandler.method426(class162.archive11, Client.currentTrackGroupId, 0, StructComposition.clientPreferences.method2425(), false);
			}
