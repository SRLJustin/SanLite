...
public final class KeyHandler implements KeyListener, FocusListener {
	...
	static final void method301(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		if (Client.isCameraLocked) {
			...
			WallObject.field2622 = var2 - var12;
		...
		if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (InterfaceParent.oculusOrbFocalPointX >> 7 != class101.localPlayer.x >> 7 || class141.oculusOrbFocalPointY >> 7 != class101.localPlayer.y >> 7)) {
			...
			var14 = class28.baseX * 64 + (InterfaceParent.oculusOrbFocalPointX >> 7);
			var15 = WorldMapLabelSize.baseY * 64 + (class141.oculusOrbFocalPointY >> 7);
			PacketBufferNode var16 = EnumComposition.getPacketBufferNode(ClientPacket.field2966, Client.packetWriter.isaacCipher);
			var16.packetBuffer.method7763(var13);
			var16.packetBuffer.method7771(var15);
			var16.packetBuffer.writeIntME(Client.field635);
			var16.packetBuffer.method7771(var14);
