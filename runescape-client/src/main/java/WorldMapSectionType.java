...
public enum WorldMapSectionType implements class349 {
	...
	static void method5297(Font var0, Font var1) {
		...
		if (class491.worldSelectBackSprites == null) {
			...
			SpritePixels[] var2 = class220.method4629(var3, var4, var5);
		...
		if (class25.worldSelectStars == null) {
		...
		if (class25.worldSelectStars != null) {
			class25.worldSelectStars[1].drawAt(Login.xPadding + 140, 1);
			var1.draw("Members only world", Login.xPadding + 152, 10, 16777215, -1);
			class25.worldSelectStars[0].drawAt(Login.xPadding + 140, 12);
		...
		if (class491.worldSelectBackSprites != null) {
			...
			if (StudioGame.worldSelectLeftSprite != null && Login.worldSelectPage > 0) {
				StudioGame.worldSelectLeftSprite.drawAt(8, class127.canvasHeight / 2 - StudioGame.worldSelectLeftSprite.subHeight * -517064944 / 2);
			}

			if (class205.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) {
				class205.worldSelectRightSprite.drawAt(GameEngine.canvasWidth - class205.worldSelectRightSprite.subWidth - 8, class127.canvasHeight / 2 - class205.worldSelectRightSprite.subHeight * -517064944 / 2);
			}
		...
		if (var4 != null) {
			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				for (var8 = 0; var8 < Client.mapIconCount; ++var8) {
					var16 = Client.field607[var8] * 4 + 2 - class387.localPlayer.x / 32;
					var10 = Client.field591[var8] * 4 + 2 - class387.localPlayer.y / 32;
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					...
					if (Client.hintArrowType == 2) {
						var10 = Client.field520 * 4 - ParamComposition.baseX * 256 + 2 - class387.localPlayer.x / 32;
						var11 = Client.field539 * 4 - Client.baseY * 256 + 2 - class387.localPlayer.y / 32;
