			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					if (class145.friendsChatManager != null) {
						Interpreter.Interpreter_stringStack[++VarbitComposition.Interpreter_stringStackSize - 1] = class145.friendsChatManager.name;
					} else {
						Interpreter.Interpreter_stringStack[++VarbitComposition.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (class145.friendsChatManager != null) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class145.friendsChatManager.getSize();
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize()) {
						Interpreter.Interpreter_stringStack[++VarbitComposition.Interpreter_stringStackSize - 1] = class145.friendsChatManager.get(var3).getUsername().getName();
					} else {
						Interpreter.Interpreter_stringStack[++VarbitComposition.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = ((Buddy)class145.friendsChatManager.get(var3)).getWorld();
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = ((Buddy)class145.friendsChatManager.get(var3)).rank;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class145.friendsChatManager != null ? class145.friendsChatManager.minKick : 0;
					return 1;
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class145.friendsChatManager != null ? class145.friendsChatManager.rank : 0;
					return 1;
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize() && class145.friendsChatManager.get(var3).getUsername().equals(class67.localPlayer.username)) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (class145.friendsChatManager != null && class145.friendsChatManager.owner != null) {
						Interpreter.Interpreter_stringStack[++VarbitComposition.Interpreter_stringStackSize - 1] = class145.friendsChatManager.owner;
					} else {
						Interpreter.Interpreter_stringStack[++VarbitComposition.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize() && ((FriendsChatMember)class145.friendsChatManager.get(var3)).isFriend()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (var0 == 3628) {
						...
						if (var0 == 3629) {
							...
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.removeComparator();
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new UserComparator1(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new UserComparator2(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new UserComparator3(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new UserComparator4(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new UserComparator5(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new UserComparator6(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new UserComparator7(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new UserComparator8(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new UserComparator9(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new UserComparator10(var7));
							}

							return 1;
						} else if (var0 == 3655) {
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.sort();
							}
							...
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							if (class145.friendsChatManager != null) {
								class145.friendsChatManager.addComparator(new BuddyRankComparator(var7));
							}
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize() && ((FriendsChatMember)class145.friendsChatManager.get(var3)).isIgnored()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
