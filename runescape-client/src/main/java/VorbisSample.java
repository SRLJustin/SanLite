...
public class VorbisSample extends Node {
	...
	float[] method999(int var1) {
		VorbisSample_setData(this.field368[var1], 0);
		readBit();
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) {
			...
			var42.method793(var44, var4 >> 1, var45);
		}
		...
		if (!var15) {
			...
			VorbisSample_floors[var18].method668(field383, var4 >> 1);
		}
		...
		if (var15) {
			...
			float[] var40 = var3 ? field387 : field384;
			float[] var22 = var3 ? field388 : field378;
			float[] var23 = var3 ? field389 : field386;
			int[] var24 = var3 ? field391 : field369;
		...
		float[] var41 = null;
		if (this.field380 > 0) {
			var18 = var4 + this.field380 >> 2;
			var41 = new float[var18];
			int var43;
			if (!this.field382) {
				for (var19 = 0; var19 < this.field377; ++var19) {
					var43 = var19 + (this.field380 >> 1);
					var41[var19] += this.field379[var43];
				}
			}
		...
		float[] var54 = this.field379;
		this.field379 = field383;
		field383 = var54;
		this.field380 = var4;
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) {
			...
			if (this.samples == null) {
				this.field380 = 0;
				this.field379 = new float[VorbisSample_blockSize1];
				this.samples = new byte[this.sampleCount];
				this.field393 = 0;
				this.field394 = 0;
			}

			for (; this.field394 < this.field368.length; ++this.field394) {
				if (var1 != null && var1[0] <= 0) {
					return null;
				}

				float[] var2 = this.method999(this.field394);
				if (var2 != null) {
			...
			this.samples = null;
			return new RawSound(this.sampleRate, var7, this.start, this.end, this.field365);
		}
	}
