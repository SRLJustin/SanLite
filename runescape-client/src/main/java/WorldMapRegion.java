...
public class WorldMapRegion {
		...
		for (int var4 = 0; var4 < var3.planes; ++var4) {
			...
			if (var5 != null && var5.length != 0) {
				...
				for (int var7 = 0; var7 < var6.length; ++var7) {
					...
					if (DecorativeObject.method4865(var8.decoration)) {
						...
						if (var8.decoration == WorldMapDecorationType.field3746.id) {
							...
							if (var8.rotation == 1) {
								Rasterizer2D.method9014(this.pixelsPerTile + this.pixelsPerTile * var1 - 1, this.pixelsPerTile * (63 - var2), 1, var10);
							}
						...
						if (var8.decoration == WorldMapDecorationType.field3751.id) {
							...
							if (var11 == 0) {
								for (var12 = 0; var12 < this.pixelsPerTile; ++var12) {
									Rasterizer2D.method9014(var12 + this.pixelsPerTile * var1, (64 - var2) * this.pixelsPerTile - 1 - var12, 1, var10);
								}
							} else {
								for (var12 = 0; var12 < this.pixelsPerTile; ++var12) {
									Rasterizer2D.method9014(var12 + this.pixelsPerTile * var1, var12 + this.pixelsPerTile * (63 - var2), 1, var10);
								}
							}
						}
					}
	...
	void method5086(int var1, int var2, int var3, int var4) {
		...
		if (var3 == 3) {
			Rasterizer2D.method9014(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, this.pixelsPerTile, var4);
		}
	...
	static final void addWidgetItemMenuItem(Widget var0, ItemComposition var1, int var2, int var3, boolean var4) {
		...
		if (var6 != -1 && var7 != null) {
			class290.method5598(var7, class149.colorStartTag(16748608) + var1.name, var6, 0, var2, var0.id, var1.id, var4);
		}
