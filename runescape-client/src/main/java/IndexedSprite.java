...
public final class IndexedSprite extends Rasterizer2D {
	...
	public void normalize() {
		if (this.subWidth != this.width || this.height != this.subHeight * -517064944) {
			byte[] var1 = new byte[this.width * this.height];
			int var2 = 0;

			for (int var3 = 0; var3 < this.subHeight * -517064944; ++var3) {
	...
	public void drawAt(int var1, int var2) {
		...
		int var4 = 0;
		int var5 = this.subHeight * -517064944;
	...
	public void method9071(int var1, int var2, int var3, int var4) {
		...
		int var6 = this.subHeight * -517064944;
		int var7 = 0;
		int var8 = 0;
		int var9 = this.width;
