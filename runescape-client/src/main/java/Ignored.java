...
public class Ignored extends Nameable {
	...
	public static class468 method7740(int var0) {
		class468 var1 = (class468)class468.Widget_cachedSprites.get((long)var0);
		if (var1 != null) {
			return var1;
		} else {
			byte[] var2 = class468.field4918.takeFile(38, var0);
			var1 = new class468();
			if (var2 != null) {
			...
			var1.method8558();
			class468.Widget_cachedSprites.put(var1, (long)var0);
			return var1;
		}
	}
}
