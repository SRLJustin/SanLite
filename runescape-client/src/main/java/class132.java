...
public class class132 extends class128 {
	...
	static void method2887() {
		if (class121.worldMap != null) {
			class121.worldMap.method7192(PacketWriter.Client_plane, class28.baseX * 64 + (class101.localPlayer.x >> 7), WorldMapLabelSize.baseY * 64 + (class101.localPlayer.y >> 7), false);
