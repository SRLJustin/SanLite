...
public class ClanChannel extends Node {
	...
	static final void changeGameOptions(int var0) {
		...
		if (var1 != 0) {
			...
			if (var1 == 18) {
				Client.playerAttackOption = (AttackOption)DecorativeObject.findEnumerated(FriendSystem.method1778(), var2);
			...
			if (var1 == 22) {
				Client.npcAttackOption = (AttackOption)DecorativeObject.findEnumerated(FriendSystem.method1778(), var2);
