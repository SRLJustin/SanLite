...
public class PacketWriter {
	...
	static void method2842(GameEngine var0, Font var1) {
		if (Login.worldSelectOpen) {
			HealthBar.method2610(var0);
		} else {
			if ((MouseHandler.MouseHandler_lastButton == 1 || !FriendsChatMember.mouseCam && MouseHandler.MouseHandler_lastButton == 4) && MouseHandler.MouseHandler_lastPressedX >= Login.xPadding + 765 - 50 && MouseHandler.MouseHandler_lastPressedY >= 453) {
				clientPreferences.method2563(!clientPreferences.method2570());
				if (!clientPreferences.method2570()) {
					Skeleton.method4454(class153.archive11, "scape main", "", 255, false);
				} else {
					class177.method3538();
				}
			}
			...
			if (Client.gameState != 5) {
				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					...
					if (class36.clientLanguage == Language.Language_EN) {
						if (MouseHandler.MouseHandler_lastButton == 1 || !FriendsChatMember.mouseCam && MouseHandler.MouseHandler_lastButton == 4) {
					...
					if (!FriendsChatMember.mouseCam && var21 == 4) {
						var21 = 1;
					}
					...
					if (Login.loginIndex == 0) {
						...
						if (var21 == 1 && var31 >= var34 - 75 && var31 <= var34 + 75 && var32 >= var35 - 20 && var32 <= var35 + 20 || var42) {
							if ((Client.worldProperties & 33554432) != 0) {
								...
								UserComparator6.method2972(false);
							}
						}
					} else {
						int var10;
						...
						if (Login.loginIndex == 1) {
							...
							if (Login.loginIndex == 2) {
								...
								if (Calendar.field3727 != null) {
									var34 = Calendar.field3727.highX / 2;
									if (var21 == 1 && var31 >= Calendar.field3727.lowX - var34 && var31 <= var34 + Calendar.field3727.lowX && var32 >= var33 - 15 && var32 < var33) {
								...
								var35 = 277;
								Login.field939 = var31 >= var34 && var31 < var34 + WorldMapRectangle.field2963 && var32 >= var35 && var32 < var35 + class134.field1613;
								...
								var35 = 277;
								Login.field934 = var31 >= var34 && var31 < var34 + WorldMapRectangle.field2963 && var32 >= var35 && var32 < var35 + class134.field1613;
								...
								if (Login.loginIndex == 4) {
									...
									var10 = Login.loginBoxX + 180 + 80;
									if (var21 == 1 && var31 >= var10 - 75 && var31 <= var10 + 75 && var32 >= var11 - 20 && var32 <= var11 + 20) {
										UserComparator6.method2972(true);
									}

									var35 = 361;
									if (class290.field3364 != null) {
										var13 = class290.field3364.highX / 2;
										if (var21 == 1 && var31 >= class290.field3364.lowX - var13 && var31 <= var13 + class290.field3364.lowX && var32 >= var35 - 15 && var32 < var35) {
									...
									if (Login.loginIndex == 7) {
										if (class209.field2376 && !Client.onMobile) {
											...
											if (var21 == 1 && var31 >= var14 - 75 && var31 <= var14 + 75 && var32 >= var38 - 20 && var32 <= var38 + 20) {
												var45 = Language.method6781();
												if (var45) {
													class246.method5251(50);
													return;
												}
											}
										...
										var10 = Login.loginBoxX + 180;
										var11 = 311;
										if (var22.field2339 == 84 || var22.field2339 == 13 || var21 == 1 && var31 >= var10 - 75 && var31 <= var10 + 75 && var32 >= var11 - 20 && var32 <= var11 + 20) {
											GrandExchangeOfferNameComparator.method6672(false);
										}
									} else if (Login.loginIndex == 10) {
										var10 = Login.loginBoxX + 180;
										var11 = 209;
										if (var22.field2339 == 84 || var21 == 1 && var31 >= var10 - 109 && var31 <= var10 + 109 && var32 >= var11 && var32 <= var11 + 68) {
											class70.setLoginResponseString("", "Connecting to server...", "");
										...
										var11 = 233;
										Bounds var26 = var1.method7261(0, 30, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var10, var11);
										Bounds var23 = var1.method7261(32, 32, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var10, var11);
										Bounds var24 = var1.method7261(70, 34, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var10, var11);
										var34 = var11 + 17;
										Bounds var27 = var1.method7261(0, 34, "<col=ffd200>agreement (EULA)</col>.", var10, var34);
										if (var21 == 1) {
											if (var26.method7850(var31, var32)) {
												AttackOption.openURL("https://www.jagex.com/terms", true, false);
											} else if (var23.method7850(var31, var32)) {
												AttackOption.openURL("https://www.jagex.com/terms/privacy", true, false);
											} else if (var24.method7850(var31, var32) || var27.method7850(var31, var32)) {
		...
		if (var0 == ScriptOpcodes.CLIENTCLOCK) {
			...
			if (var0 == ScriptOpcodes.INV_GETOBJ) {
				...
				if (var0 == ScriptOpcodes.COORD) {
					...
					class302.Interpreter_intStackSize -= 2;
					var3 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize] + 32768;
					var4 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1];
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class6.method49(var3, var4);
					return 1;
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = Client.field496 / 100;
					return 1;
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = Client.field496;
					return 1;
				} else {
					return 2;
				}
