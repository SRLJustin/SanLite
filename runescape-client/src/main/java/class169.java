...
public class class169 {
	...
	static void playSong(int var0) {
		if (var0 == -1 && !Client.field764) {
			class6.method39();
		} else if (var0 != -1 && var0 != Client.currentTrackGroupId && StructComposition.clientPreferences.method2425() != 0 && !Client.field764) {
			Archive var1 = class162.archive11;
