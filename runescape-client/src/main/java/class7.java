...
public class class7 {
	...
	static final void method64() {
		for (int var0 = 0; var0 < Client.soundEffectCount; ++var0) {
			...
			if (Client.queuedSoundEffectDelays[var0] >= -10) {
				...
				if (Client.queuedSoundEffectDelays[var0] < 0) {
					...
					if (var2 > 0) {
						RawSound var9 = var1.toRawSound().resample(class257.field2997);
		...
		if (Client.field671 && !DynamicObject.method2208()) {
			if (PacketWriter.clientPreferences.method2495() != 0 && Client.currentTrackGroupId != -1) {
				class148.method3216(class153.archive11, Client.currentTrackGroupId, 0, PacketWriter.clientPreferences.method2495(), false);
			}
