	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field1184 >= Client.cycle) {
			...
			if (var0.field1194 == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0 || var0.sequenceFrameCycle + 1 > ScriptFrame.SequenceDefinition_get(var0.sequence).frameLengths[var0.sequenceFrame]) {
				...
				var4 = var0.field1140 * 128 + 0;
				int var5 = var0.field1182 * 128 + 0;
				int var6 = var0.field1181 * 128 + 0;
				int var7 = var0.field1183 * 128 + 0;
		...
		if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) {
			...
			var0.field1184 = 0;
			var0.field1194 = 0;
			var0.x = var0.pathX[0] * 128 + 0;
			var0.y = var0.pathY[0] * 128 + 0;
			var0.method2182();
		}
		...
		if (var0.movementSequence != -1) {
			...
			if (var8 != null) {
				if (!var8.method3834() && var8.frameIds != null) {
		...
		if (var0.sequence != -1 && var0.sequenceDelay == 0) {
			...
			if (var8 == null) {
				var0.sequence = -1;
			} else if (!var8.method3834() && var8.frameIds != null) {
	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
			...
			if (var7 != 0L) {
				...
				if (var1 == 0) {
					class356.scene.removeWallObject(var0, var2, var3);
				...
				if (var1 == 3) {
					class356.scene.removeGroundObject(var0, var2, var3);
					var13 = class162.getObjectDefinition(var14);
