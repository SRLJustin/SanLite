...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) {
			int var4 = this.midiFile.division * this.field3205 * 1000000 / PcmPlayer.field287;
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) {
			int var2 = this.midiFile.division * this.field3205 * 1000000 / PcmPlayer.field287;
	...
	void method5277(int var1, int var2) {
		...
		this.field3207[var1] = (int)(2097152.0D * Math.pow(2.0D, 5.4931640625E-4D * (double)var2) + 0.5D);
	}
	...
	int method5278(MusicPatchNode var1) {
		...
		if (var3.field3187 > 0 && (var3.field3186 > 0 || this.field3203[var1.field3284] > 0)) {
			...
			double var6 = Math.sin((double)(var1.field3281 & 511) * 0.01227184630308513D);
			var2 += (int)(var6 * (double)var4);
		}

		var4 = (int)((double)(var1.rawSound.sampleRate * 256) * Math.pow(2.0D, 3.255208333333333E-4D * (double)var2) / (double)PcmPlayer.field287 + 0.5D);
	...
	int method5279(MusicPatchNode var1) {
		...
		if (var2.field3182 > 0) {
			var3 = (int)((double)var3 * Math.pow(0.5D, (double)var1.field3275 * 1.953125E-5D * (double)var2.field3182) + 0.5D);
		}
		...
		if (var2.field3184 != null) {
			var4 = var1.field3276;
			var5 = var2.field3184[var1.field3274 * 2 + 1];
			if (var1.field3274 * 2 < var2.field3184.length - 2) {
				var6 = (var2.field3184[var1.field3274 * 2] & 255) << 8;
				var7 = (var2.field3184[var1.field3274 * 2 + 2] & 255) << 8;
				var5 += (var2.field3184[var1.field3274 * 2 + 3] - var5) * (var4 - var6) / (var7 - var6);
			}
		...
		if (var1.field3278 > 0 && var2.field3181 != null) {
			var4 = var1.field3278;
			var5 = var2.field3181[var1.field3279 * 4 + 1];
			if (var1.field3279 * 4 < var2.field3181.length - 2) {
				var6 = (var2.field3181[var1.field3279 * 4] & 255) << 8;
				var7 = (var2.field3181[var1.field3279 * 4 + 2] & 255) << 8;
				var5 += (var2.field3181[var1.field3279 * 4 + 3] - var5) * (var4 - var6) / (var7 - var6);
			}
	...
	boolean method5317(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3278 < 0 || var1.stream != null && !var1.stream.method860()) {
			...
			if (var5 > 0) {
				var5 -= (int)(16.0D * Math.pow(2.0D, (double)this.field3214[var1.field3284] * 4.921259842519685E-4D) + 0.5D);
				if (var5 < 0) {
					var5 = 0;
				}
			...
			double var8 = (double)((var1.field3269 - 60 << 8) + (var1.field3273 * var1.field3277 >> 12)) * 5.086263020833333E-6D;
			if (var6.field3182 > 0) {
				if (var6.field3183 > 0) {
			...
			if (var6.field3184 != null) {
				...
				while (var1.field3274 * 2 < var6.field3184.length - 2 && var1.field3276 > (var6.field3184[var1.field3274 * 2 + 2] & 255) << 8) {
					var1.field3274 = var1.field3274 * 4 + 4;
				}

				if (var1.field3274 * 2 == var6.field3184.length - 2 && var6.field3184[var1.field3274 * 2 + 1] == 0) {
					var7 = true;
				}
			}
			...
			if (var1.field3278 >= 0 && var6.field3181 != null && (this.field3210[var1.field3284] & 1) == 0 && (var1.field3267 < 0 || var1 != this.field3223[var1.field3284][var1.field3267])) {
				...
				while (var1.field3279 * 4 < var6.field3181.length - 2 && var1.field3278 > (var6.field3181[var1.field3279 * 4 + 2] & 255) << 8) {
					var1.field3279 = var1.field3279 * 4 + 2;
				}

				if (var1.field3279 * 4 == var6.field3181.length - 2) {
					var7 = true;
				}
			}
