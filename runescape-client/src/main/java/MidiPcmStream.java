...
public class MidiPcmStream extends PcmStream {
	...
	int method5279(MusicPatchNode var1) {
		...
		if (var2.field3184 != null) {
			var4 = var1.field3276;
			var5 = var2.field3184[var1.field3274 * 4 + 1];
			if (var1.field3274 * 4 < var2.field3184.length - 2) {
				var6 = (var2.field3184[var1.field3274 * 4] & 255) << 8;
				var7 = (var2.field3184[var1.field3274 * 4 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field3184[var1.field3274 * 4 + 3] - var5) / (var7 - var6);
			}
	...
	boolean method5317(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3278 < 0 || var1.stream != null && !var1.stream.method860()) {
			...
			if (var6.field3184 != null) {
				...
				while (var1.field3274 * 4 < var6.field3184.length - 2 && var1.field3276 > (var6.field3184[var1.field3274 * 4 + 2] & 255) << 8) {
					var1.field3274 = var1.field3274 * 4 + 2;
				}

				if (var1.field3274 * 4 == var6.field3184.length - 2 && var6.field3184[var1.field3274 * 4 + 1] == 0) {
					var7 = true;
				}
			}
