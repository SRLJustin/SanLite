...
public class MidiPcmStream extends PcmStream {
	...
	int method5105(MusicPatchNode var1) {
		...
		if (var2.field3226 > 0) {
			var3 = (int)((double)var3 * Math.pow(0.5D, 1.953125E-5D * (double)var1.field3313 * (double)var2.field3226) + 0.5D);
		}
		...
		if (var2.field3232 != null) {
			var4 = var1.field3314;
			var5 = var2.field3232[var1.field3315 * 4 + 1];
			if (var1.field3315 * 4 < var2.field3232.length - 2) {
				var6 = (var2.field3232[var1.field3315 * 4] & 255) << 8;
				var7 = (var2.field3232[var1.field3315 * 4 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field3232[var1.field3315 * 4 + 3] - var5) / (var7 - var6);
			}
		...
		if (var1.field3316 < 0 || var1.stream != null && !var1.stream.method815()) {
			...
			if (var6.field3226 > 0) {
				if (var6.field3227 > 0) {
					...
					var1.field3313 = var1.field3313 * 1251753984 + 1310720000;
				}
			}
			...
			if (var6.field3232 != null) {
				...
				while (var1.field3315 * 4 < var6.field3232.length - 2 && var1.field3314 > (var6.field3232[var1.field3315 * 4 + 2] & 255) << 8) {
					var1.field3315 = var1.field3315 * 4 + 2;
				}

				if (var1.field3315 * 4 == var6.field3232.length - 2 && var6.field3232[var1.field3315 * 4 + 1] == 0) {
					var7 = true;
				}
			}
