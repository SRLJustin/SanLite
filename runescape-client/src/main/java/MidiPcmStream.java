...
public class MidiPcmStream extends PcmStream {
	...
	int method5299(MusicPatchNode var1) {
		...
		if (var1.field3253 > 0 && var2.field3162 != null) {
			var4 = var1.field3253;
			var5 = var2.field3162[var1.field3250 * 4 + 1];
			if (var1.field3250 * 4 < var2.field3162.length - 2) {
				var6 = (var2.field3162[var1.field3250 * 4] & 255) << 8;
				var7 = (var2.field3162[var1.field3250 * 4 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field3162[var1.field3250 * 4 + 3] - var5) / (var7 - var6);
			}
	...
	boolean method5396(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3253 < 0 || var1.stream != null && !var1.stream.method831()) {
			...
			if (var1.field3253 >= 0 && var6.field3162 != null && (this.field3200[var1.field3240] & 1) == 0 && (var1.field3243 < 0 || var1 != this.field3204[var1.field3240][var1.field3243])) {
				...
				while (var1.field3250 * 4 < var6.field3162.length - 2 && var1.field3253 > (var6.field3162[var1.field3250 * 4 + 2] & 255) << 8) {
					var1.field3250 = var1.field3250 * 4 + 2;
				}

				if (var1.field3250 * 4 == var6.field3162.length - 2) {
					var7 = true;
				}
			}
