...
public class MidiPcmStream extends PcmStream {
	...
	int method5590(MusicPatchNode var1) {
		...
		if (var2.field3337 != null) {
			var4 = var1.field3420;
			var5 = var2.field3337[var1.field3416 * 2 + 1];
			if (var1.field3416 * 2 < var2.field3337.length - 2) {
				var6 = (var2.field3337[var1.field3416 * 2] & 255) << 8;
				var7 = (var2.field3337[var1.field3416 * 2 + 2] & 255) << 8;
				var5 += (var2.field3337[var1.field3416 * 2 + 3] - var5) * (var4 - var6) / (var7 - var6);
			}
		...
		if (var1.field3415 > 0 && var2.field3333 != null) {
			var4 = var1.field3415;
			var5 = var2.field3333[var1.field3429 * 4 + 1];
			if (var1.field3429 * 4 < var2.field3333.length - 2) {
				var6 = (var2.field3333[var1.field3429 * 4] & 255) << 8;
				var7 = (var2.field3333[var1.field3429 * 4 + 2] & 255) << 8;
				var5 += (var2.field3333[var1.field3429 * 4 + 3] - var5) * (var4 - var6) / (var7 - var6);
			}
	...
	boolean method5599(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3415 < 0 || var1.stream != null && !var1.stream.method919()) {
			...
			if (var6.field3337 != null) {
				...
				while (var1.field3416 * 2 < var6.field3337.length - 2 && var1.field3420 > (var6.field3337[var1.field3416 * 2 + 2] & 255) << 8) {
					var1.field3416 = var1.field3416 * 4 + 4;
				}

				if (var1.field3416 * 2 == var6.field3337.length - 2 && var6.field3337[var1.field3416 * 2 + 1] == 0) {
					var7 = true;
				}
			}
			...
			if (var1.field3415 >= 0 && var6.field3333 != null && (this.field3356[var1.field3427] & 1) == 0 && (var1.field3418 < 0 || var1 != this.field3374[var1.field3427][var1.field3418])) {
				...
				while (var1.field3429 * 4 < var6.field3333.length - 2 && var1.field3415 > (var6.field3333[var1.field3429 * 4 + 2] & 255) << 8) {
					var1.field3429 = var1.field3429 * 4 + 2;
				}

				if (var1.field3429 * 4 == var6.field3333.length - 2) {
					var7 = true;
				}
			}
