...
public class MidiPcmStream extends PcmStream {
	...
	public MidiPcmStream() {
		...
		this.field3213 = new int[16];
		this.field3212 = new int[16];
		this.field3217 = new int[16];
		this.field3222 = new int[16];
		this.field3221 = new MusicPatchNode[16][128];
		this.field3220 = new MusicPatchNode[16][128];
	...
	void method5292(int var1, int var2) {
		...
		this.field3222[var1] = (int)(2097152.0D * Math.pow(2.0D, (double)var2 * 5.4931640625E-4D) + 0.5D);
	}
	...
	int method5293(MusicPatchNode var1) {
		...
		if (var3.field3182 > 0 && (var3.field3186 > 0 || this.field3211[var1.field3274] > 0)) {
			...
			double var6 = Math.sin((double)(var1.field3278 & 511) * 0.01227184630308513D);
			var2 += (int)((double)var4 * var6);
		}

		var4 = (int)((double)(var1.rawSound.sampleRate * 256) * Math.pow(2.0D, 3.255208333333333E-4D * (double)var2) / (double)class301.field3595 + 0.5D);
	...
	int method5294(MusicPatchNode var1) {
		...
		if (var2.field3180 > 0) {
			var3 = (int)((double)var3 * Math.pow(0.5D, 1.953125E-5D * (double)var1.field3272 * (double)var2.field3180) + 0.5D);
		}
		...
		if (var1.field3275 > 0 && var2.field3191 != null) {
			var4 = var1.field3275;
			var5 = var2.field3191[var1.field3276 * 2 + 1];
			if (var1.field3276 * 2 < var2.field3191.length - 2) {
				var6 = (var2.field3191[var1.field3276 * 2] & 255) << 8;
				var7 = (var2.field3191[var1.field3276 * 2 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field3191[var1.field3276 * 2 + 3] - var5) / (var7 - var6);
			}
	...
	boolean method5303(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3275 < 0 || var1.stream != null && !var1.stream.method859()) {
			...
			if (var5 > 0) {
				var5 -= (int)(16.0D * Math.pow(2.0D, 4.921259842519685E-4D * (double)this.field3218[var1.field3274]) + 0.5D);
				if (var5 < 0) {
					var5 = 0;
				}
			...
			double var8 = (double)((var1.field3279 - 60 << 8) + (var1.field3269 * var1.field3271 >> 12)) * 5.086263020833333E-6D;
			if (var6.field3180 > 0) {
				if (var6.field3185 > 0) {
			...
			if (var1.field3275 >= 0 && var6.field3191 != null && (this.field3219[var1.field3274] & 1) == 0 && (var1.field3265 < 0 || var1 != this.field3220[var1.field3274][var1.field3265])) {
				...
				while (var1.field3276 * 2 < var6.field3191.length - 2 && var1.field3275 > (var6.field3191[var1.field3276 * 2 + 2] & 255) << 8) {
					var1.field3276 = var1.field3276 * 4 + 4;
				}

				if (var1.field3276 * 2 == var6.field3191.length - 2) {
					var7 = true;
				}
			}
