...
public class MidiPcmStream extends PcmStream {
	...
	int method5097(MusicPatchNode var1) {
		...
		if (var2.field3056 != null) {
			var4 = var1.field3140;
			var5 = var2.field3056[var1.field3141 * 4 + 1];
			if (var1.field3141 * 4 < var2.field3056.length - 2) {
				var6 = (var2.field3056[var1.field3141 * 4] & 255) << 8;
				var7 = (var2.field3056[var1.field3141 * 4 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field3056[var1.field3141 * 4 + 3] - var5) / (var7 - var6);
			}
	...
	boolean method5106(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3142 < 0 || var1.stream != null && !var1.stream.method854()) {
			...
			if (var6.field3052 > 0) {
				if (var6.field3057 > 0) {
					var1.field3139 = var1.field3139 * 1595686912 + (int)(128.0D * Math.pow(2.0D, var8 * (double)var6.field3057) + 0.5D) * 1595686912;
				} else {
					var1.field3139 = var1.field3139 * 1595686912 + -1910505472;
				}
			}
			...
			if (var6.field3056 != null) {
				...
				while (var1.field3141 * 4 < var6.field3056.length - 2 && var1.field3140 > (var6.field3056[var1.field3141 * 4 + 2] & 255) << 8) {
					var1.field3141 = var1.field3141 * 4 + 2;
				}

				if (var1.field3141 * 4 == var6.field3056.length - 2 && var6.field3056[var1.field3141 * 4 + 1] == 0) {
					var7 = true;
				}
			}
