...
public class MidiPcmStream extends PcmStream {
	...
	public MidiPcmStream() {
		this.field3366 = 256;
		this.field3367 = -727379968;
		this.field3368 = new int[16];
		this.field3392 = new int[16];
		this.field3370 = new int[16];
		this.field3388 = new int[16];
		this.field3372 = new int[16];
		this.field3369 = new int[16];
		this.field3374 = new int[16];
		this.field3380 = new int[16];
		this.field3376 = new int[16];
		this.field3375 = new int[16];
		this.field3378 = new int[16];
		this.field3379 = new int[16];
		this.field3384 = new int[16];
		this.field3365 = new int[16];
		this.field3373 = new int[16];
		this.field3383 = new MusicPatchNode[16][128];
		this.field3391 = new MusicPatchNode[16][128];
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) {
			int var4 = this.midiFile.division * this.field3367 * 1000000 / class284.field3321;
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) {
			int var2 = this.midiFile.division * this.field3367 * 1000000 / class284.field3321;
	...
	void method5614(int var1, int var2) {
		...
		this.field3373[var1] = (int)(2097152.0D * Math.pow(2.0D, (double)var2 * 5.4931640625E-4D) + 0.5D);
	}
	...
	int method5639(MusicPatchNode var1) {
		...
		if (var3.field3354 > 0 && (var3.field3349 > 0 || this.field3380[var1.field3436] > 0)) {
			...
			double var6 = Math.sin(0.01227184630308513D * (double)(var1.field3443 & 511));
			var2 += (int)((double)var4 * var6);
		}

		var4 = (int)((double)(var1.rawSound.sampleRate * 256) * Math.pow(2.0D, (double)var2 * 3.255208333333333E-4D) / (double)class284.field3321 + 0.5D);
	...
	int method5640(MusicPatchNode var1) {
		...
		if (var2.field3345 > 0) {
			var3 = (int)((double)var3 * Math.pow(0.5D, (double)var2.field3345 * 1.953125E-5D * (double)var1.field3437) + 0.5D);
		}
		...
		if (var1.field3440 > 0 && var2.field3351 != null) {
			var4 = var1.field3440;
			var5 = var2.field3351[var1.field3426 * 2 + 1];
			if (var1.field3426 * 2 < var2.field3351.length - 2) {
				var6 = (var2.field3351[var1.field3426 * 2] & 255) << 8;
				var7 = (var2.field3351[var1.field3426 * 2 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field3351[var1.field3426 * 2 + 3] - var5) / (var7 - var6);
			}
	...
	boolean method5626(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3440 < 0 || var1.stream != null && !var1.stream.method898()) {
			...
			if (var5 > 0) {
				var5 -= (int)(16.0D * Math.pow(2.0D, (double)this.field3376[var1.field3436] * 4.921259842519685E-4D) + 0.5D);
				if (var5 < 0) {
					var5 = 0;
				}
			...
			double var8 = (double)((var1.field3431 - 60 << 8) + (var1.field3439 * var1.field3428 >> 12)) * 5.086263020833333E-6D;
			if (var6.field3345 > 0) {
				if (var6.field3352 > 0) {
			...
			if (var1.field3440 >= 0 && var6.field3351 != null && (this.field3375[var1.field3436] & 1) == 0 && (var1.field3430 < 0 || var1 != this.field3391[var1.field3436][var1.field3430])) {
				...
				while (var1.field3426 * 2 < var6.field3351.length - 2 && var1.field3440 > (var6.field3351[var1.field3426 * 2 + 2] & 255) << 8) {
					var1.field3426 = var1.field3426 * 4 + 4;
				}

				if (var1.field3426 * 2 == var6.field3351.length - 2) {
					var7 = true;
				}
			}
