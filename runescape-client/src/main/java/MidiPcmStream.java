...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) {
			int var4 = this.midiFile.division * this.field3113 * 1000000 / PcmPlayer.field305;
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) {
			int var2 = this.midiFile.division * this.field3113 * 1000000 / PcmPlayer.field305;
	...
	int method5152(MusicPatchNode var1) {
		...
		if (var2.field3094 != null) {
			var4 = var1.field3183;
			var5 = var2.field3094[var1.field3176 * 4 + 1];
			if (var1.field3176 * 4 < var2.field3094.length - 2) {
				var6 = (var2.field3094[var1.field3176 * 4] & 255) << 8;
				var7 = (var2.field3094[var1.field3176 * 4 + 2] & 255) << 8;
				var5 += (var2.field3094[var1.field3176 * 4 + 3] - var5) * (var4 - var6) / (var7 - var6);
			}
	...
	boolean method5068(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3186 < 0 || var1.stream != null && !var1.stream.method826()) {
			...
			if (var6.field3094 != null) {
				...
				while (var1.field3176 * 4 < var6.field3094.length - 2 && var1.field3183 > (var6.field3094[var1.field3176 * 4 + 2] & 255) << 8) {
					var1.field3176 = var1.field3176 * 4 + 2;
				}

				if (var1.field3176 * 4 == var6.field3094.length - 2 && var6.field3094[var1.field3176 * 4 + 1] == 0) {
					var7 = true;
				}
			}
