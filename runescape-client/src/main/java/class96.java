...
public class class96 {
			...
			try {
				if (NetCache.NetCache_loadTime > 30000) {
					...
					for (int var15 = 0; var15 < 100; ++var15) {
						int var16 = NetCache.NetCache_socket.vmethod7795();
						if (var16 < 0) {
							throw new IOException();
						}
	...
	public static PacketBufferNode method2686(int var0, String var1, Language var2, int var3) {
		...
		var4.packetBuffer.method8810(var4.packetBuffer.offset - var5);
		return var4;
	}
	...
	static int method2687(int var0, Script var1, boolean var2) {
		Widget var3 = var2 ? Interpreter.scriptDotWidget : class85.field1091;
