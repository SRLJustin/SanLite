...
public class class326 {
	...
	public class326() {
		...
		this.field4093 = new int[2048];
		this.field4095 = new int[2048];
		this.field4094 = 0;
		...
		for (byte var3 = 12; var1 < 16; var2 -= var3) {
			var4 = VarbitComposition.method3556((double)((float)var2 / 360.0F), 0.9998999834060669D, (double)(0.075F + (float)var1 * 0.425F / 16.0F));
		...
		for (int var6 = var2 / 6; var1 < UserComparator7.field1366.length; var2 -= var6) {
			var4 = var1 * 2;

			for (int var5 = VarbitComposition.method3556((double)((float)var2 / 360.0F), 0.9998999834060669D, 0.5D); var1 < var4 && var1 < UserComparator7.field1366.length; ++var1) {
	...
	void method6064(int var1) {
		int var2 = var1 * 2 + 1;
		double[] var3 = class149.method3135(0.0D, (double)((float)var1 / 3.0F), var1);
