...
public class class28 {
	...
	static int method412(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.FRIEND_COUNT) {
			if (DecorativeObject.friendSystem.field814 == 0) {
				Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = -2;
			} else if (DecorativeObject.friendSystem.field814 == 1) {
				Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = -1;
			} else {
				Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = DecorativeObject.friendSystem.friendsList.getSize();
			}
			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (DecorativeObject.friendSystem.method1818() && var3 >= 0 && var3 < DecorativeObject.friendSystem.friendsList.getSize()) {
					Friend var8 = (Friend)DecorativeObject.friendSystem.friendsList.get(var3);
				...
				var3 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize];
				if (DecorativeObject.friendSystem.method1818() && var3 >= 0 && var3 < DecorativeObject.friendSystem.friendsList.getSize()) {
					Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = ((Buddy)DecorativeObject.friendSystem.friendsList.get(var3)).world;
				} else {
				...
				var3 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize];
				if (DecorativeObject.friendSystem.method1818() && var3 >= 0 && var3 < DecorativeObject.friendSystem.friendsList.getSize()) {
					Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = ((Buddy)DecorativeObject.friendSystem.friendsList.get(var3)).rank;
				} else {
					Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = 0;
				}
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					var5 = Interpreter.Interpreter_stringStack[--class125.Interpreter_stringStackSize];
					DecorativeObject.friendSystem.addFriend(var5);
					return 1;
				} else if (var0 == ScriptOpcodes.FRIEND_DEL) {
					var5 = Interpreter.Interpreter_stringStack[--class125.Interpreter_stringStackSize];
					DecorativeObject.friendSystem.removeFriend(var5);
					return 1;
				} else if (var0 == ScriptOpcodes.IGNORE_ADD) {
					var5 = Interpreter.Interpreter_stringStack[--class125.Interpreter_stringStackSize];
					DecorativeObject.friendSystem.addIgnore(var5);
					return 1;
				} else if (var0 == ScriptOpcodes.IGNORE_DEL) {
					var5 = Interpreter.Interpreter_stringStack[--class125.Interpreter_stringStackSize];
					DecorativeObject.friendSystem.removeIgnore(var5);
					return 1;
				} else if (var0 == ScriptOpcodes.FRIEND_TEST) {
					var5 = Interpreter.Interpreter_stringStack[--class125.Interpreter_stringStackSize];
					var5 = ItemLayer.method4055(var5);
					Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = DecorativeObject.friendSystem.isFriended(new Username(var5, ViewportMouse.loginType), false) ? 1 : 0;
					return 1;
				} else if (var0 == ScriptOpcodes.CLAN_GETCHATDISPLAYNAME) {
					if (MenuAction.friendsChatManager != null) {
						Interpreter.Interpreter_stringStack[++class125.Interpreter_stringStackSize - 1] = MenuAction.friendsChatManager.name;
					} else {
						Interpreter.Interpreter_stringStack[++class125.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (MenuAction.friendsChatManager != null) {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = MenuAction.friendsChatManager.getSize();
					} else {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize];
					if (MenuAction.friendsChatManager != null && var3 < MenuAction.friendsChatManager.getSize()) {
						Interpreter.Interpreter_stringStack[++class125.Interpreter_stringStackSize - 1] = MenuAction.friendsChatManager.get(var3).getUsername().getName();
					} else {
						Interpreter.Interpreter_stringStack[++class125.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize];
					if (MenuAction.friendsChatManager != null && var3 < MenuAction.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = ((Buddy)MenuAction.friendsChatManager.get(var3)).getWorld();
					} else {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize];
					if (MenuAction.friendsChatManager != null && var3 < MenuAction.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = ((Buddy)MenuAction.friendsChatManager.get(var3)).rank;
					} else {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = 0;
					}
					...
					Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = MenuAction.friendsChatManager != null ? MenuAction.friendsChatManager.minKick : 0;
					return 1;
					...
					Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = MenuAction.friendsChatManager != null ? MenuAction.friendsChatManager.rank : 0;
					return 1;
					...
					if (!DecorativeObject.friendSystem.method1818()) {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = -1;
					} else {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = DecorativeObject.friendSystem.ignoreList.getSize();
					}

					return 1;
				} else if (var0 == ScriptOpcodes.IGNORE_GETNAME) {
					var3 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize];
					if (DecorativeObject.friendSystem.method1818() && var3 >= 0 && var3 < DecorativeObject.friendSystem.ignoreList.getSize()) {
						Ignored var4 = (Ignored)DecorativeObject.friendSystem.ignoreList.get(var3);
					...
					var5 = Interpreter.Interpreter_stringStack[--class125.Interpreter_stringStackSize];
					var5 = ItemLayer.method4055(var5);
					Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = DecorativeObject.friendSystem.isIgnored(new Username(var5, ViewportMouse.loginType)) ? 1 : 0;
					return 1;
				} else if (var0 == ScriptOpcodes.CLAN_ISSELF) {
					var3 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize];
					if (MenuAction.friendsChatManager != null && var3 < MenuAction.friendsChatManager.getSize() && MenuAction.friendsChatManager.get(var3).getUsername().equals(class296.localPlayer.username)) {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (MenuAction.friendsChatManager != null && MenuAction.friendsChatManager.owner != null) {
						Interpreter.Interpreter_stringStack[++class125.Interpreter_stringStackSize - 1] = MenuAction.friendsChatManager.owner;
					} else {
						Interpreter.Interpreter_stringStack[++class125.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize];
					if (MenuAction.friendsChatManager != null && var3 < MenuAction.friendsChatManager.getSize() && ((FriendsChatMember)MenuAction.friendsChatManager.get(var3)).isFriend()) {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (var0 == 3628) {
						DecorativeObject.friendSystem.friendsList.removeComparator();
						return 1;
					} else {
						boolean var7;
						if (var0 == 3629) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new UserComparator1(var7));
							return 1;
						} else if (var0 == 3630) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new UserComparator2(var7));
							return 1;
						} else if (var0 == 3631) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new UserComparator3(var7));
							return 1;
						} else if (var0 == 3632) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new UserComparator4(var7));
							return 1;
						} else if (var0 == 3633) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new UserComparator5(var7));
							return 1;
						} else if (var0 == 3634) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new UserComparator6(var7));
							return 1;
						} else if (var0 == 3635) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new UserComparator7(var7));
							return 1;
						} else if (var0 == 3636) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new UserComparator8(var7));
							return 1;
						} else if (var0 == 3637) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new UserComparator9(var7));
							return 1;
						} else if (var0 == 3638) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new UserComparator10(var7));
							return 1;
						} else if (var0 == 3639) {
							DecorativeObject.friendSystem.friendsList.sort();
							return 1;
						} else if (var0 == 3640) {
							DecorativeObject.friendSystem.ignoreList.removeComparator();
							return 1;
						} else if (var0 == 3641) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.ignoreList.addComparator(new UserComparator1(var7));
							return 1;
						} else if (var0 == 3642) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.ignoreList.addComparator(new UserComparator2(var7));
							return 1;
						} else if (var0 == 3643) {
							DecorativeObject.friendSystem.ignoreList.sort();
							return 1;
						} else if (var0 == 3644) {
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.removeComparator();
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new UserComparator1(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new UserComparator2(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new UserComparator3(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new UserComparator4(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new UserComparator5(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new UserComparator6(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new UserComparator7(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new UserComparator8(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new UserComparator9(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new UserComparator10(var7));
							}

							return 1;
						} else if (var0 == 3655) {
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.sort();
							}

							return 1;
						} else if (var0 == 3656) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							DecorativeObject.friendSystem.friendsList.addComparator(new BuddyRankComparator(var7));
							return 1;
						} else if (var0 == 3657) {
							var7 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize] == 1;
							if (MenuAction.friendsChatManager != null) {
								MenuAction.friendsChatManager.addComparator(new BuddyRankComparator(var7));
							}
					...
					var3 = Interpreter.Interpreter_intStack[--class379.Interpreter_intStackSize];
					if (MenuAction.friendsChatManager != null && var3 < MenuAction.friendsChatManager.getSize() && ((FriendsChatMember)MenuAction.friendsChatManager.get(var3)).isIgnored()) {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class379.Interpreter_intStackSize - 1] = 0;
					}
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			class150.archive5 = Varps.method5683(0, false, true, true, false);
			MouseHandler.archive6 = Varps.method5683(1, false, true, true, false);
			class157.archive2 = Varps.method5683(2, true, false, true, false);
			PlayerType.archive7 = Varps.method5683(3, false, true, true, false);
			Canvas.archive4 = Varps.method5683(4, false, true, true, false);
			SecureRandomFuture.archive9 = Varps.method5683(5, true, true, true, false);
			ReflectionCheck.archive10 = Varps.method5683(6, true, true, true, false);
			WorldMapSectionType.archive11 = Varps.method5683(7, false, true, true, false);
			class142.archive8 = Varps.method5683(8, false, true, true, false);
			Client.field522 = Varps.method5683(9, false, true, true, false);
			WorldMapRegion.field2798 = Varps.method5683(10, false, true, true, false);
			class7.field32 = Varps.method5683(11, false, true, true, false);
			class188.archive12 = Varps.method5683(12, false, true, true, false);
			class143.archive13 = Varps.method5683(13, true, false, true, false);
			ChatChannel.archive14 = Varps.method5683(14, false, true, true, false);
			ClanChannel.archive15 = Varps.method5683(15, false, true, true, false);
			class382.field4449 = Varps.method5683(17, true, true, true, false);
			NetCache.archive18 = Varps.method5683(18, false, true, true, false);
			class310.archive19 = Varps.method5683(19, false, true, true, false);
			class139.archive20 = Varps.method5683(20, false, true, true, false);
			class250.field2930 = Varps.method5683(21, false, true, true, true);
			...
			var29 += MouseHandler.archive6.percentage() * 4 / 100;
			...
			var29 += ReflectionCheck.archive10.percentage() * 2 / 100;
			...
			var29 += WorldMapRegion.field2798.percentage() * 2 / 100;
			...
			var29 += class382.field4449.method6294() && class382.field4449.isFullyLoaded() ? 1 : 0;
			if (var29 != 100) {
				if (var29 != 0) {
				...
				WorldMapID.method5166(MouseHandler.archive6, "Skeletons");
				WorldMapID.method5166(Canvas.archive4, "Sound FX");
				WorldMapID.method5166(SecureRandomFuture.archive9, "Maps");
				WorldMapID.method5166(ReflectionCheck.archive10, "Music Tracks");
				...
				class174.field1857 = new GraphicsDefaults();
				class174.field1857.decode(class382.field4449);
			...
			FaceNormal.field2521 = new Decimator(22050, SoundCache.field337);
			...
			if (Client.titleLoadingStage == 60) {
				var30 = WorldMapRegion.field2798;
				...
				if (Client.titleLoadingStage == 80) {
					...
					if (BuddyRankComparator.compass == null) {
						BuddyRankComparator.compass = FriendsList.SpriteBuffer_getSprite(class142.archive8, class174.field1857.compass, 0);
					} else {
						++var29;
					}

					if (class150.redHintArrowSprite == null) {
						class150.redHintArrowSprite = FriendsList.SpriteBuffer_getSprite(class142.archive8, class174.field1857.field4536, 0);
					} else {
						++var29;
					}

					if (HealthBar.mapSceneSprites == null) {
						HealthBar.mapSceneSprites = class147.method3146(class142.archive8, class174.field1857.mapScenes, 0);
					} else {
						++var29;
					}

					if (Renderable.headIconPkSprites == null) {
						Renderable.headIconPkSprites = BufferedSource.method7532(class142.archive8, class174.field1857.headIconsPk, 0);
					} else {
						++var29;
					}

					if (class278.headIconPrayerSprites == null) {
						class278.headIconPrayerSprites = BufferedSource.method7532(class142.archive8, class174.field1857.field4538, 0);
					} else {
						++var29;
					}

					if (class162.headIconHintSprites == null) {
						class162.headIconHintSprites = BufferedSource.method7532(class142.archive8, class174.field1857.field4539, 0);
					} else {
						++var29;
					}

					if (WorldMapLabelSize.mapMarkerSprites == null) {
						WorldMapLabelSize.mapMarkerSprites = BufferedSource.method7532(class142.archive8, class174.field1857.field4540, 0);
					} else {
						++var29;
					}

					if (class199.crossSprites == null) {
						class199.crossSprites = BufferedSource.method7532(class142.archive8, class174.field1857.field4541, 0);
					} else {
						++var29;
					}

					if (Decimator.mapDotSprites == null) {
						Decimator.mapDotSprites = BufferedSource.method7532(class142.archive8, class174.field1857.field4542, 0);
					} else {
						++var29;
					}

					if (WorldMap.scrollBarSprites == null) {
						WorldMap.scrollBarSprites = class147.method3146(class142.archive8, class174.field1857.field4543, 0);
					} else {
						++var29;
					}

					if (UserComparator4.modIconSprites == null) {
						UserComparator4.modIconSprites = class147.method3146(class142.archive8, class174.field1857.field4544, 0);
					} else {
						++var29;
					}
					...
					if (!Client.field522.isFullyLoaded()) {
						...
						Rasterizer3D.method4153(class6.textureProvider);
						Rasterizer3D.method4154(BufferedSink.clientPreferences.method2392());
					...
					if (!WorldMapRegion.field2798.tryLoadFileByNames("huffman", "")) {
						Login.Login_loadingText = "Loading wordpack - " + 0 + "%";
						Login.Login_loadingPercent = 94;
					} else {
						Huffman var35 = new Huffman(WorldMapRegion.field2798.takeFileByNames("huffman", ""));
				...
				Archive var14 = MouseHandler.archive6;
				...
				class203.Ignored_cached = new class448(class376.field4411, 47, class103.clientLanguage, class157.archive2);
