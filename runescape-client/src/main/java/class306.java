		...
		if (var3 != 0) {
			...
			if (var3 == 1) {
				if (var2 == 1) {
					...
					class19.clientPreferences.method2255(0.9D);
				}
				...
				if (var2 == 2) {
					...
					Projectile.method1959();
					class19.clientPreferences.method2255(0.8D);
				}
				...
				if (var2 == 3) {
					...
					Projectile.method1959();
					class19.clientPreferences.method2255(0.7D);
				}
				...
				if (var2 == 4) {
					...
					Projectile.method1959();
					class19.clientPreferences.method2255(0.6D);
				}
			}
