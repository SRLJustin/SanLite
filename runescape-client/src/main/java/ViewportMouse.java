				...
				if (var14 == 1) {
					...
					if (var29.definition.size == 1 && (var29.x & 127) == 64 && (var29.y & 127) == 64) {
						...
						for (var33 = 0; var33 < var25; ++var33) {
							var20 = Client.players[var34[var33]];
				...
				if (var14 == 3) {
					...
					if (var32 != null) {
						for (TileItem var31 = (TileItem)var32.first(); var31 != null; var31 = (TileItem)var32.next()) {
							ItemComposition var35 = class258.ItemDefinition_get(var31.id);
							if (Client.isItemSelected == 1) {
								StructComposition.insertMenuItemNoShift("Use", Client.selectedItemName + " " + "->" + " " + class82.colorStartTag(16748608) + var35.name, 16, var31.id, var24, var13);
							} else if (Client.isSpellSelected) {
								if ((Coord.selectedSpellFlags & 1) == 1) {
									StructComposition.insertMenuItemNoShift(Client.selectedSpellActionName, Client.selectedSpellName + " " + "->" + " " + class82.colorStartTag(16748608) + var35.name, 17, var31.id, var24, var13);
								}
							} else {
								...
								for (int var28 = 4; var28 >= 0; --var28) {
									if (var27 != null && var27[var28] != null) {
										...
										StructComposition.insertMenuItemNoShift(var27[var28], class82.colorStartTag(16748608) + var35.name, var21, var31.id, var24, var13);
									} else if (var28 == 2) {
										StructComposition.insertMenuItemNoShift("Take", class82.colorStartTag(16748608) + var35.name, 20, var31.id, var24, var13);
									}
								}

								StructComposition.insertMenuItemNoShift("Examine", class82.colorStartTag(16748608) + var35.name, 1004, var31.id, var24, var13);
							}
						}
					}
				}
