...
public class ViewportMouse {
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			Varcs.archive5 = ModeWhere.method6081(0, false, true, true, false);
			WorldMapEvent.archive6 = ModeWhere.method6081(1, false, true, true, false);
			class140.archive2 = ModeWhere.method6081(2, true, false, true, false);
			class341.archive7 = ModeWhere.method6081(3, false, true, true, false);
			Client.archive4 = ModeWhere.method6081(4, false, true, true, false);
			WorldMapSectionType.archive9 = ModeWhere.method6081(5, true, true, true, false);
			class121.field1515 = ModeWhere.method6081(6, true, true, true, false);
			class10.archive11 = ModeWhere.method6081(7, false, true, true, false);
			class304.archive8 = ModeWhere.method6081(8, false, true, true, false);
			Language.field4098 = ModeWhere.method6081(9, false, true, true, false);
			ApproximateRouteStrategy.archive10 = ModeWhere.method6081(10, false, true, true, false);
			UserComparator7.field1383 = ModeWhere.method6081(11, false, true, true, false);
			class267.archive12 = ModeWhere.method6081(12, false, true, true, false);
			AbstractByteArrayCopier.archive13 = ModeWhere.method6081(13, true, false, true, false);
			WorldMapSprite.archive14 = ModeWhere.method6081(14, false, true, true, false);
			class67.archive15 = ModeWhere.method6081(15, false, true, true, false);
			class6.field20 = ModeWhere.method6081(17, true, true, true, false);
			AbstractUserComparator.archive18 = ModeWhere.method6081(18, false, true, true, false);
			MouseHandler.archive19 = ModeWhere.method6081(19, false, true, true, false);
			class4.archive20 = ModeWhere.method6081(20, false, true, true, false);
			class132.field1588 = ModeWhere.method6081(21, false, true, true, true);
			...
			if (Client.titleLoadingStage == 45) {
				...
				WorldMapRegion.field2722 = new Decimator(22050, PcmPlayer.field287);
				...
				if (Client.titleLoadingStage == 60) {
					...
					if (!class140.archive2.isFullyLoaded()) {
						...
						FloorUnderlayDefinition.field1990 = var24;
						...
						SoundCache.method762(class140.archive2, Varcs.archive5, WorldMapEvent.archive6);
						...
						ModeWhere.Ignored_cached = new class427(class285.field3313, 47, class134.clientLanguage, class140.archive2);
					...
					if (!Language.field4098.isFullyLoaded()) {
						...
						Rasterizer3D.method4061(class12.textureProvider);
			...
			var26 += WorldMapEvent.archive6.percentage() * 4 / 100;
			...
			var26 += class121.field1515.percentage() * 2 / 100;
			...
			var26 += class6.field20.method5795() && class6.field20.isFullyLoaded() ? 1 : 0;
			if (var26 != 100) {
				if (var26 != 0) {
				...
				HealthBarUpdate.method2202(WorldMapEvent.archive6, "Skeletons");
				HealthBarUpdate.method2202(Client.archive4, "Sound FX");
				HealthBarUpdate.method2202(WorldMapSectionType.archive9, "Maps");
				HealthBarUpdate.method2202(class121.field1515, "Music Tracks");
				...
				LoginScreenAnimation.field1221 = new GraphicsDefaults();
				LoginScreenAnimation.field1221.decode(class6.field20);
