...
public abstract class NameableContainer {
	...
	static final void method7728(int var0, int var1, int var2, int var3, int var4, int var5, Scene var6, CollisionMap var7) {
		if (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var1][var2] & 2) != 0 || (Tiles.Tiles_renderFlags[var0][var1][var2] & 16) == 0) {
			...
			if (var5 == 22) {
				...
				if (var5 >= 12) {
					...
					var6.newWallObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field1015[var4], 0, var19, var21);
					if (var4 == 0) {
						if (var8.clipped) {
					...
					var6.newWallObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field1016[var4], 0, var19, var21);
					if (var8.clipped) {
						if (var4 == 0) {
							Tiles.field1013[var0][var1][var2 + 1] = 50;
						} else if (var4 == 1) {
					...
					if (var5 == 2) {
						...
						var6.newWallObject(var0, var1, var2, var16, (Renderable)var31, (Renderable)var32, Tiles.field1015[var4], Tiles.field1015[var28], var19, var21);
						if (var8.modelClipped) {
							if (var4 == 0) {
								var10000 = class312.field3717[var0][var1];
								var10000[var2] |= 585;
						...
						var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field1015[var4], 0, 0, 0, var19, var21);
					} else {
						Object var25;
						long var29;
						if (var5 == 5) {
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, Tiles.field1015[var4], 0, var28 * Tiles.field1017[var4], var28 * Tiles.field1007[var4], var19, var21);
						} else if (var5 == 6) {
							var28 = 8;
							var29 = var6.getWallObjectTag(var0, var1, var2);
							if (0L != var29) {
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, 256, var4, var28 * Tiles.field1019[var4], var28 * Tiles.field1020[var4], var19, var21);
						} else if (var5 == 7) {
							var23 = var4 + 2 & 3;
							if (var8.animationId == -1 && var8.transforms == null) {
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)var26, 256, var4, var28 * Tiles.field1019[var4], var28 * Tiles.field1020[var4], var19, var21);
						}
					}
				}
			} else {
				...
				if (var34 != null && var6.method4466(var0, var1, var2, var16, var9, var10, (Renderable)var34, var5 == 11 ? 256 : 0, var19, var21) && var8.clipped) {
					...
					for (var24 = 0; var24 <= var9; ++var24) {
						for (int var33 = 0; var33 <= var10; ++var33) {
							if (var23 > Tiles.field1013[var0][var24 + var1][var33 + var2]) {
