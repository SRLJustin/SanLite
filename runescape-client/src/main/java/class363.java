			...
			if (class273.field3108 == var0) {
				...
				if (class273.field3111 == var0) {
					...
					if (var3 >= 0 && var4 >= 0 && var3 < 103 && var4 < 103) {
						if (var9 == 0) {
							WallObject var34 = class139.scene.method4293(ApproximateRouteStrategy.Client_plane, var3, var4);
							if (var34 != null) {
						...
						if (var9 == 1) {
							DecorativeObject var46 = class139.scene.method4294(ApproximateRouteStrategy.Client_plane, var3, var4);
							if (var46 != null) {
						...
						if (var9 == 3) {
							GroundObject var48 = class139.scene.getGroundObject(ApproximateRouteStrategy.Client_plane, var3, var4);
							if (var48 != null) {
