...
public final class class371 {
	...
	static final void method6674(int var0, int var1) {
		if (Client.hintArrowType == 2) {
			class148.worldToScreen(Client.hintArrowSubX * 64 + (Client.hintArrowX - Canvas.baseX * 64 << 7), Client.hintArrowSubY * 64 + (Client.hintArrowY - class118.baseY * 64 << 7), Client.hintArrowHeight * 2);
