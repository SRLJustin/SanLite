...
public class class37 {
	...
	static void playSong(int var0) {
		if (var0 == -1 && !Client.field638) {
			class283.midiPcmStream.clear();
			class283.musicPlayerStatus = 1;
			DevicePcmPlayerProvider.musicTrackArchive = null;
		} else if (var0 != -1 && var0 != Client.currentTrackGroupId && BufferedSink.clientPreferences.method2391() != 0 && !Client.field638) {
			Archive var1 = ReflectionCheck.archive10;
