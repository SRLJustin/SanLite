...
public final class Player extends Actor {
	...
	void updateIsInFriendsChat() {
		this.isInFriendsChat = class281.friendsChatManager != null && class281.friendsChatManager.contains(this.username) ? TriBool.TriBool_true : TriBool.TriBool_false;
	}
			...
			if (super.pathX[0] >= 0 && super.pathX[0] < 104 && super.pathY[0] >= 0 && super.pathY[0] < 104) {
				if (var3 == class204.field2357) {
					...
					if (var6 >= var8 && var6 < 104 - var8 && var7 >= var8 && var7 < 104 - var8 && var1 >= var8 && var1 < 104 - var8 && var2 >= var8 && var2 < 104 - var8) {
						int var9 = Clock.method3520(var6, var7, this.transformedSize(), GroundObject.method4298(var1, var2), Client.collisionMaps[this.plane], true, Client.field806, Client.field785);
						if (var9 >= 1) {
