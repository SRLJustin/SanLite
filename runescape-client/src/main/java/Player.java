...
public final class Player extends Actor {
		...
		if (this.appearance == null) {
			...
			if (var3 == null) {
				...
				if (!this.isUnanimated && super.spotAnimation != -1 && super.spotAnimationFrame != -1) {
					...
					if (var4 != null) {
						var4.offsetBy(0, -super.field1143, 0);
				...
				if (!this.isUnanimated && this.model0 != null) {
					...
					if (Client.cycle >= this.animationCycleStart && Client.cycle < this.animationCycleEnd) {
						var4 = this.model0;
						var4.offsetBy(this.field1095 * 4096 - super.x, this.tileHeight2 - this.tileHeight, this.field1108 * 4096 - super.y);
						...
						var4.offsetBy(super.x - this.field1095 * 4096, this.tileHeight - this.tileHeight2, super.y - this.field1108 * 4096);
					}
				}
	...
	void updateIsInFriendsChat() {
		this.isInFriendsChat = Huffman.friendsChatManager != null && Huffman.friendsChatManager.contains(this.username) ? TriBool.TriBool_true : TriBool.TriBool_false;
	}
