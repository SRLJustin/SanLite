	...
	static final void method2710(int var0) {
		...
		for (var5 = 0; var5 < 104; ++var5) {
			for (var6 = 0; var6 < 104; ++var6) {
				long var7 = WorldMapAreaData.scene.getGroundObjectTag(class103.Client_plane, var5, var6);
				if (0L != var7) {
					...
					if (var10 >= 0 && class4.WorldMapElement_get(var10).field1953) {
						...
						Client.field607[Client.mapIconCount] = var5;
						Client.field591[Client.mapIconCount] = var6;
						++Client.mapIconCount;
					}
				}
			}
