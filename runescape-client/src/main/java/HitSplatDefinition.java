	...
	public Font getFont() {
		if (this.fontId == -1) {
			...
			if (var1 != null) {
				...
				Font var2;
				if (!Ignored.SpriteBuffer_loadSpritesFromArchive(var3, var5, 0)) {
					var2 = null;
				} else {
		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
				...
				if (Login.loginIndex == 0) {
					...
					var23 = 291;
					class6.field18.drawAt(var4 - 73, var23 - 20);
					...
					IndexedSprite var26 = var9 ? (var10 ? DynamicObject.field979 : class228.field2759) : (var10 ? class113.field1427 : class345.field4157);
					...
					IndexedSprite var12 = var13 ? (var14 ? DynamicObject.field979 : class228.field2759) : (var14 ? class113.field1427 : class345.field4157);
					...
					short var16 = 321;
					class6.field18.drawAt(var15 - 73, var16 - 20);
					...
					if (Login.loginIndex == 4) {
						...
						IndexedSprite var34;
						if (Login.field895) {
							var34 = class228.field2759;
						} else {
							var34 = class345.field4157;
						}
						...
						var8 = 321;
						class6.field18.drawAt(var7 - 73, var8 - 20);
						...
						short var36 = 321;
						class6.field18.drawAt(var25 - 73, var36 - 20);
						...
						if (VarpDefinition.field1821 && !Client.onMobile) {
							...
							for (var45 = 0; var45 < 8; ++var45) {
								class6.field18.method8135(var4, var32, 30, 40);
							...
							short var48 = 321;
							class6.field18.drawAt(var45 - 73, var48 - 20);
						...
						var33 = 311;
						class6.field18.drawAt(var32 - 73, var33 - 20);
						...
						var4 = Login.loginBoxX + 180;
						var31 = 311;
						class6.field18.drawAt(var4 - 73, var31 - 20);
			...
			class145.field1674[class19.clientPreferences.method2317() ? 1 : 0].drawAt(Login.xPadding + 765 - 40, 463);
