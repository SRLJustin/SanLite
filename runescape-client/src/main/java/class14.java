	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) {
			if (var2) {
				...
				Players.Players_regions[var1] = (var4.plane << 28) + (WorldMapLabelSize.baseY * 64 + var4.pathY[0] >> 13) + (class28.baseX * 64 + var4.pathX[0] >> 13 << 14);
				if (var4.field1165 != -1) {
			...
			if (var3 == 1) {
				...
				if (var5 == 0) {
					...
					var8 = var6 >> 14 & 16383;
					var9 = var6 & 16383;
					var10 = (class28.baseX * 64 + var8 + var4.pathX[0] & 16383) - class28.baseX * 64;
					var11 = (WorldMapLabelSize.baseY * 64 + var9 + var4.pathY[0] & 16383) - WorldMapLabelSize.baseY * 64;
					if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) {
						var4.resetPath(var10, var11);
						var4.field1088 = false;
					} else if (var2) {
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
									...
									if (var10.type == 4) {
										...
										SpritePixels var40;
										if (!var10.isIf3) {
											var40 = var10.method5608(ObjectSound.runCs1(var10), class138.urlRequester);
											if (var40 != null) {
											...
											if (var10.itemId != -1) {
												...
												var40 = var10.method5608(false, class138.urlRequester);
											}
