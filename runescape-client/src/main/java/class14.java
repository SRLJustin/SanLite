...
public class class14 {
	...
	static int method170(int var0, Script var1, boolean var2) {
		...
		if (var0 >= 2000) {
			var0 -= 1000;
			var3 = HitSplatDefinition.getWidget(Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]);
		} else {
		...
		if (var0 != ScriptOpcodes.CC_SETOBJECT && var0 != ScriptOpcodes.CC_SETOBJECT_NONUM && var0 != ScriptOpcodes.CC_SETOBJECT_ALWAYS_NUM) {
			...
			int var5 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1];
			var3.itemId = var4;
	...
	static final void method174(int var0, int var1, int var2, int var3, int var4, int var5, int var6, Scene var7, CollisionMap var8) {
		...
		long var20 = GroundObject.calculateTag(var2, var3, 2, var9.int1 == 0, var4);
		...
		if (var6 == 22) {
			...
			if (var6 >= 12) {
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field977[var5], 0, var20, var22);
				if (var9.interactType != 0) {
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field978[var5], 0, var20, var22);
				if (var9.interactType != 0) {
					var8.method3795(var2, var3, var6, var5, var9.boolean1);
				}
				...
				if (var6 == 2) {
					...
					var7.newWallObject(var0, var2, var3, var17, (Renderable)var31, (Renderable)var25, Tiles.field977[var5], Tiles.field977[var23], var20, var22);
					if (var9.interactType != 0) {
						var8.method3795(var2, var3, var6, var5, var9.boolean1);
					}
					...
					var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field977[var5], 0, 0, 0, var20, var22);
				} else {
					long var24;
					Object var26;
					if (var6 == 5) {
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, Tiles.field977[var5], 0, var23 * Tiles.field979[var5], var23 * Tiles.field982[var5], var20, var22);
					} else if (var6 == 6) {
						var23 = 8;
						var24 = var7.getWallObjectTag(var0, var2, var3);
						if (var24 != 0L) {
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, 256, var5, var23 * Tiles.field981[var5], var23 * Tiles.field970[var5], var20, var22);
					} else if (var6 == 7) {
						int var29 = var5 + 2 & 3;
						if (var9.animationId == -1 && var9.transforms == null) {
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)var27, 256, var5, var23 * Tiles.field981[var5], var23 * Tiles.field970[var5], var20, var22);
					}
				}
			}
		} else {
	...
	static int method179(int var0, Script var1, boolean var2) {
		Widget var3 = HitSplatDefinition.getWidget(Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize]);
