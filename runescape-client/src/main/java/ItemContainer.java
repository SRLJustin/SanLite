			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					if (class13.friendsChatManager != null) {
						Interpreter.Interpreter_stringStack[++GrandExchangeOfferAgeComparator.Interpreter_stringStackSize - 1] = class13.friendsChatManager.name;
					} else {
						Interpreter.Interpreter_stringStack[++GrandExchangeOfferAgeComparator.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (class13.friendsChatManager != null) {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = class13.friendsChatManager.getSize();
					} else {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize];
					if (class13.friendsChatManager != null && var3 < class13.friendsChatManager.getSize()) {
						Interpreter.Interpreter_stringStack[++GrandExchangeOfferAgeComparator.Interpreter_stringStackSize - 1] = class13.friendsChatManager.get(var3).getUsername().getName();
					} else {
						Interpreter.Interpreter_stringStack[++GrandExchangeOfferAgeComparator.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize];
					if (class13.friendsChatManager != null && var3 < class13.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = ((Buddy)class13.friendsChatManager.get(var3)).getWorld();
					} else {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize];
					if (class13.friendsChatManager != null && var3 < class13.friendsChatManager.getSize()) {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = ((Buddy)class13.friendsChatManager.get(var3)).rank;
					} else {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = 0;
					}
					...
					Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = class13.friendsChatManager != null ? class13.friendsChatManager.minKick : 0;
					return 1;
					...
					Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = class13.friendsChatManager != null ? class13.friendsChatManager.rank : 0;
					return 1;
					...
					var3 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize];
					if (class13.friendsChatManager != null && var3 < class13.friendsChatManager.getSize() && class13.friendsChatManager.get(var3).getUsername().equals(class28.localPlayer.username)) {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (class13.friendsChatManager != null && class13.friendsChatManager.owner != null) {
						Interpreter.Interpreter_stringStack[++GrandExchangeOfferAgeComparator.Interpreter_stringStackSize - 1] = class13.friendsChatManager.owner;
					} else {
						Interpreter.Interpreter_stringStack[++GrandExchangeOfferAgeComparator.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize];
					if (class13.friendsChatManager != null && var3 < class13.friendsChatManager.getSize() && ((FriendsChatMember)class13.friendsChatManager.get(var3)).isFriend()) {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (var0 == 3628) {
						...
						if (var0 == 3629) {
							...
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.removeComparator();
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new UserComparator1(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new UserComparator2(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new UserComparator3(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new UserComparator4(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new UserComparator5(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new UserComparator6(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new UserComparator7(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new UserComparator8(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new UserComparator9(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new UserComparator10(var7));
							}
							...
							var7 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize] == 1;
							if (class13.friendsChatManager != null) {
								class13.friendsChatManager.addComparator(new BuddyRankComparator(var7));
							}
					...
					var3 = Interpreter.Interpreter_intStack[--TaskHandler.Interpreter_intStackSize];
					if (class13.friendsChatManager != null && var3 < class13.friendsChatManager.getSize() && ((FriendsChatMember)class13.friendsChatManager.get(var3)).isIgnored()) {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++TaskHandler.Interpreter_intStackSize - 1] = 0;
					}
