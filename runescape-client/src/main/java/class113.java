...
public class class113 {
	...
	class113() {
		this.field1423 = Float.MAX_VALUE;
		this.field1424 = Float.MAX_VALUE;
		this.field1425 = Float.MAX_VALUE;
		this.field1426 = Float.MAX_VALUE;
	}
	...
	void method2621(Buffer var1, int var2) {
		this.field1430 = var1.readShort();
		this.field1428 = var1.method7570();
		this.field1423 = var1.method7570();
		this.field1424 = var1.method7570();
		this.field1425 = var1.method7570();
		this.field1426 = var1.method7570();
	}
	...
	public static final synchronized long method2624() {
		...
		if (var0 < class269.field3215) {
			class269.field3217 += class269.field3215 - var0;
		}

		class269.field3215 = var0;
		return class269.field3217 + var0;
	}
	...
	public static void method2625(String[] var0, int[] var1) {
		InterfaceParent.method2072(var0, var1, 0, var0.length - 1);
	}
	...
	static void method2623(class117 var0, float[] var1, float[] var2) {
		if (var0 != null) {
			...
			var0.field1473[0] = (var9 + var10 - var4 - var4) * var8 / var3;
			var0.field1473[1] = (var4 + var4 + var4 - var9 - var9 - var10) * var8;
			var0.field1473[2] = var6;
			var0.field1473[3] = var2[0];
		}
	}
}
