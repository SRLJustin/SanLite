...
public class Rasterizer2D extends DualNode {
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method7838(var0, var1, var2, var4);
		method7838(var0, var3 + var1 - 1, var2, var4);
		method7840(var0, var1, var3, var4);
		method7840(var0 + var2 - 1, var1, var3, var4);
	}
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) {
			if (var2 >= 0) {
				...
				method7838(var0 + var2, var1, -var2 + 1, var4);
			}
			...
			if (var3 >= 0) {
				...
				method7840(var0, var3 + var1, -var3 + 1, var4);
			}
