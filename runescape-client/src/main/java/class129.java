...
public class class129 implements class119 {
	...
	static void method3086(AbstractArchive var0, AbstractArchive var1, boolean var2, int var3) {
		if (Login.clearLoginScreen) {
			...
			Login.field906 = VarcInt.SpriteBuffer_getIndexedSpriteByName(var1, "titlebutton", "");
			...
			Login.field905 = class125.method3066(var1, "runes", "");
			Login.field908 = class125.method3066(var1, "title_mute", "");
			Login.field932 = VarcInt.SpriteBuffer_getIndexedSpriteByName(var1, "options_radio_buttons,0", "");
			ChatChannel.field1005 = VarcInt.SpriteBuffer_getIndexedSpriteByName(var1, "options_radio_buttons,4", "");
			Login.field910 = VarcInt.SpriteBuffer_getIndexedSpriteByName(var1, "options_radio_buttons,2", "");
			class100.field1335 = VarcInt.SpriteBuffer_getIndexedSpriteByName(var1, "options_radio_buttons,6", "");
			WorldMapRectangle.field2963 = Login.field932.subWidth;
			class134.field1613 = Login.field932.subHeight * -517064944;
			class305.loginScreenRunesAnimation = new LoginScreenAnimation(Login.field905);
			if (var2) {
			...
			if (!PacketWriter.clientPreferences.method2570()) {
				WorldMapScaleHandler.method5467(2, class153.archive11, "scape main", "", 255, false);
			} else {
