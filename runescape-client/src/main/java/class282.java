...
public class class282 {
	...
	static void method5426(SequenceDefinition var0, int var1, int var2, int var3) {
		if (Client.soundEffectCount < 50 && FriendsChatMember.clientPreferences.method2226() != 0) {
				...
				if (var3.type == 6) {
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
						...
						if (var5 != -1) {
							...
							if (!var6.method3725()) {
								for (var3.modelFrameCycle += Client.field599; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; class125.method2770(var3)) {
