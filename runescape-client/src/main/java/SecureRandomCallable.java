...
public class SecureRandomCallable implements Callable {
	...
	static final void method2125() {
		for (int var0 = 0; var0 < Client.soundEffectCount; ++var0) {
			...
			if (Client.queuedSoundEffectDelays[var0] >= -10) {
				...
				if (Client.queuedSoundEffectDelays[var0] < 0) {
					...
					if (var2 > 0) {
						RawSound var9 = var1.toRawSound().resample(Tiles.field1010);
		...
		if (Client.field737 && !Varcs.method2546()) {
			if (class260.clientPreferences.method2335() != 0 && Client.currentTrackGroupId != -1) {
				FriendsChatManager.method6678(MouseHandler.field244, Client.currentTrackGroupId, 0, class260.clientPreferences.method2335(), false);
			}
