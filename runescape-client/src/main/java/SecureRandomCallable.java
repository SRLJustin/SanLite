...
public class SecureRandomCallable implements Callable {
	...
	static int method2026(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.WORLDLIST_FETCH) {
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = class4.loadWorlds() ? 1 : 0;
			return 1;
		} else {
			World var9;
			if (var0 == ScriptOpcodes.WORLDLIST_START) {
				...
				if (var9 != null) {
					Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var9.id;
					Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var9.properties;
					Interpreter.Interpreter_stringStack[++UserComparator8.Interpreter_stringStackSize - 1] = var9.activity;
					Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var9.location;
					Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var9.population;
				...
				if (var0 == ScriptOpcodes.WORLDLIST_SPECIFIC) {
					...
					if (var7 != null) {
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var7.id;
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var7.properties;
						Interpreter.Interpreter_stringStack[++UserComparator8.Interpreter_stringStackSize - 1] = var7.activity;
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var7.location;
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var7.population;
					...
					var3 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize];
					boolean var10 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1] == 1;
					var8 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 2];
					boolean var6 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 3] == 1;
					InterfaceParent.sortWorldList(var3, var10, var8, var6);
					return 1;
				} else if (var0 != 6511) {
					if (var0 == ScriptOpcodes.SETFOLLOWEROPSLOWPRIORITY) {
						Client.followerOpsLowPriority = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
						return 1;
					} else {
						int var4;
						...
						if (var0 == ScriptOpcodes.NC_PARAM) {
							...
							if (var5.isString()) {
								...
								Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = class119.getNpcDefinition(var3).getIntParam(var4, var5.defaultInt);
							}
							...
							if (var5.isString()) {
								...
								Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = FileSystem.getObjectDefinition(var3).getIntParam(var4, var5.defaultInt);
							}
							...
							if (var5.isString()) {
								...
								Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = AttackOption.ItemDefinition_get(var3).getIntParam(var4, var5.defaultInt);
							}
							...
							if (var5.isString()) {
								...
								Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = class388.StructDefinition_getStructDefinition(var3).getIntParam(var4, var5.defaultInt);
							}

							return 1;
						} else if (var0 == ScriptOpcodes.ON_MOBILE) {
							Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.onMobile ? 1 : 0;
							return 1;
						} else if (var0 == ScriptOpcodes.CLIENTTYPE) {
							Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.clientType;
							return 1;
						} else if (var0 == 6520) {
							return 1;
							...
							Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.field482;
							return 1;
						} else {
							return 2;
						}
