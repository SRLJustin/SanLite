...
public class FontName {
	...
	static final void method8315(Scene var0, CollisionMap[] var1) {
			...
			for (var3 = 0; var3 < 104; ++var3) {
				for (var4 = 0; var4 < 104; ++var4) {
					if ((Tiles.Tiles_renderFlags[var2][var3][var4] & 1) == 1) {
						...
						if (var5 >= 0) {
							var1[var5].method4202(var3, var4);
						}
					}
				}
			}
		...
		int var18;
		for (var2 = 0; var2 < 4; ++var2) {
			byte[][] var45 = Tiles.field1013[var2];
			boolean var52 = true;
			boolean var53 = true;
			boolean var6 = true;
			boolean var7 = true;
			...
			for (var11 = 0; var11 < 104; ++var11) {
				class100.field1332[var11] = 0;
				class161.field1805[var11] = 0;
				Tiles.field1024[var11] = 0;
				class463.field4906[var11] = 0;
			...
			for (var11 = -5; var11 < 109; ++var11) {
				for (var12 = 0; var12 < 104; ++var12) {
					...
					if (var13 >= 0 && var13 < 104) {
						...
						var15 = Tiles.field1010[var2][var13][var12] & var14;
						if (var15 > 0) {
							FloorUnderlayDefinition var50 = DefaultsGroup.method7840(var15 - 1);
							var10000 = class100.field1332;
							var10000[var12] += var50.hue;
							var10000 = class161.field1805;
							var10000[var12] += var50.saturation;
							var10000 = Tiles.field1024;
							var10000[var12] += var50.lightness;
							var10000 = class463.field4906;
					...
					if (var14 >= 0 && var14 < 104) {
						...
						var16 = Tiles.field1010[var2][var14][var12] & var15;
						if (var16 > 0) {
				...
				if (var11 >= 1 && var11 < 103) {
					...
					for (var17 = -5; var17 < 109; ++var17) {
						...
						if (var18 >= 0 && var18 < 104) {
							var12 += class100.field1332[var18];
							var13 += class161.field1805[var18];
							var14 += Tiles.field1024[var18];
							var15 += class463.field4906[var18];
							var16 += SceneTilePaint.field2764[var18];
						}

						var19 = var17 - 5;
						if (var19 >= 0 && var19 < 104) {
							var12 -= class100.field1332[var19];
							var13 -= class161.field1805[var19];
							var14 -= Tiles.field1024[var19];
							var15 -= class463.field4906[var19];
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							int var21 = Tiles.field1010[var2][var11][var17] & var20;
							int var22 = class172.field1865[var2][var11][var17] & var20;
							if (var21 > 0 || var22 > 0) {
								...
								if (var21 > 0) {
									...
									var34 = var13 / var16;
									var35 = var14 / var16;
									var31 = class139.method3151(var33, var34, var35);
									...
									var32 = class139.method3151(var33, var34, var35);
								}

								FloorOverlayDefinition var36;
								if (var2 > 0) {
									boolean var58 = true;
									if (var21 == 0 && Tiles.field1011[var2][var11][var17] != 0) {
										var58 = false;
									}
								...
								if (var22 == 0) {
									...
									var34 = Tiles.field1011[var2][var11][var17] + 1;
									...
									if (var49 >= 0) {
										...
										var40 = class139.method3151(var36.hue, var36.saturation, var36.lightness);
										...
										var41 = class139.method3151(var42, var36.saturation, var43);
									}
									...
									if (var36.secondaryRgb != -1) {
										...
										var41 = class139.method3151(var43, var36.secondarySaturation, var44);
										var42 = Rasterizer3D.Rasterizer3D_colorPalette[FloorUnderlayDefinition.method3806(var41, 96)];
									}
			...
			Tiles.field1010[var2] = null;
			class172.field1865[var2] = null;
			Tiles.field1011[var2] = null;
			Tiles.field1012[var2] = null;
			Tiles.field1013[var2] = null;
		}
	...
	static final void FriendSystem_invalidateIgnoreds() {
		...
		if (class463.friendsChatManager != null) {
			class463.friendsChatManager.invalidateIgnoreds();
		}
