		...
		if (!Client.isInInstance) {
			...
			for (var5 = (var3 - 6) / 8; var5 <= (var3 + 6) / 8; ++var5) {
				for (var6 = (var2 - 6) / 8; var6 <= (var2 + 6) / 8; ++var6) {
					...
					Renderable.regionMapArchiveIds[var4] = NetCache.archive10.getGroupId("m" + var5 + "_" + var6);
					class217.regionLandArchiveIds[var4] = NetCache.archive10.getGroupId("l" + var5 + "_" + var6);
					++var4;
				}
			}

			KeyHandler.method432(var3, var2, true);
		} else {
			var2 = var1.method8714();
			...
			for (var6 = 0; var6 < 4; ++var6) {
				for (var7 = 0; var7 < 13; ++var7) {
					for (var8 = 0; var8 < 13; ++var8) {
						...
						if (var9 == 1) {
							Client.field770[var6][var7][var8] = var1.readBits(26);
						} else {
							Client.field770[var6][var7][var8] = -1;
						}
					}
				}
			}
			...
			for (var6 = 0; var6 < 4; ++var6) {
				for (var7 = 0; var7 < 13; ++var7) {
					for (var8 = 0; var8 < 13; ++var8) {
						var9 = Client.field770[var6][var7][var8];
						if (var9 != -1) {
							...
							if (var12 != -1) {
								...
								var13 = var12 >> 8 & 255;
								int var14 = var12 & 255;
								Renderable.regionMapArchiveIds[var5] = NetCache.archive10.getGroupId("m" + var13 + "_" + var14);
								class217.regionLandArchiveIds[var5] = NetCache.archive10.getGroupId("l" + var13 + "_" + var14);
								++var5;
							}
						}
					}
			...
			KeyHandler.method432(var4, var2, !var15);
		}
