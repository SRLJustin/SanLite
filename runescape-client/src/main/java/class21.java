...
public class class21 {
	...
	static final void method297(PacketBuffer var0) {
		for (int var1 = 0; var1 < Players.Players_pendingUpdateCount; ++var1) {
			...
			if ((var4 & 128) != 0) {
				var6 = var0.method8484();
				PlayerType var18 = (PlayerType)DecorativeObject.findEnumerated(class303.PlayerType_values(), var0.method8435());
				boolean var20 = var0.method8623() == 1;
				var9 = var0.method8436();
				var10 = var0.offset;
				if (var3.username != null && var3.appearance != null) {
					boolean var19 = false;
					if (var18.isUser && DecorativeObject.friendSystem.isIgnored(var3.username)) {
						var19 = true;
					}
			...
			if ((var4 & 1024) != 0) {
				Players.field1314[var2] = (class202)DecorativeObject.findEnumerated(BufferedSink.method7548(), var0.method8440());
			}
		...
		if (var0 != Client.gameState) {
			...
			if (var0 != 5 && var0 != 10) {
				if (var0 == 20) {
					...
					NameableContainer.method7441(WorldMapRegion.field2798, class142.archive8, false, var3);
				} else if (var0 == 11) {
					NameableContainer.method7441(WorldMapRegion.field2798, class142.archive8, false, 4);
				} else if (var0 == 50) {
					MusicPatchNode2.setLoginResponseString("", "Updating date of birth...", "");
					NameableContainer.method7441(WorldMapRegion.field2798, class142.archive8, false, 7);
				} else {
				...
				int var2 = var1 ? 0 : 12;
				NameableContainer.method7441(WorldMapRegion.field2798, class142.archive8, true, var2);
			}
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) {
			Skeleton.worldToScreen(Client.field723 * 64 + (Client.field512 - class26.baseX * 64 << 7), (Client.field513 - class158.baseY * 64 << 7) + Client.field541 * 4096, Client.field770 * 4);
