...
public class class21 {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) {
			Skeleton.worldToScreen(Client.field723 * 64 + (Client.field512 - class26.baseX * 64 << 7), (Client.field513 - class158.baseY * 64 << 7) + Client.field541 * 4096, Client.field770 * 2);
