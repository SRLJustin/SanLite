	...
	static void method5896(Font var0, Font var1) {
		...
		if (class388.worldSelectBackSprites != null) {
			...
			if (class17.worldSelectLeftSprite != null && Login.worldSelectPage > 0) {
				class17.worldSelectLeftSprite.drawAt(8, DecorativeObject.canvasHeight / 2 - class17.worldSelectLeftSprite.subHeight / 2);
			}

			if (class14.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) {
				class14.worldSelectRightSprite.drawAt(class7.canvasWidth - class14.worldSelectRightSprite.subWidth - 8, DecorativeObject.canvasHeight / 2 - class14.worldSelectRightSprite.subHeight / 2);
			}
