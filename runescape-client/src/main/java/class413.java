	...
	static int method7863(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				var14.packetBuffer.method8536(var16);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var3 = Interpreter.Interpreter_intStack[class87.Interpreter_intStackSize];
						var16 = Interpreter.Interpreter_intStack[class87.Interpreter_intStackSize + 1];
						Widget var13 = var2 ? class190.scriptDotWidget : class360.field4354;
						...
						Client.field791 = 3;
						Client.field683 = var2 ? class190.scriptDotWidget.id : class360.field4354.id;
						return 1;
					} else {
						boolean var10;
						if (var0 == ScriptOpcodes.SETHIDEUSERNAME) {
							...
							if (var4.method4020()) {
								Login.method2096(var4.field2282);
							}
