...
public class class273 {
	...
	static int method5374(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				var14.packetBuffer.method8523(var16);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var3 = Interpreter.Interpreter_intStack[class379.Interpreter_intStackSize];
						var16 = Interpreter.Interpreter_intStack[class379.Interpreter_intStackSize + 1];
						Widget var13 = var2 ? class140.scriptDotWidget : class136.field1589;
						...
						Client.field668 = 3;
						Client.field755 = var2 ? class140.scriptDotWidget.id : class136.field1589.id;
						return 1;
					} else {
						boolean var10;
						if (var0 == ScriptOpcodes.SETHIDEUSERNAME) {
							...
							if (var4.method3886()) {
								ObjectComposition.method3734(var4.field2213);
							}
	...
	static void method5375(int var0, int var1, int var2) {
