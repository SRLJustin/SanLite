...
public class PlayerComposition {
	...
	public void changeAppearance(int var1, boolean var2) {
		if (var1 != 1 || this.field3491 != 1) {
			...
			if (var3 != 0) {
				...
				} while(var4 == null || var4.nonSelectable || var4.bodypartID != var1 + (this.field3491 == 1 ? 7 : 0));
	...
	void setHash() {
		...
		this.hash <<= 1;
		this.hash += -1359876681L * (long)(this.field3491 * 1135706119);
	...
	public Model getModel(SequenceDefinition var1, int var2, SequenceDefinition var3, int var4) {
		if (this.npcTransformId != -1) {
			return class137.getNpcDefinition(this.npcTransformId).method3723(var1, var2, var3, var4, (class189)null);
		} else {
			long var5 = this.hash;
			...
			if (var18 == null) {
				...
				for (int var10 = 0; var10 < 12; ++var10) {
					...
					if (var11 >= 512 && !TileItem.ItemDefinition_get(var11 - 512).method3969(this.field3491)) {
						var9 = true;
					}
				}
				...
				if (var9) {
					if (-1L != this.field3490) {
						var18 = (Model)Widget_cachedSpriteMasks.get(this.field3490);
					}
				...
				if (var18 == null) {
					...
					for (int var12 = 0; var12 < 12; ++var12) {
						...
						if (var13 >= 512) {
							...
							ModelData var15 = var22.method3959(this.field3491);
							if (var15 != null) {
								if (this.field3488 != null) {
									class179 var16 = this.field3488[var12];
									if (var16 != null) {
										int var17;
										if (var16.field1913 != null && var22.recolorFrom != null && var22.recolorTo.length == var16.field1913.length) {
											for (var17 = 0; var17 < var22.recolorFrom.length; ++var17) {
												var15.recolor(var22.recolorTo[var17], var16.field1913[var17]);
											}
										}

										if (var16.field1914 != null && var22.retextureFrom != null && var16.field1914.length == var22.retextureTo.length) {
					...
					Widget_cachedSpriteMasks.put(var18, var5);
					this.field3490 = var5;
				}
			}
	...
	ModelData getModelData() {
		if (this.npcTransformId != -1) {
			return class137.getNpcDefinition(this.npcTransformId).method3750((class189)null);
		} else {
			boolean var1 = false;
			...
			for (int var2 = 0; var2 < 12; ++var2) {
				...
				if (var3 >= 512 && !TileItem.ItemDefinition_get(var3 - 512).method3960(this.field3491)) {
					var1 = true;
				}
			}
			...
			if (var1) {
				...
				for (int var4 = 0; var4 < 12; ++var4) {
					...
					if (var5 >= 512) {
						var6 = TileItem.ItemDefinition_get(var5 - 512).method3961(this.field3491);
						if (var6 != null) {
							var7[var3++] = var6;
						}
					}
