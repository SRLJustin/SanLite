...
public class class27 {
	...
	public class27() {
		this.field162 = new int[112];
		this.field161 = new int[192];
			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
				...
				if (!var10.isIf3 || !class160.isComponentHidden(var10)) {
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						...
						if (var10.type == 0) {
							if (!var10.isIf3 && class160.isComponentHidden(var10) && var10 != class25.mousedOverWidgetIf1) {
								continue;
							}
							...
							if (class160.isComponentHidden(var10) && var10 != class25.mousedOverWidgetIf1) {
								continue;
							}
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
											...
											if (var10.itemIds[var19] <= 0) {
												if (var10.inventorySprites != null && var19 < 20) {
													...
													if (var52 != null) {
														...
														LoginScreenAnimation.method2477(var10);
													}
												}
											} else {
												boolean var40 = false;
														...
														if (var10 == WorldMapLabelSize.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
															...
															if (var1 != -1) {
																...
																if (var23 + var25 < Rasterizer2D.Rasterizer2D_yClipStart && var28.scrollY > 0) {
																	var29 = (Rasterizer2D.Rasterizer2D_yClipStart - var23 - var25) * Client.field574 / 3;
																	if (var29 > Client.field574 * 10) {
																	...
																	LoginScreenAnimation.method2477(var28);
																}

																if (var23 + var25 + 32 > Rasterizer2D.Rasterizer2D_yClipEnd && var28.scrollY < var28.scrollHeight - var28.height) {
																	var29 = (var23 + var25 + 32 - Rasterizer2D.Rasterizer2D_yClipEnd) * Client.field574 / 3;
																	if (var29 > Client.field574 * 10) {
																		var29 = Client.field574 * 10;
																	}
									...
									if (UserComparator5.runCs1(var10)) {
										var19 = var10.color2;
										if (var10 == class25.mousedOverWidgetIf1 && var10.mouseOverColor2 != 0) {
											var19 = var10.mouseOverColor2;
										}
									} else {
										var19 = var10.color;
										if (var10 == class25.mousedOverWidgetIf1 && var10.mouseOverColor != 0) {
									...
									if (var10.type == 4) {
										...
										SpritePixels var44;
										if (!var10.isIf3) {
											var44 = var10.method6196(UserComparator5.runCs1(var10), class245.urlRequester);
											if (var44 != null) {
											...
											if (var10.itemId != -1) {
												...
												var44 = var10.method6196(false, class245.urlRequester);
											}
										...
										if (var10.type == 6) {
											...
											if (var10.itemId != -1) {
												...
												var45 = var10.method6206(var37, var26, var39, class387.localPlayer.appearance, var50, var51);
											...
											if (var10.type == 8 && var10 == class18.field102 && Client.field666 == Client.field665) {
												...
												String var47;
												for (var32 = GroundObject.method4312(var32, var10); var32.length() > 0; var20 = var20 + var31.ascent + 1) {
												...
												for (var32 = GroundObject.method4312(var32, var10); var32.length() > 0; var26 = var26 + var31.ascent + 1) {
