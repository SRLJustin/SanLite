...
public class class1 implements Callable {
	...
	static void playSong(int var0) {
		if (var0 == -1 && !Client.field737) {
			LoginPacket.method5207();
		} else if (var0 != -1 && var0 != Client.currentTrackGroupId && class260.clientPreferences.method2335() != 0 && !Client.field737) {
			Archive var1 = MouseHandler.field244;
