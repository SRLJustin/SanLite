...
public enum class83 implements MouseWheel {
	...
	static void savePreferences() {
		...
		try {
			...
			Buffer var1 = FriendsChatMember.clientPreferences.toBuffer();
	...
	static final void method2089() {
		if (DirectByteArrayCopier.FriendsChatManager_inFriendsChat) {
			if (class19.friendsChatManager != null) {
				class19.friendsChatManager.sort();
			}

			FriendSystem.method1670();
			DirectByteArrayCopier.FriendsChatManager_inFriendsChat = false;
		}
