			...
			if (class264.field3049 == var0) {
				...
				if (class264.field3051 == var0) {
					...
					if (var7 >= 0 && var38 >= 0 && var7 < 103 && var38 < 103) {
						if (var5 == 0) {
							WallObject var33 = MusicPatchNode.scene.method4281(Tiles.Client_plane, var7, var38);
							if (var33 != null) {
						...
						if (var5 == 1) {
							DecorativeObject var44 = MusicPatchNode.scene.method4282(Tiles.Client_plane, var7, var38);
							if (var44 != null) {
						...
						if (var5 == 3) {
							GroundObject var46 = MusicPatchNode.scene.getGroundObject(Tiles.Client_plane, var7, var38);
							if (var46 != null) {
