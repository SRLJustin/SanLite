...
public class Skills {
	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
			...
			if (0L != var7) {
				...
				if (var1 == 0) {
					WorldMapAreaData.scene.removeWallObject(var0, var2, var3);
				...
				if (var1 == 3) {
					WorldMapAreaData.scene.removeGroundObject(var0, var2, var3);
					var13 = class463.getObjectDefinition(var14);
	...
	static void method6427(int var0, int var1) {
		...
		if (var2 != null) {
			FileSystem.method3505(var2.param0, var2.param1, var2.opcode, var2.identifier, var2.field890, var2.field893, var2.field892, var0, var1);
		}
