		...
		if (class263.field3031 == var0) {
			...
			if (class263.field3032 == var0) {
				...
				if (var5 >= 0 && var37 >= 0 && var5 < 104 && var37 < 104) {
					var10 = var39 + 1;
					if (ScriptFrame.localPlayer.pathX[0] >= var5 - var10 && ScriptFrame.localPlayer.pathX[0] <= var10 + var5 && ScriptFrame.localPlayer.pathY[0] >= var37 - var10 && ScriptFrame.localPlayer.pathY[0] <= var10 + var37 && FriendsChatMember.clientPreferences.method2226() != 0 && var9 > 0 && Client.soundEffectCount < 50) {
			...
			if (class263.field3027 == var0) {
				...
				if (class263.field3028 == var0) {
					...
					if (var38 >= 0 && var39 >= 0 && var38 < 103 && var39 < 103) {
						if (var5 == 0) {
							WallObject var31 = class12.scene.method4073(class268.Client_plane, var38, var39);
							if (var31 != null) {
						...
						if (var5 == 1) {
							DecorativeObject var42 = class12.scene.method4113(class268.Client_plane, var38, var39);
							if (var42 != null) {
						...
						if (var5 == 3) {
							GroundObject var44 = class12.scene.getGroundObject(class268.Client_plane, var38, var39);
							if (var44 != null) {
