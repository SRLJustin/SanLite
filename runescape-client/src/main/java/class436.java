...
public class class436 extends DualNode {
	...
	static int method7535(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.STOCKMARKET_GETOFFERTYPE) {
			...
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.grandExchangeOffers[var3].type();
			return 1;
		} else if (var0 == ScriptOpcodes.STOCKMARKET_GETOFFERITEM) {
			var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.grandExchangeOffers[var3].id;
			return 1;
		} else if (var0 == ScriptOpcodes.STOCKMARKET_GETOFFERPRICE) {
			var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.grandExchangeOffers[var3].unitPrice;
			return 1;
		} else if (var0 == ScriptOpcodes.STOCKMARKET_GETOFFERCOUNT) {
			var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.grandExchangeOffers[var3].totalQuantity;
			return 1;
		} else if (var0 == ScriptOpcodes.STOCKMARKET_GETOFFERCOMPLETEDCOUNT) {
			var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.grandExchangeOffers[var3].currentQuantity;
			return 1;
		} else if (var0 == ScriptOpcodes.STOCKMARKET_GETOFFERCOMPLETEDGOLD) {
			var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
			Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = Client.grandExchangeOffers[var3].currentPrice;
			return 1;
		} else {
			int var13;
			if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFEREMPTY) {
				...
				Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var13 == 0 ? 1 : 0;
				return 1;
			} else if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFERSTABLE) {
				var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
				var13 = Client.grandExchangeOffers[var3].status();
				Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var13 == 2 ? 1 : 0;
				return 1;
			} else if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFERFINISHED) {
				var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
				var13 = Client.grandExchangeOffers[var3].status();
				Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var13 == 5 ? 1 : 0;
				return 1;
			} else if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFERADDING) {
				var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
				var13 = Client.grandExchangeOffers[var3].status();
				Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var13 == 1 ? 1 : 0;
				return 1;
			} else {
				boolean var12;
				if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_NAME) {
					var12 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize] == 1;
					...
					var12 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize] == 1;
					boolean var11 = Interpreter.Interpreter_intStack[Nameable.Interpreter_intStackSize + 1] == 1;
					if (UserComparator3.grandExchangeEvents != null) {
					...
					Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = UserComparator3.grandExchangeEvents == null ? 0 : UserComparator3.grandExchangeEvents.events.size();
					return 1;
				} else {
					...
					if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERWORLD) {
						...
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var4.world;
						return 1;
						...
						var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
						var4 = (GrandExchangeEvent)UserComparator3.grandExchangeEvents.events.get(var3);
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var4.grandExchangeOffer.totalQuantity;
						return 1;
					} else if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERPRICE) {
						var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
						var4 = (GrandExchangeEvent)UserComparator3.grandExchangeEvents.events.get(var3);
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var4.grandExchangeOffer.unitPrice;
						return 1;
					} else if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERITEM) {
						var3 = Interpreter.Interpreter_intStack[--Nameable.Interpreter_intStackSize];
						var4 = (GrandExchangeEvent)UserComparator3.grandExchangeEvents.events.get(var3);
						Interpreter.Interpreter_intStack[++Nameable.Interpreter_intStackSize - 1] = var4.grandExchangeOffer.id;
						return 1;
					} else {
						return 2;
					}
