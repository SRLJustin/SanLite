...
public class ReflectionCheck extends Node {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (ObjectSound.oculusOrbFocalPointX >> 7 != class28.localPlayer.x >> 7 || class306.oculusOrbFocalPointY >> 7 != class28.localPlayer.y >> 7)) {
			...
			var19.packetBuffer.writeIntME(Client.field698);
		...
		for (var17 = 0; var17 < 5; ++var17) {
			if (Client.field678[var17]) {
				var18 = (int)(Math.random() * (double)(Client.field747[var17] * 2 + 1) - (double)Client.field747[var17] + Math.sin((double)Client.field749[var17] / 100.0D * (double)Client.field653[var17]) * (double)Client.field654[var17]);
				if (var17 == 0) {
