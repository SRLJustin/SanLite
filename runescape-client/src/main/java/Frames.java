...
public class Frames extends DualNode {
	...
	static final void checkIfMinimapClicked(Widget var0, int var1, int var2) {
		if (Client.minimapState == 0 || Client.minimapState == 3) {
			if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !FriendsChatMember.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) {
				...
				if (var3.contains(var4, var5)) {
					...
					var13.packetBuffer.method8765(Client.field702.method4143(82) ? (Client.field702.method4143(81) ? 2 : 1) : 0);
