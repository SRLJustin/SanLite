...
public class UserComparator7 extends AbstractUserComparator {
	...
	static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null && var9.parentId == var1 && (var9.method6108() || class197.getWidgetFlags(var9) != 0 || var9 == Client.field680)) {
				if (var9.isIf3) {
				...
				if (var34 || !var9.isIf3 || var12 < var14 && var13 < var15) {
						...
						if (var9.noClickThrough) {
							if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15) {
								for (var27 = (ScriptEvent)Client.scriptEvents.last(); var27 != null; var27 = (ScriptEvent)Client.scriptEvents.previous()) {
									if (var27.field1050) {
										var27.remove();
										var27.widget.field3624 = false;
									}
								}

								SequenceDefinition.method3881();
								if (Script.field973 == 0) {
							...
							for (var27 = (ScriptEvent)Client.scriptEvents.last(); var27 != null; var27 = (ScriptEvent)Client.scriptEvents.previous()) {
								if (var27.field1050 && var27.widget.onScroll == var27.args) {
									var27.remove();
								}
							}
						}
					...
					if (var9.contentType == 1337) {
						if (!Client.field685 && !Client.isMenuOpen && var35) {
						...
						if (var9.isIf3) {
							...
							if (var9.hasListener) {
								...
								if (var9.field3624 && var35 && var9.onMouseRepeat != null) {
									var22 = new ScriptEvent();
									var22.field1050 = true;
									var22.widget = var9;
									var22.mouseX = MouseHandler.MouseHandler_x - var26;
