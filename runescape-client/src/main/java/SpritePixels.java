...
public final class SpritePixels extends Rasterizer2D {
	...
	public void method7970(int var1, int var2, int var3) {
		...
		if (var7 > 0 && var6 > 0) {
			if (var3 == 256) {
				method7950(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9);
			} else {
				method7972(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9, var3);
			}
	...
	public void method8030(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			...
			if (var5 == 256) {
				...
				method7952(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5);
			}
	...
	public void method7951(int var1, int var2, int var3, int var4) {
		this.method7978(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4);
	}
