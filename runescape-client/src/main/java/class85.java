	...
	static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null && var9.parentId == var1 && (var9.method6209() || class173.getWidgetFlags(var9) != 0 || var9 == Client.clickedWidgetParent)) {
				...
				} else if (var9.type == 0 && var9 != class25.mousedOverWidgetIf1 && class160.isComponentHidden(var9)) {
					continue;
				}
				...
				if (var9.type == 11) {
					if (var9.method6222(class245.urlRequester)) {
						if (var9.method6351()) {
							LoginScreenAnimation.method2477(var9);
				...
				if (var34 || !var9.isIf3 || var12 < var14 && var13 < var15) {
					if (var9.isIf3) {
						...
						if (var9.noClickThrough) {
							...
							for (var27 = (ScriptEvent)Client.scriptEvents.last(); var27 != null; var27 = (ScriptEvent)Client.scriptEvents.previous()) {
								if (var27.field1058 && var27.widget.onScroll == var27.args) {
									var27.remove();
								}
							}
						}
					...
					if (var9.contentType == 1337) {
						if (!Client.field509 && !Client.isMenuOpen && var35) {
						...
						if (var9.isIf3) {
							...
							boolean var36 = false;
							if ((MouseHandler.MouseHandler_currentButton == 1 || !FriendsChatMember.mouseCam && MouseHandler.MouseHandler_currentButton == 4) && var35) {
								var36 = true;
							}

							var21 = false;
							if ((MouseHandler.MouseHandler_lastButton == 1 || !FriendsChatMember.mouseCam && MouseHandler.MouseHandler_lastButton == 4) && MouseHandler.MouseHandler_lastPressedX >= var12 && MouseHandler.MouseHandler_lastPressedY >= var13 && MouseHandler.MouseHandler_lastPressedX < var14 && MouseHandler.MouseHandler_lastPressedY < var15) {
								var21 = true;
							}
							...
							if (var9.hasListener) {
								...
								if (var9.field3552 && var35 && var9.onMouseRepeat != null) {
									var22 = new ScriptEvent();
									var22.field1058 = true;
									var22.widget = var9;
									var22.mouseX = MouseHandler.MouseHandler_x - var26;
								...
								int var37;
								int var39;
								if (var9.onVarTransmit != null && Client.field504 > var9.field3697) {
									if (var9.varTransmitTriggers != null && Client.field504 - var9.field3697 <= 32) {
										label844:
										for (var39 = var9.field3697; var39 < Client.field504; ++var39) {
											var23 = Client.field700[var39 & 31];
									...
									var9.field3697 = Client.field504;
								}
								...
								if (var9.onInvTransmit != null && Client.field524 > var9.field3698) {
									if (var9.invTransmitTriggers != null && Client.field524 - var9.field3698 <= 32) {
										...
										for (var39 = var9.field3698; var39 < Client.field524; ++var39) {
											var23 = Client.field661[var39 & 31];
								...
								if (var9.onStatTransmit != null && Client.field705 > var9.field3699) {
									if (var9.statTransmitTriggers != null && Client.field705 - var9.field3699 <= 32) {
										label796:
										for (var39 = var9.field3699; var39 < Client.field705; ++var39) {
											var23 = Client.field704[var39 & 31];
									...
									var9.field3699 = Client.field705;
								}
						...
						if (!var9.isIf3) {
							...
							if ((var9.mouseOverRedirect >= 0 || var9.mouseOverColor != 0) && MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15) {
								if (var9.mouseOverRedirect >= 0) {
									...
									class25.mousedOverWidgetIf1 = var9;
								}
							}
