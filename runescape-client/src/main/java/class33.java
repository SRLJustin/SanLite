...
public class class33 {
	...
	public static void RunException_sendStackTrace(String var0, Throwable var1) {
		if (var1 != null) {
			...
			try {
				...
				URL var3 = new URL(RunException.RunException_applet.getCodeBase(), "clienterror.ws?cv=" + RunException.field4844 + "&cs=" + RunException.field4847 + "&u=" + RunException.localPlayerName + "&v1=" + TaskHandler.javaVendor + "&v2=" + TaskHandler.javaVersion + "&ct=" + RunException.clientType + "&e=" + var2);
	...
	static void method572(boolean var0) {
		byte var1 = 0;
		boolean var2 = FriendsChatMember.clientPreferences.method2229() >= Client.field480;
		if (!var2) {
			var1 = 12;
		...
		if (Login.Login_username == null || Login.Login_username.length() <= 0) {
			if (FriendsChatMember.clientPreferences.method2227() != null) {
				Login.Login_username = FriendsChatMember.clientPreferences.method2227();
