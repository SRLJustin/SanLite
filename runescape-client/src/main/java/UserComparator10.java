			...
			if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !FriendSystem.isComponentHidden(var3))) {
				...
				if (var3.type == 6) {
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
						boolean var8 = class26.runCs1(var3);
						if (var8) {
						...
						if (var5 != -1) {
							...
							if (!var6.method4020()) {
								for (var3.modelFrameCycle += Client.field563; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; class69.method2030(var3)) {
